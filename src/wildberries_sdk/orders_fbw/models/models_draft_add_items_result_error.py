...
class ModelsDraftAddItemsResultError(BaseModel):
    """
    ModelsDraftAddItemsResultError
    """ # noqa: E501
    detail: StrictStr = Field(description="Детали ошибки", json_schema_extra={"examples": ["Создайте карточку товара с этим баркодом"]})
    title: StrictStr = Field(description="Заголовок ошибки", json_schema_extra={"examples": ["Invalid sku"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelsDraftAddItemsResultError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelsDraftAddItemsResultError from a dict"""
        if obj is None:
            return None
