...
class PutV3FbsSuppliesSupplyIdSpotRequest(BaseModel):
    ...
    carrier_country_code: Annotated[str, Field(min_length=3, strict=True, max_length=3)] = Field(description="Код страны перевозчика по [ОКСМ](./orders-fbs#tag/fbsSupplies/operation/getV3FbsDictionariesCountriesOksm)", alias="carrierCountryCode", json_schema_extra={"examples": ["112"]})
