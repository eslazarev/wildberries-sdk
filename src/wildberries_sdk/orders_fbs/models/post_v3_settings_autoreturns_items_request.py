...
class PostV3SettingsAutoreturnsItemsRequest(BaseModel):
    """
    PostV3SettingsAutoreturnsItemsRequest
    """ # noqa: E501
    chrt_ids: Annotated[List[StrictInt], Field(min_length=1, max_length=1000)] = Field(description="Список ID размеров товаров в системе WB", alias="chrtIds", json_schema_extra={"examples": [[111111, 222222]]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3SettingsAutoreturnsItemsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3SettingsAutoreturnsItemsRequest from a dict"""
        if obj is None:
            return None
