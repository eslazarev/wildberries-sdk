...
class SupplySpotQRCode(BaseModel):
    ...
    SupplySpotQRCode
    """ # noqa: E501
    qr_code: StrictStr = Field(description="QR-код поставки в кодировке base64", alias="qrCode", json_schema_extra={"examples": ["U3dhZ2dlciByb2Nrcw=="]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SupplySpotQRCode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SupplySpotQRCode from a dict"""
        if obj is None:
            return None
