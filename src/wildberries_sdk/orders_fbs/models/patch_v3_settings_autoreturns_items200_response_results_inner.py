...
class PatchV3SettingsAutoreturnsItems200ResponseResultsInner(BaseModel):
    """
    ...
    error: Optional[List[PatchV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner]] = Field(default=None, description="Детали ошибки")
    success: Optional[StrictBool] = Field(default=None, description="- `true` — настройки автовозврата товара получены ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV3SettingsAutoreturnsItems200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV3SettingsAutoreturnsItems200ResponseResultsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "error": [PatchV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner.from_dict(_item) for _item in obj["error"]] if obj.get("error") is not None else None,
