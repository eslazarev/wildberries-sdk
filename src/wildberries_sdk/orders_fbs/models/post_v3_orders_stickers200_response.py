...
class PostV3OrdersStickers200Response(BaseModel):
    """
    PostV3OrdersStickers200Response
    """ # noqa: E501
    stickers: Optional[List[PostV3OrdersStickers200ResponseStickersInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3OrdersStickers200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3OrdersStickers200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stickers": [PostV3OrdersStickers200ResponseStickersInner.from_dict(_item) for _item in obj["stickers"]] if obj.get("stickers") is not None else None
        })
        return _obj
