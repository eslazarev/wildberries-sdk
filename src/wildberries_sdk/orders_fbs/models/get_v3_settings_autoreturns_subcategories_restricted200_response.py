...
class GetV3SettingsAutoreturnsSubcategoriesRestricted200Response(BaseModel):
    """
    ...
    data: List[GetV3SettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner] = Field(description="Список ID предметов, товары которых не хранятся на складах WB")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV3SettingsAutoreturnsSubcategoriesRestricted200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV3SettingsAutoreturnsSubcategoriesRestricted200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "next": obj.get("next"),
            "data": [GetV3SettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
