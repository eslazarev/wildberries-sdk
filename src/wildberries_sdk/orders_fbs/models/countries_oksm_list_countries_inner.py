...
class CountriesOKSMListCountriesInner(BaseModel):
    ...
    """ # noqa: E501
    code: StrictStr = Field(description="Код страны", json_schema_extra={"examples": ["036"]})
    name: StrictStr = Field(description="Название страны", json_schema_extra={"examples": ["Австралия"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CountriesOKSMListCountriesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CountriesOKSMListCountriesInner from a dict"""
        if obj is None:
            return None
