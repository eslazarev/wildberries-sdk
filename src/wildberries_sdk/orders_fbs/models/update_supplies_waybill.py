...
class UpdateSuppliesWaybill(BaseModel):
    """
    UpdateSuppliesWaybill
    """ # noqa: E501
    data: Annotated[List[UpdateSupplyWaybill], Field(min_length=1, max_length=100)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSuppliesWaybill from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSuppliesWaybill from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [UpdateSupplyWaybill.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
