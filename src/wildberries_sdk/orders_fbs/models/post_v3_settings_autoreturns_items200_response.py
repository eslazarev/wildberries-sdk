...
class PostV3SettingsAutoreturnsItems200Response(BaseModel):
    """
    PostV3SettingsAutoreturnsItems200Response
    """ # noqa: E501
    results: List[PostV3SettingsAutoreturnsItems200ResponseResultsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3SettingsAutoreturnsItems200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3SettingsAutoreturnsItems200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [PostV3SettingsAutoreturnsItems200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
