...
class PostV3SettingsAutoreturnsItems200ResponseResultsInner(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Куда будет возвращён товар:   - `auto` — место возврата определяется автоматически   - `byWarehouse` — на склад WB   - `byPickupPoint` — на пункт выдачи заказов   - `byCourier` — продавцу курьером. Всегда для товаров тех [предметов](/openapi/orders-fbs#tag/autoreturnSettings/operation/getV3SettingsAutoreturnsSubcategoriesRestricted), которые автоматически возвращаются в ПВЗ ")
    changeable: Optional[StrictBool] = Field(default=None, description="- `true` — настройки автовозврата товара можно изменить ")
    error: Optional[List[PostV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner]] = Field(default=None, description="Детали ошибки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3SettingsAutoreturnsItems200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3SettingsAutoreturnsItems200ResponseResultsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "error": [PostV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner.from_dict(_item) for _item in obj["error"]] if obj.get("error") is not None else None
        })
        return _obj
