...
class AccessInner(BaseModel):
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['balance', 'brands', 'changeJam', 'discountPrice', 'finance', 'showcase', 'suppliersDocuments', 'supply', 'questions', 'pinFeedbacks', 'pointsForReviews', 'feedbacks', 'oldAnalyticsReports', 'marketplace', 'brandsFlow', 'copyrightComplaints', 'pretrialClaims', 'sellersChat']):
            raise ValueError("must be one of enum values ('balance', 'brands', 'changeJam', 'discountPrice', 'finance', 'showcase', 'suppliersDocuments', 'supply', 'questions', 'pinFeedbacks', 'pointsForReviews', 'feedbacks', 'oldAnalyticsReports', 'marketplace', 'brandsFlow', 'copyrightComplaints', 'pretrialClaims', 'sellersChat')")
        return value
