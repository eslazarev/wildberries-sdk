...
class GetV2News200ResponseDataInner(BaseModel):
    """
    ...
    types: Optional[List[GetV2News200ResponseDataInnerTypesInner]] = Field(default=None, description="Теги новости")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2News200ResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2News200ResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "types": [GetV2News200ResponseDataInnerTypesInner.from_dict(_item) for _item in obj["types"]] if obj.get("types") is not None else None
        })
        return _obj
