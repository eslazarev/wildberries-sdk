...
from wildberries_sdk.rates.configuration import Configuration
from wildberries_sdk.rates.api_response import ApiResponse, T as ApiResponseT
import wildberries_sdk.rates.models
from wildberries_sdk.rates import rest
from wildberries_sdk.rates.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.1.130/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wildberries_sdk.rates.models, klass)
