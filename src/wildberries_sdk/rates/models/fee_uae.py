...
class FeeUAE(BaseModel):
    """
    FeeUAE
    """ # noqa: E501
    report: Optional[List[FeeUAEReportInner]] = Field(default=None, description="Список комиссий")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeeUAE from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeeUAE from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "report": [FeeUAEReportInner.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
        return _obj
