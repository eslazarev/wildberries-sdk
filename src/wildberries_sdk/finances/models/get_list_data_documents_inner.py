...
class GetListDataDocumentsInner(BaseModel):
    ...
    category: Optional[StrictStr] = Field(default=None, description="Название [категории документов](./documents-and-accounting#tag/documents/operation/getV1DocumentsCategories) из поля ответа `title`", json_schema_extra={"examples": ["Уведомление о выкупе"]})
