...
class GetV2HistoryGoodsTask200Response(BaseModel):
    """
    GetV2HistoryGoodsTask200Response
    """ # noqa: E501
    data: Optional[GetV2HistoryGoodsTask200ResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2HistoryGoodsTask200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2HistoryGoodsTask200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": GetV2HistoryGoodsTask200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
