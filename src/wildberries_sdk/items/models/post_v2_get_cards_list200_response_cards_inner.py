...
class PostV2GetCardsList200ResponseCardsInner(BaseModel):
    """
    PostV2GetCardsList200ResponseCardsInner
    """ # noqa: E501
    nm_id: Optional[StrictInt] = Field(default=None, description="Артикул WB", alias="nmID")
    imt_id: Optional[StrictInt] = Field(default=None, description="ID для [объединённых](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточек товаров.<br>Един для всех артикулов WB группы объединённых карточек.<br>У каждой карточки товара есть `imtID`, даже если она не объединена с другими карточками<br>", alias="imtID")
    ...
    documents: Optional[PostV2GetCardsList200ResponseCardsInnerDocuments] = None
    ...
    sizes: Optional[List[PostV2GetCardsList200ResponseCardsInnerSizesInner]] = Field(default=None, description="Размеры товара")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200ResponseCardsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200ResponseCardsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "documents": PostV2GetCardsList200ResponseCardsInnerDocuments.from_dict(obj["documents"]) if obj.get("documents") is not None else None,
            ...
            "sizes": [PostV2GetCardsList200ResponseCardsInnerSizesInner.from_dict(_item) for _item in obj["sizes"]] if obj.get("sizes") is not None else None,
            "tags": [PostV2GetCardsList200ResponseCardsInnerTagsInner.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
