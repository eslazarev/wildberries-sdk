...
class PostV3WarehousesRequest(BaseModel):
    ...
    office_id: Annotated[int, Field(strict=True, ge=1)] = Field(description="ID [склада WB](./item-management#tag/sellerWarehouses/operation/getV3Offices).<br>Нельзя привязывать склад WB, который уже используется", alias="officeId", json_schema_extra={"examples": [15]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3WarehousesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3WarehousesRequest from a dict"""
        if obj is None:
            return None
