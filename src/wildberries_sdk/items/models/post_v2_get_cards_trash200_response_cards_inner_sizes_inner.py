...
class PostV2GetCardsTrash200ResponseCardsInnerSizesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsTrash200ResponseCardsInnerSizesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsTrash200ResponseCardsInnerSizesInner from a dict"""
        if obj is None:
            return None
