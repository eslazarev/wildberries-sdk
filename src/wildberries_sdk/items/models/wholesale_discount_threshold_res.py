...
class WholesaleDiscountThresholdRes(BaseModel):
    ...
    wholesale_discount: StrictInt = Field(description="Скидка, %", alias="wholesaleDiscount", json_schema_extra={"examples": [10]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WholesaleDiscountThresholdRes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WholesaleDiscountThresholdRes from a dict"""
        if obj is None:
            return None
