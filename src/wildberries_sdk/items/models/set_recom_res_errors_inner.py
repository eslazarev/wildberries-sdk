...
class SetRecomResErrorsInner(BaseModel):
    ...
    """ # noqa: E501
    main_nm: StrictStr = Field(description="Значение параметра `nmId`", alias="mainNm", json_schema_extra={"examples": ["5870243"]})
    recom_nm: StrictStr = Field(description="Значение параметра `recomNm`", alias="recomNm", json_schema_extra={"examples": ["5870244"]})
    message: StrictStr = Field(description="Сообщение об ошибке", json_schema_extra={"examples": ["The item has no photo"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetRecomResErrorsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetRecomResErrorsInner from a dict"""
        if obj is None:
            return None
