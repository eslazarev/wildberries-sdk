...
class RequestMoveNmsImtConn(BaseModel):
    ...
    """ # noqa: E501
    target_imt: StrictInt = Field(description="Существующий `imtID`, под которым необходимо [объединить](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточки товаров", alias="targetIMT", json_schema_extra={"examples": [123]})
