...
class ResponseErrorV3(BaseModel):
    """
    ResponseErrorV3
    """ # noqa: E501
    ...
    detail: StrictStr = Field(description="Детали ошибки", json_schema_extra={"examples": ["Invalid data format"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResponseErrorV3 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResponseErrorV3 from a dict"""
        if obj is None:
            return None
