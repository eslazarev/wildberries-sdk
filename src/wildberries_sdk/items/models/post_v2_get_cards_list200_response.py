...
class PostV2GetCardsList200Response(BaseModel):
    """
    PostV2GetCardsList200Response
    """ # noqa: E501
    cards: Optional[List[PostV2GetCardsList200ResponseCardsInner]] = Field(default=None, description="Список карточек товаров")
    cursor: Optional[PostV2GetCardsList200ResponseCursor] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cards": [PostV2GetCardsList200ResponseCardsInner.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None,
            "cursor": PostV2GetCardsList200ResponseCursor.from_dict(obj["cursor"]) if obj.get("cursor") is not None else None
        })
        return _obj
