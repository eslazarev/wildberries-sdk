...
class PostV2GetCardsTrash200Response(BaseModel):
    """
    PostV2GetCardsTrash200Response
    """ # noqa: E501
    cards: Optional[List[PostV2GetCardsTrash200ResponseCardsInner]] = Field(default=None, description="Массив карточек товаров")
    cursor: Optional[PostV2GetCardsTrash200ResponseCursor] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsTrash200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsTrash200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cards": [PostV2GetCardsTrash200ResponseCardsInner.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None,
            "cursor": PostV2GetCardsTrash200ResponseCursor.from_dict(obj["cursor"]) if obj.get("cursor") is not None else None
        })
        return _obj
