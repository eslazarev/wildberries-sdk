...
class ContentV2GetCardsListPost200ResponseCardsInnerDocumentsOverallVerdict(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentV2GetCardsListPost200ResponseCardsInnerDocumentsOverallVerdict from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentV2GetCardsListPost200ResponseCardsInnerDocumentsOverallVerdict from a dict"""
        if obj is None:
            return None
