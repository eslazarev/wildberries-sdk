...
class GetRecomRes(BaseModel):
    ...
    next: StrictInt = Field(description="Курсор. Последний `nmId` в ответе", json_schema_extra={"examples": [143]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRecomRes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRecomRes from a dict"""
        if obj is None:
            return None
