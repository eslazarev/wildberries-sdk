...
class ApiMetaDetailsResponseResultsInnerErrorsInner(BaseModel):
    ...
    meta_details: Optional[List[MetaDetailsErrorsInner]] = Field(default=None, description="Ошибки проверки идентификаторов маркировки", alias="metaDetails")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiMetaDetailsResponseResultsInnerErrorsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiMetaDetailsResponseResultsInnerErrorsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metaDetails": [MetaDetailsErrorsInner.from_dict(_item) for _item in obj["metaDetails"]] if obj.get("metaDetails") is not None else None
        })
        return _obj
