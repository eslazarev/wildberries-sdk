...
class ApiOrdersRequestV2(BaseModel):
    ...
    ApiOrdersRequestV2
    """ # noqa: E501
    orders_ids: Annotated[List[StrictInt], Field(max_length=1000)] = Field(description="Список ID сборочных заданий", alias="ordersIds", json_schema_extra={"examples": [[123456, 234567, 345678]]})
