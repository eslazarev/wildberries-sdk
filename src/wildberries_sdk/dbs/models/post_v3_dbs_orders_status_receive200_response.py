...
class PostV3DbsOrdersStatusReceive200Response(BaseModel):
    """
    ...
    results: Optional[List[PostV3DbsOrdersStatusReceive200ResponseResultsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3DbsOrdersStatusReceive200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3DbsOrdersStatusReceive200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [PostV3DbsOrdersStatusReceive200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
