...
class PatchV0AuctionNms200ResponseNmsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV0AuctionNms200ResponseNmsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV0AuctionNms200ResponseNmsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nms": PatchV0AuctionNms200ResponseNmsInnerNms.from_dict(obj["nms"]) if obj.get("nms") is not None else None
        })
        return _obj
