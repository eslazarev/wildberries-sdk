...
class StatCampaignNotFound(BaseModel):
    ...
    """ # noqa: E501
    advert_id: Optional[StrictInt] = Field(default=None, description="ID кампании", json_schema_extra={"examples": [111]})
    error: Optional[StrictStr] = Field(default=None, description="Описание ошибки", json_schema_extra={"examples": ["кампания не найдена"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatCampaignNotFound from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatCampaignNotFound from a dict"""
        if obj is None:
            return None
