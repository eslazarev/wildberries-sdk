...
class V0BidRecommendationBaseBidTop2(BaseModel):
    """
    Топ-ставка 
    """ # noqa: E501
    bid_kopecks: Optional[StrictInt] = Field(default=None, description="Рекомендуемая ставка в разменных единицах — 0,01 от базовой валюты [аккаунта продавца](https://cmp.wildberries.ru/campaigns/finances). Если `0`, для данного предмета топ-ставка не используется", alias="bidKopecks")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0BidRecommendationBaseBidTop2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0BidRecommendationBaseBidTop2 from a dict"""
        if obj is None:
            return None
