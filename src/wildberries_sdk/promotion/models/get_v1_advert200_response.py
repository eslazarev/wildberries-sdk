...
class GetV1Advert200Response(BaseModel):
    """
    ...
    extended: Optional[GetV1Advert200ResponseExtended] = None
    items: Optional[List[GetV1Advert200ResponseItemsInner]] = Field(default=None, description="Информация о баннере. <br> Наличие в ответе тех или иных полей зависит от конфигурации медиакампании. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1Advert200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1Advert200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "extended": GetV1Advert200ResponseExtended.from_dict(obj["extended"]) if obj.get("extended") is not None else None,
            "items": [GetV1Advert200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
