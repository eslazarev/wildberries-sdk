...
class V0BidRecommendationReachMedium(BaseModel):
    """
    Средний охват: 61-75% 
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0BidRecommendationReachMedium from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0BidRecommendationReachMedium from a dict"""
        if obj is None:
            return None
