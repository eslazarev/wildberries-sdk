...
class V0DeleteNormQueryBidsRequestItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["advert_id", "nm_id", "norm_query"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0DeleteNormQueryBidsRequestItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0DeleteNormQueryBidsRequestItem from a dict"""
        if obj is None:
            return None
