...
class PatchV1Bids200ResponseBidsInner(BaseModel):
    """
    PatchV1Bids200ResponseBidsInner
    """ # noqa: E501
    advert_id: StrictInt = Field(description="ID кампании")
    nm_bids: List[PatchV1Bids200ResponseBidsInnerNmBidsInner] = Field(description="Ставки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV1Bids200ResponseBidsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV1Bids200ResponseBidsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nm_bids": [PatchV1Bids200ResponseBidsInnerNmBidsInner.from_dict(_item) for _item in obj["nm_bids"]] if obj.get("nm_bids") is not None else None
        })
        return _obj
