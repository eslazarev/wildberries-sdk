...
class GetV1PromotionCount200ResponseAdvertsInner(BaseModel):
    """
    ...
    advert_list: Optional[List[GetV1PromotionCount200ResponseAdvertsInnerAdvertListInner]] = Field(default=None, description="Список кампаний")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1PromotionCount200ResponseAdvertsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1PromotionCount200ResponseAdvertsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "advert_list": [GetV1PromotionCount200ResponseAdvertsInnerAdvertListInner.from_dict(_item) for _item in obj["advert_list"]] if obj.get("advert_list") is not None else None
        })
        return _obj
