...
class GetV1Balance200Response(BaseModel):
    """
    ...
    cashbacks: Optional[List[GetV1Balance200ResponseCashbacksInner]] = Field(default=None, description="Промо-бонусы")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1Balance200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1Balance200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bonus": obj.get("bonus"),
            "cashbacks": [GetV1Balance200ResponseCashbacksInner.from_dict(_item) for _item in obj["cashbacks"]] if obj.get("cashbacks") is not None else None
        })
        return _obj
