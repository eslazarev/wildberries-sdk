...
class PatchV0AuctionNms200Response(BaseModel):
    """
    PatchV0AuctionNms200Response
    """ # noqa: E501
    nms: List[PatchV0AuctionNms200ResponseNmsInner] = Field(description="Результат отработки запроса")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV0AuctionNms200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV0AuctionNms200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nms": [PatchV0AuctionNms200ResponseNmsInner.from_dict(_item) for _item in obj["nms"]] if obj.get("nms") is not None else None
        })
        return _obj
