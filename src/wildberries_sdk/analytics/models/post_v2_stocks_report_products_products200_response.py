...
class PostV2StocksReportProductsProducts200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2StocksReportProductsProducts200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2StocksReportProductsProducts200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": TableItemResponse.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
