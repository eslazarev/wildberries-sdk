...
class SearchReportItemReq(BaseModel):
    """
    SearchReportItemReq
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchReportItemReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchReportItemReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "params": SearchReportItemReqParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
