...
class DistributionTableItemV1(BaseModel):
    """
    ...
    feedback_rating: Optional[DistributionTableItemV1FeedbackRating] = Field(default=None, alias="feedbackRating")
    feedback_count: Optional[DistributionTableItemV1FeedbackCount] = Field(default=None, alias="feedbackCount")
    five_star: Optional[DistributionTableItemV1FiveStar] = Field(default=None, alias="fiveStar")
    four_star: Optional[DistributionTableItemV1FourStar] = Field(default=None, alias="fourStar")
    three_star: Optional[DistributionTableItemV1ThreeStar] = Field(default=None, alias="threeStar")
    two_star: Optional[DistributionTableItemV1TwoStar] = Field(default=None, alias="twoStar")
    one_star: Optional[DistributionTableItemV1OneStar] = Field(default=None, alias="oneStar")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributionTableItemV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributionTableItemV1 from a dict"""
        if obj is None:
            return None
