...
class OrderFeedRequestSelectedPeriod(BaseModel):
    ...
    """ # noqa: E501
    start: datetime = Field(description="Дата и время начала периода. Не ранее 31 суток от текущей даты и не позднее `end`", json_schema_extra={"examples": ["2026-07-23T00:00:00+03:00"]})
    end: Optional[datetime] = Field(default=None, description="Дата и время конца периода. Не ранее 31 суток от текущей даты", json_schema_extra={"examples": ["2026-07-31T00:00:00+03:00"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderFeedRequestSelectedPeriod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderFeedRequestSelectedPeriod from a dict"""
        if obj is None:
            return None
