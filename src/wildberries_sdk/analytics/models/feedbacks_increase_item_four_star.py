...
class FeedbacksIncreaseItemFourStar(BaseModel):
    """
    Отзывы 4 звезды
    """ # noqa: E501
    current: StrictInt = Field(description="Прирост оценок за период", json_schema_extra={"examples": [2]})
    ...
    total: StrictInt = Field(description="Всего оценок", json_schema_extra={"examples": [13]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeedbacksIncreaseItemFourStar from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeedbacksIncreaseItemFourStar from a dict"""
        if obj is None:
            return None
