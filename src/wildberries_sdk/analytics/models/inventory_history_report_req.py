...
class InventoryHistoryReportReq(BaseModel):
    """
    InventoryHistoryReportReq
    """ # noqa: E501
    id: UUID = Field(description="ID отчёта в UUID-формате. Генерируется продавцом самостоятельно")
    report_type: StrictStr = Field(description="Тип отчёта `STOCK_HISTORY_DAILY_CSV` — Отчёт по истории остатков. <br> Данные отчёта обновляются 1 раз в 2 часа", alias="reportType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InventoryHistoryReportReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InventoryHistoryReportReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "params": InventoryHistoryReportReqParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
