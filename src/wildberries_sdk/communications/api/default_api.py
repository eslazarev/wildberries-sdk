...
class DefaultApi:
    ...
    def get_v1_claims(
        ...
        _param = self._get_v1_claims_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1Claims200Response",
            '400': "GetV1Claims400Response",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "PostV1FeedbacksAnswer403Response",
            '429': "GetV1NewFeedbacksQuestions401Response",
    ...
    @validate_call
    def get_v1_claims_with_http_info(
        self,
        is_archive: Annotated[StrictBool, Field(description="Состояние заявки:   * `false` — на рассмотрении   * `true` — в архиве ")],
        id: Annotated[Optional[StrictStr], Field(description="ID заявки")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Количество заявок в ответе")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[GetV1Claims200Response]:
        """Заявки покупателей на возврат
    ...
    @validate_call
    def get_v1_claims_without_preload_content(
        self,
        is_archive: Annotated[StrictBool, Field(description="Состояние заявки:   * `false` — на рассмотрении   * `true` — в архиве ")],
        id: Annotated[Optional[StrictStr], Field(description="ID заявки")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Количество заявок в ответе")] = None,
    ...
    def get_v1_feedback_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[GetV1Feedback200Response]:
        """Получить отзыв по ID
    ...
    def get_v1_feedbacks_archive(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1FeedbacksArchive200Response",
            '400': "ResponseFeedbackQuestionErr",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "ResponseFeedbackQuestionErr",
    ...
    def get_v1_feedbacks_archive_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[GetV1FeedbacksArchive200Response]:
        """Список архивных отзывов
    ...
    def get_v1_feedbacks_count(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1FeedbacksCount200Response",
            '400': "ResponseFeedbackQuestionErr",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "ResponseFeedbackQuestionErr",
    ...
    def get_v1_feedbacks_count_unanswered(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1FeedbacksCountUnanswered200Response",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "ResponseFeedbackQuestionErr",
            '429': "GetV1NewFeedbacksQuestions401Response",
    ...
    def get_v1_feedbacks_count_unanswered_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[GetV1FeedbacksCountUnanswered200Response]:
        """Необработанные отзывы
    ...
    def get_v1_new_feedbacks_questions(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1NewFeedbacksQuestions200Response",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "ResponseFeedbackQuestionErr",
            '429': "GetV1NewFeedbacksQuestions401Response",
    ...
    def get_v1_new_feedbacks_questions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[GetV1NewFeedbacksQuestions200Response]:
        """Непросмотренные отзывы и вопросы
    ...
    def get_v1_question_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[GetV1Question200Response]:
        """Получить вопрос по ID
    ...
    def get_v1_questions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[GetV1Questions200Response]:
        """Список вопросов
    ...
    def get_v1_questions_count(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1QuestionsCount200Response",
            '400': "ResponseFeedbackQuestionErr",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "ResponseFeedbackQuestionErr",
    ...
    def get_v1_questions_count_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[GetV1QuestionsCount200Response]:
        """Количество вопросов
    ...
    def get_v1_questions_count_unanswered(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1QuestionsCountUnanswered200Response",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "ResponseFeedbackQuestionErr",
            '429': "GetV1NewFeedbacksQuestions401Response",
    ...
    def get_v1_questions_count_unanswered_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=2)] = 0,
    ) -> ApiResponse[GetV1QuestionsCountUnanswered200Response]:
        """Неотвеченные вопросы
    ...
    def get_v1_seller_download_id(
        self,
        id: Annotated[StrictStr, Field(description="ID файла, см. значение поля `downloadID` в методе [События чатов](./customer-communication#tag/buyersChat/operation/getV1SellerEvents)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "bytes",
            '202': "GetV1SellerDownloadId202Response",
            '400': "GetV1SellerEvents400Response",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "PostV1FeedbacksAnswer403Response",
            '429': "GetV1NewFeedbacksQuestions401Response",
            '451': "GetV1SellerDownloadId451Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def patch_v1_claim(
        self,
        patch_v1_claim_request: Annotated[PatchV1ClaimRequest, Field(description="Ответ на заявку")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param patch_v1_claim_request: Ответ на заявку (required)
        :type patch_v1_claim_request: PatchV1ClaimRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_v1_claim_serialize(
            patch_v1_claim_request=patch_v1_claim_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_v1_claim_with_http_info(
        self,
        patch_v1_claim_request: Annotated[PatchV1ClaimRequest, Field(description="Ответ на заявку")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_v1_claim_without_preload_content(
        self,
        patch_v1_claim_request: Annotated[PatchV1ClaimRequest, Field(description="Ответ на заявку")],
        _request_timeout: Union[
            None,
    ...
    def _patch_v1_claim_serialize(
        self,
        patch_v1_claim_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if patch_v1_claim_request is not None:
            _body_params = patch_v1_claim_request
    ...
    def patch_v1_questions(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PatchV1Questions200Response",
            '400': "ResponseFeedbackQuestionErr",
            '401': "GetV1NewFeedbacksQuestions401Response",
            '402': "GetV1NewFeedbacksQuestions402Response",
            '403': "ResponseFeedbackQuestionErr",
    ...
    def post_v1_seller_message(
        self,
        reply_sign: Annotated[str, Field(strict=True, max_length=255, description="Подпись чата. Можно получить из [информации по чату](./customer-communication#tag/buyersChat/operation/getV1SellerChats) или [данных события](./customer-communication#tag/buyersChat/operation/getV1SellerEvents), если в событии есть поле `\\\"isNewChat\\\": true`. ")],
