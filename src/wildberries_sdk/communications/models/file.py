...
class File(BaseModel):
    ...
    download_id: Optional[StrictStr] = Field(default=None, description="ID файла. [Получить файл](./user-communication#tag/buyersChat/operation/getV1SellerDownloadId)", alias="downloadID")
