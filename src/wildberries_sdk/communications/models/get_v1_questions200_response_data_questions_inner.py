...
class GetV1Questions200ResponseDataQuestionsInner(BaseModel):
    """
    ...
    answer: Optional[GetV1Questions200ResponseDataQuestionsInnerAnswer] = None
    product_details: Optional[GetV1Questions200ResponseDataQuestionsInnerProductDetails] = Field(default=None, alias="productDetails")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1Questions200ResponseDataQuestionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1Questions200ResponseDataQuestionsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "answer": GetV1Questions200ResponseDataQuestionsInnerAnswer.from_dict(obj["answer"]) if obj.get("answer") is not None else None,
            "productDetails": GetV1Questions200ResponseDataQuestionsInnerProductDetails.from_dict(obj["productDetails"]) if obj.get("productDetails") is not None else None,
