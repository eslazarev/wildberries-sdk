...
class PatchV1ClaimRequest(BaseModel):
    ...
    action: StrictStr = Field(description="Действие с заявкой.<br>Используйте одно из значений массива `actions` — ответа [метода получения заявок](./customer-communication#tag/buyersReturns/operation/getV1Claims)", json_schema_extra={"examples": ["rejectcustom"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV1ClaimRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV1ClaimRequest from a dict"""
        if obj is None:
            return None
