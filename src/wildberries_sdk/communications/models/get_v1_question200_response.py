...
class GetV1Question200Response(BaseModel):
    """
    GetV1Question200Response
    """ # noqa: E501
    data: Optional[GetV1Question200ResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1Question200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1Question200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": GetV1Question200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
