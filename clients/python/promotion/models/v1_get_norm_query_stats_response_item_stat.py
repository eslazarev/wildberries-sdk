...
class V1GetNormQueryStatsResponseItemStat(BaseModel):
    """
    ...
    ctr: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="CTR (click-through rate) — отношение числа кликов к количеству показов в процентах.  Для кампаний с типом оплаты `cpc` — за клики — значение будет `null` ")
    cpc: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Средняя стоимость клика в базовых единицах валюты [аккаунта продавца](https://cmp.wildberries.ru/campaigns/finances)")
    ...
    avg_pos: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Средняя позиция товара на страницах поисковой выдачи", alias="avgPos")
    ...
    __properties: ClassVar[List[str]] = ["normQuery", "views", "clicks", "atbs", "orders", "ctr", "cpc", "cpm", "avgPos", "shks", "spend"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1GetNormQueryStatsResponseItemStat from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1GetNormQueryStatsResponseItemStat from a dict"""
        if obj is None:
            return None
