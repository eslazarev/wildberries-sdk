...
class GetV1Advert200ResponseItemsInner(BaseModel):
    """
    ...
    show_hours: Optional[List[GetV1Advert200ResponseItemsInnerShowHoursInner]] = Field(default=None, description="Часы показа")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1Advert200ResponseItemsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1Advert200ResponseItemsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "show_hours": [GetV1Advert200ResponseItemsInnerShowHoursInner.from_dict(_item) for _item in obj["show_hours"]] if obj.get("show_hours") is not None else None,
            "Erid": obj.get("Erid")
        })
        return _obj
