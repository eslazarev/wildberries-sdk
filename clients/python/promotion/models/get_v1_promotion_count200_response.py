...
class GetV1PromotionCount200Response(BaseModel):
    """
    GetV1PromotionCount200Response
    """ # noqa: E501
    adverts: Optional[List[GetV1PromotionCount200ResponseAdvertsInner]] = Field(default=None, description="Данные по кампаниям")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1PromotionCount200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1PromotionCount200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "adverts": [GetV1PromotionCount200ResponseAdvertsInner.from_dict(_item) for _item in obj["adverts"]] if obj.get("adverts") is not None else None,
            "all": obj.get("all")
        })
        return _obj
