...
class PatchV0AuctionNms200ResponseNmsInnerNms(BaseModel):
    """
    Карточки товаров
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV0AuctionNms200ResponseNmsInnerNms from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV0AuctionNms200ResponseNmsInnerNms from a dict"""
        if obj is None:
            return None
