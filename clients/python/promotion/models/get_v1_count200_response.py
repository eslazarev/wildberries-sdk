...
class GetV1Count200Response(BaseModel):
    """
    ...
    adverts: Optional[GetV1Count200ResponseAdverts] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1Count200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1Count200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "all": obj.get("all"),
            "adverts": GetV1Count200ResponseAdverts.from_dict(obj["adverts"]) if obj.get("adverts") is not None else None
        })
        return _obj
