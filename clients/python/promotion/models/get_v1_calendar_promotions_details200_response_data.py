...
class GetV1CalendarPromotionsDetails200ResponseData(BaseModel):
    """
    Данные ответа
    """ # noqa: E501
    promotions: Optional[List[GetV1CalendarPromotionsDetails200ResponseDataPromotionsInner]] = Field(default=None, description="Список акций")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1CalendarPromotionsDetails200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1CalendarPromotionsDetails200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "promotions": [GetV1CalendarPromotionsDetails200ResponseDataPromotionsInner.from_dict(_item) for _item in obj["promotions"]] if obj.get("promotions") is not None else None
        })
        return _obj
