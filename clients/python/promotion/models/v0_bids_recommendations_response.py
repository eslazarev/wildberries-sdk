...
class V0BidsRecommendationsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["advertId", "base", "nmId", "normQueries"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0BidsRecommendationsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0BidsRecommendationsResponse from a dict"""
        if obj is None:
            return None
