...
class PostV1BidsMin200Response(BaseModel):
    """
    PostV1BidsMin200Response
    """ # noqa: E501
    bids: List[PostV1BidsMin200ResponseBidsInner] = Field(description="Список карточек товаров со ставками")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1BidsMin200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1BidsMin200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": [PostV1BidsMin200ResponseBidsInner.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None
        })
        return _obj
