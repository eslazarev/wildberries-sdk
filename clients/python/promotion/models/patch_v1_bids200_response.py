...
class PatchV1Bids200Response(BaseModel):
    """
    PatchV1Bids200Response
    """ # noqa: E501
    bids: List[PatchV1Bids200ResponseBidsInner] = Field(description="Результат отработки запроса")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV1Bids200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV1Bids200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": [PatchV1Bids200ResponseBidsInner.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None,
