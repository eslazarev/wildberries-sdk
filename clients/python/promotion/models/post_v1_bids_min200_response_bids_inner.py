...
class PostV1BidsMin200ResponseBidsInner(BaseModel):
    """
    PostV1BidsMin200ResponseBidsInner
    """ # noqa: E501
    bids: List[PostV1BidsMin200ResponseBidsInnerBidsInner] = Field(description="Список ставок по местам размещения")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1BidsMin200ResponseBidsInner from a JSON string"""
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.bids:
            for _item_bids in self.bids:
                _items.append(_item_bids.to_dict() if _item_bids is not None else None)
            _dict['bids'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1BidsMin200ResponseBidsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": [PostV1BidsMin200ResponseBidsInnerBidsInner.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None,
            "nm_id": obj.get("nm_id")
        })
        return _obj
