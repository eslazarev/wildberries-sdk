...
from wildberries_sdk_promotion.configuration import Configuration
from wildberries_sdk_promotion.api_response import ApiResponse, T as ApiResponseT
import wildberries_sdk_promotion.models
from wildberries_sdk_promotion import rest
from wildberries_sdk_promotion.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wildberries_sdk_promotion.models, klass)
