...
class PostV1AcquiringList400Response(BaseModel):
    """
    PostV1AcquiringList400Response
    """ # noqa: E501
    status: StrictInt = Field(description="HTTP статус-код", json_schema_extra={"examples": [400]})
    title: StrictStr = Field(description="Заголовок ошибки", json_schema_extra={"examples": ["GetAcquiringGeneralReport decode error"]})
    detail: StrictStr = Field(description="Детали ошибки", json_schema_extra={"examples": ["GetAcquiringGeneralReport decode error: Key: 'AcquiringGeneralReportRequestV2.DateTo' Error:Field validation for 'DateTo' failed on the 'required' tag"]})
    request_id: StrictStr = Field(description="ID запроса", alias="requestId", json_schema_extra={"examples": ["4950c661-9056-4baa-a0ed-c7e498c4a557"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1AcquiringList400Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1AcquiringList400Response from a dict"""
        if obj is None:
            return None
