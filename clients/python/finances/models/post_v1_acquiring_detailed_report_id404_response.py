...
class PostV1AcquiringDetailedReportId404Response(BaseModel):
    """
    PostV1AcquiringDetailedReportId404Response
    """ # noqa: E501
    status: StrictInt = Field(description="HTTP статус-код", json_schema_extra={"examples": [404]})
    title: StrictStr = Field(description="Заголовок ошибки", json_schema_extra={"examples": ["GetAcquiringReportByReportID usecase error"]})
    detail: StrictStr = Field(description="Детали ошибки", json_schema_extra={"examples": ["GetAcquiringReportByReportID usecase error: generate meta key: get report data: report id not found"]})
    request_id: StrictStr = Field(description="ID запроса", alias="requestId", json_schema_extra={"examples": ["b8c4a3db-2860-4df6-99dc-10602ddbc003"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1AcquiringDetailedReportId404Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1AcquiringDetailedReportId404Response from a dict"""
        if obj is None:
            return None
