...
class PostV1SalesReportsDetailedReportId404Response(BaseModel):
    """
    ...
    title: StrictStr = Field(description="Заголовок ошибки", json_schema_extra={"examples": ["GetDetailsByReportID error"]})
    detail: StrictStr = Field(description="Детали ошибки", json_schema_extra={"examples": ["GetDetailsByReportID error: generate meta key: get report data: report id not found"]})
    request_id: StrictStr = Field(description="ID запроса", alias="requestId", json_schema_extra={"examples": ["4565feab-860b-493c-ad8d-6eda4d1902db"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1SalesReportsDetailedReportId404Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1SalesReportsDetailedReportId404Response from a dict"""
        if obj is None:
            return None
