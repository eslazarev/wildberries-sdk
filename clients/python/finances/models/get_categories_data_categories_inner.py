...
class GetCategoriesDataCategoriesInner(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="ID категории документа из параметра [запроса](./financial-reports-and-accounting#tag/documents/operation/getV1DocumentsList) `category`", json_schema_extra={"examples": ["redeem-notification"]})
    title: Optional[StrictStr] = Field(default=None, description="Название категории документа из поля [ответа](./financial-reports-and-accounting#tag/documents/~1api~1v1~1documents~1list/get) `category`", json_schema_extra={"examples": ["Уведомление о выкупе"]})
