...
class GetV2News200Response(BaseModel):
    """
    GetV2News200Response
    """ # noqa: E501
    data: Optional[List[GetV2News200ResponseDataInner]] = Field(default=None, description="Новости")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2News200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2News200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [GetV2News200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
