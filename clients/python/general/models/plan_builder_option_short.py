...
class PlanBuilderOptionShort(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Название опции на языке из параметра `locale`", json_schema_extra={"examples": ["Закрепление отзывов и видео"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlanBuilderOptionShort from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlanBuilderOptionShort from a dict"""
        if obj is None:
            return None
