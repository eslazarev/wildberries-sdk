...
class DefaultApi:
    ...
    def get_ping_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[GetPing200Response]:
        """Проверка подключения
    ...
    def get_v1_seller_info(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1SellerInfo200Response",
            '401': "GetPing401Response",
            '402': "GetV1SellerInfo402Response",
            '429': "GetPing401Response",
        }
    ...
    def get_v1_seller_info_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[GetV1SellerInfo200Response]:
        """Получить информацию о продавце
    ...
    def get_v2_news_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[GetV2News200Response]:
        """Получение новостей портала продавцов
