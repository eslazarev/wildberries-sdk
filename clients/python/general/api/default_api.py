...
class DefaultApi:
    ...
    @validate_call
    def get_common_v1_tariff_constructor_options(
        self,
        ...
        _param = self._get_common_v1_tariff_constructor_options_serialize(
            locale=locale,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_common_v1_tariff_constructor_options_with_http_info(
        self,
        locale: Annotated[Optional[StrictStr], Field(description="Язык полей ответа:   - `ru` — русский   - `en` — английский ")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_common_v1_tariff_constructor_options_without_preload_content(
        self,
        locale: Annotated[Optional[StrictStr], Field(description="Язык полей ответа:   - `ru` — русский   - `en` — английский ")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_common_v1_tariff_constructor_options_serialize(
        self,
        locale,
        _request_auth,
        _content_type,
