...
class DefaultApi:
    ...
    @validate_call
    def get_v1_analytics_banned_products_shadowed(
        self,
        ...
        """(Deprecated) Скрытые из каталога
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /api/v1/analytics/banned-products/shadowed is deprecated.", DeprecationWarning)

        _param = self._get_v1_analytics_banned_products_shadowed_serialize(
            sort=sort,
            order=order,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetV1AnalyticsBannedProductsShadowed200Response",
            '400': "GetV1AnalyticsBannedProducsBlocked400Response",
            '401': "GetV1SupplierOrders401Response",
            '402': "GetV1SupplierOrders402Response",
            '429': "GetV1SupplierOrders401Response",
    ...
    @validate_call
    def get_v1_analytics_banned_products_shadowed_with_http_info(
        self,
        sort: Annotated[StrictStr, Field(description="Сортировка - `brand` — по бренду - `nmId` — по артикулу WB - `title` — по наименованию товара - `vendorCode` — по артикулу продавца - `nmRating` — по рейтингу товара ")],
        order: Annotated[StrictStr, Field(description="Порядок выдачи - `desc` — от наибольшего числового значения к наименьшему, от последнего по алфавиту значения к первому - `asc` — от наименьшего числового значения к наибольшему, от первого по алфавиту значения к последнему ")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[GetV1AnalyticsBannedProductsShadowed200Response]:
        """(Deprecated) Скрытые из каталога
    ...
    @validate_call
    def get_v1_analytics_banned_products_shadowed_without_preload_content(
        self,
        sort: Annotated[StrictStr, Field(description="Сортировка - `brand` — по бренду - `nmId` — по артикулу WB - `title` — по наименованию товара - `vendorCode` — по артикулу продавца - `nmRating` — по рейтингу товара ")],
        order: Annotated[StrictStr, Field(description="Порядок выдачи - `desc` — от наибольшего числового значения к наименьшему, от последнего по алфавиту значения к первому - `asc` — от наименьшего числового значения к наибольшему, от первого по алфавиту значения к последнему ")],
        _request_timeout: Union[
    ...
    def _get_v1_analytics_banned_products_shadowed_serialize(
        self,
        sort,
        order,
        _request_auth,
