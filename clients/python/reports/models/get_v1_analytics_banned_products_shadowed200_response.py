...
class GetV1AnalyticsBannedProductsShadowed200Response(BaseModel):
    """
    GetV1AnalyticsBannedProductsShadowed200Response
    """ # noqa: E501
    report: Optional[List[GetV1AnalyticsBannedProductsShadowed200ResponseReportInner]] = Field(default=None, description="Отчёт")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1AnalyticsBannedProductsShadowed200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1AnalyticsBannedProductsShadowed200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "report": [GetV1AnalyticsBannedProductsShadowed200ResponseReportInner.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
        return _obj
