...
class ModelsListDraftsResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelsListDraftsResponse from a JSON string"""
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.drafts:
            for _item_drafts in self.drafts:
                _items.append(_item_drafts.to_dict() if _item_drafts is not None else None)
            _dict['drafts'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelsListDraftsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "drafts": [ModelsDraftItem.from_dict(_item) for _item in obj["drafts"]] if obj.get("drafts") is not None else None
        })
        return _obj
