...
class ModelsDraftCreateResponse(BaseModel):
    """
    ModelsDraftCreateResponse
    """ # noqa: E501
    draft_id: StrictStr = Field(description="ID черновика", alias="draftId", json_schema_extra={"examples": ["cd20d135-f13f-47a0-903c-3bd268b92047"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelsDraftCreateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelsDraftCreateResponse from a dict"""
        if obj is None:
            return None
