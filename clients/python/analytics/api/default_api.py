...
class DefaultApi:
    ...
    @validate_call
    def post_analytics_v1_stocks_report_seller_warehouses(
        self,
        ...
        _param = self._post_analytics_v1_stocks_report_seller_warehouses_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostAnalyticsV1StocksReportSellerWarehouses200Response",
            '204': None,
            '400': "ErrorObject400",
            '401': "PostV3SalesFunnelProducts401Response",
            '403': "ErrorObject403",
    ...
    @validate_call
    def post_analytics_v1_stocks_report_seller_warehouses_with_http_info(
        self,
        inventory_request: InventoryRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[PostAnalyticsV1StocksReportSellerWarehouses200Response]:
        """Остатки на складах продавца
    ...
    @validate_call
    def post_analytics_v1_stocks_report_seller_warehouses_without_preload_content(
        self,
        inventory_request: InventoryRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_analytics_v1_stocks_report_seller_warehouses_serialize(
        self,
        inventory_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/analytics/v1/stocks-report/seller-warehouses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
