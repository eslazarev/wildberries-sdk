...
class FeedbacksIncreaseItemOneStar(BaseModel):
    """
    Отзывы 1 звезда
    """ # noqa: E501
    ...
    total: StrictInt = Field(description="Всего оценок", json_schema_extra={"examples": [7]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeedbacksIncreaseItemOneStar from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeedbacksIncreaseItemOneStar from a dict"""
        if obj is None:
            return None
