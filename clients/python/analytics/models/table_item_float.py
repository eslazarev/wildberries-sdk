...
class TableItemFloat(BaseModel):
    ...
    Рейтинг продавца
    """ # noqa: E501
    current: Union[StrictFloat, StrictInt] = Field(description="Текущий рейтинг", json_schema_extra={"examples": [3.56]})
    dynamics: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Динамика по сравнению с предыдущим периодом, %", json_schema_extra={"examples": [0.03]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableItemFloat from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableItemFloat from a dict"""
        if obj is None:
            return None
