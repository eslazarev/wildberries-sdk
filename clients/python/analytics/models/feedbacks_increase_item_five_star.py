...
class FeedbacksIncreaseItemFiveStar(BaseModel):
    """
    Отзывы 5 звёзд
    """ # noqa: E501
    current: StrictInt = Field(description="Прирост оценок за период", json_schema_extra={"examples": [19]})
    dynamics: Optional[StrictInt] = Field(default=None, description="Динамика по сравнению с предыдущим периодом, %", json_schema_extra={"examples": [17]})
    total: StrictInt = Field(description="Всего оценок", json_schema_extra={"examples": [51]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeedbacksIncreaseItemFiveStar from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeedbacksIncreaseItemFiveStar from a dict"""
        if obj is None:
            return None
