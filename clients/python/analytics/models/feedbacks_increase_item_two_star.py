...
class FeedbacksIncreaseItemTwoStar(BaseModel):
    """
    Отзывы 2 звезды
    """ # noqa: E501
    current: StrictInt = Field(description="Прирост оценок за период", json_schema_extra={"examples": [5]})
    dynamics: Optional[StrictInt] = Field(default=None, description="Динамика по сравнению с предыдущим периодом, %", json_schema_extra={"examples": [5]})
    total: StrictInt = Field(description="Всего оценок", json_schema_extra={"examples": [34]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeedbacksIncreaseItemTwoStar from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeedbacksIncreaseItemTwoStar from a dict"""
        if obj is None:
            return None
