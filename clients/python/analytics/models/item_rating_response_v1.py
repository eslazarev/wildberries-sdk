...
class ItemRatingResponseV1(BaseModel):
    """
    Данные ответа
    """ # noqa: E501
    ...
    cards: List[DistributionTableItemV1] = Field(description="Данные по товарам")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ItemRatingResponseV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ItemRatingResponseV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cards": [DistributionTableItemV1.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None
        })
        return _obj
