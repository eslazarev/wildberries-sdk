...
class DistributionTableIndicatorsTwoStar(BaseModel):
    """
    Отзывы 2 звезды
    """ # noqa: E501
    current: StrictInt = Field(description="Прирост оценок за период", json_schema_extra={"examples": [2]})
    dynamics: Optional[StrictInt] = Field(default=None, description="Динамика по сравнению с предыдущим периодом, %", json_schema_extra={"examples": [2]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributionTableIndicatorsTwoStar from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributionTableIndicatorsTwoStar from a dict"""
        if obj is None:
            return None
