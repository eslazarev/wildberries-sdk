...
class PostV3DbwOrdersStatus200Response(BaseModel):
    """
    PostV3DbwOrdersStatus200Response
    """ # noqa: E501
    orders: Optional[List[PostV3DbwOrdersStatus200ResponseOrdersInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3DbwOrdersStatus200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3DbwOrdersStatus200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "orders": [PostV3DbwOrdersStatus200ResponseOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
