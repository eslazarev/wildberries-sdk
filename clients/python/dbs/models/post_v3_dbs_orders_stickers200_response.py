...
class PostV3DbsOrdersStickers200Response(BaseModel):
    """
    PostV3DbsOrdersStickers200Response
    """ # noqa: E501
    stickers: Optional[List[PostV3DbsOrdersStickers200ResponseStickersInner]] = Field(default=None, description="Стикеры")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3DbsOrdersStickers200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3DbsOrdersStickers200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stickers": [PostV3DbsOrdersStickers200ResponseStickersInner.from_dict(_item) for _item in obj["stickers"]] if obj.get("stickers") is not None else None
        })
        return _obj
