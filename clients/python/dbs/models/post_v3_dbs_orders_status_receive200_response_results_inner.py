...
class PostV3DbsOrdersStatusReceive200ResponseResultsInner(BaseModel):
    """
    PostV3DbsOrdersStatusReceive200ResponseResultsInner
    """ # noqa: E501
    errors: Optional[List[PostV3DbsOrdersStatusReceive200ResponseResultsInnerErrorsInner]] = Field(default=None, description="Детали ошибки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3DbsOrdersStatusReceive200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3DbsOrdersStatusReceive200ResponseResultsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "errors": [PostV3DbsOrdersStatusReceive200ResponseResultsInnerErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
