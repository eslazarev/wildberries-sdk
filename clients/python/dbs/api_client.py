...
from wildberries_sdk.dbs.configuration import Configuration
from wildberries_sdk.dbs.api_response import ApiResponse, T as ApiResponseT
import wildberries_sdk.dbs.models
from wildberries_sdk.dbs import rest
from wildberries_sdk.dbs.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.1.159/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wildberries_sdk.dbs.models, klass)
