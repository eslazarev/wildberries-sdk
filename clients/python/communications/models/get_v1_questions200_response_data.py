...
class GetV1Questions200ResponseData(BaseModel):
    """
    ...
    questions: Optional[List[GetV1Questions200ResponseDataQuestionsInner]] = Field(default=None, description="Вопросы")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1Questions200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1Questions200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "questions": [GetV1Questions200ResponseDataQuestionsInner.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None
        })
        return _obj
