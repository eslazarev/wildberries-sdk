...
class GetV1Question200ResponseData(BaseModel):
    """
    ...
    answer: Optional[GetV1Question200ResponseDataAnswer] = None
    product_details: Optional[GetV1Question200ResponseDataProductDetails] = Field(default=None, alias="productDetails")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1Question200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1Question200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "answer": GetV1Question200ResponseDataAnswer.from_dict(obj["answer"]) if obj.get("answer") is not None else None,
            "productDetails": GetV1Question200ResponseDataProductDetails.from_dict(obj["productDetails"]) if obj.get("productDetails") is not None else None,
