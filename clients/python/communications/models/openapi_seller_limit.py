...
class OpenapiSellerLimit(BaseModel):
    ...
    OpenapiSellerLimit
    """ # noqa: E501
    per_unit_limit: StrictInt = Field(description="Максимальное количество закреплённых отзывов в одной карточке товара или в группе [объединённых](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточек", alias="perUnitLimit", json_schema_extra={"examples": [2]})
