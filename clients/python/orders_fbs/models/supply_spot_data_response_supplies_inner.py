...
class SupplySpotDataResponseSuppliesInner(BaseModel):
    ...
    spot: Optional[SupplySpotData] = Field(default=None, description="Данные СПОТ")
    error: Optional[ApiErrorV3] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SupplySpotDataResponseSuppliesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SupplySpotDataResponseSuppliesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "spot": SupplySpotData.from_dict(obj["spot"]) if obj.get("spot") is not None else None,
            "error": ApiErrorV3.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
