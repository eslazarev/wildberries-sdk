...
class PostV3OrdersStickersCrossBorderRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3OrdersStickersCrossBorderRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3OrdersStickersCrossBorderRequest from a dict"""
        if obj is None:
            return None
