...
class GetV3SuppliesOrdersReshipment200ResponseOrdersInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV3SuppliesOrdersReshipment200ResponseOrdersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV3SuppliesOrdersReshipment200ResponseOrdersInner from a dict"""
        if obj is None:
            return None
