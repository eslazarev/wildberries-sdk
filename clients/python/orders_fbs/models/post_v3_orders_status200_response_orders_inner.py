...
class PostV3OrdersStatus200ResponseOrdersInner(BaseModel):
    """
    ...
    is_cancellable: Optional[StrictBool] = Field(default=None, description="Доступна ли [отмена](./orders-fbs#tag/fbsAssemblyOrders/operation/patchV3OrdersOrderIdCancel) сборочного задания: - `false` — недоступна - `true` — доступна ", alias="isCancellable", json_schema_extra={"examples": [False]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3OrdersStatus200ResponseOrdersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3OrdersStatus200ResponseOrdersInner from a dict"""
        if obj is None:
            return None
