...
class GetMarketplaceV3FbsSettingsAutoreturns200Response(BaseModel):
    """
    GetMarketplaceV3FbsSettingsAutoreturns200Response
    """ # noqa: E501
    type: StrictStr = Field(description="Тип автовозврата:   - `allToWarehouse` — все товары отправляются на склад WB, кроме товаров тех [предметов](/openapi/orders-fbs#tag/autoreturnSettings/operation/getMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted), которые автоматически возвращаются в ПВЗ   - `allToPickupPoint` — все товары отправляются на пункт выдачи заказов   - `manual` — используются ручные настройки ", json_schema_extra={"examples": ["allToWarehouse"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetMarketplaceV3FbsSettingsAutoreturns200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetMarketplaceV3FbsSettingsAutoreturns200Response from a dict"""
        if obj is None:
            return None
