...
class V3APIErrorV2(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V3APIErrorV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V3APIErrorV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "errors": [V3APIErrorV2ErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
