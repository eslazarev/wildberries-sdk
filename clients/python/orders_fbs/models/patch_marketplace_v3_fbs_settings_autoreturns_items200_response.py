...
class PatchMarketplaceV3FbsSettingsAutoreturnsItems200Response(BaseModel):
    """
    PatchMarketplaceV3FbsSettingsAutoreturnsItems200Response
    """ # noqa: E501
    results: List[PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchMarketplaceV3FbsSettingsAutoreturnsItems200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchMarketplaceV3FbsSettingsAutoreturnsItems200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
