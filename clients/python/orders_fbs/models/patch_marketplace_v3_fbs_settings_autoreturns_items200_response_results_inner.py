...
class PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner(BaseModel):
    """
    ...
    error: Optional[List[PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInnerErrorInner]] = Field(default=None, description="Детали ошибки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "error": [PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInnerErrorInner.from_dict(_item) for _item in obj["error"]] if obj.get("error") is not None else None,
