...
class PatchMarketplaceV3FbsSettingsAutoreturnsRequest(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Тип автовозврата малогабаритных товаров:   - `allToWarehouse` — отправлять все товары на склад WB, кроме товаров тех [предметов](/openapi/orders-fbs#tag/autoreturnSettings/operation/getMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted), которые автоматически возвращаются в ПВЗ   - `allToPickupPoint` — отправлять все товары на пункт выдачи заказов   - `manual` — использовать ручные настройки ", json_schema_extra={"examples": ["allToWarehouse"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchMarketplaceV3FbsSettingsAutoreturnsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchMarketplaceV3FbsSettingsAutoreturnsRequest from a dict"""
        if obj is None:
            return None
