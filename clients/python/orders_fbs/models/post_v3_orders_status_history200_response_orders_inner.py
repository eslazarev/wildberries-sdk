...
class PostV3OrdersStatusHistory200ResponseOrdersInner(BaseModel):
    """
    ...
    statuses: Optional[List[PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner]] = Field(default=None, description="Статусы")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3OrdersStatusHistory200ResponseOrdersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3OrdersStatusHistory200ResponseOrdersInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "statuses": [PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None,
