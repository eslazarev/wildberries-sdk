...
class UpdateSupplyWaybill(BaseModel):
    ...
    waybill_uuid: UUID = Field(description="ID ЭТрН", alias="waybillUuid", json_schema_extra={"examples": ["550e8400-e29b-41d4-a716-445676543567"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSupplyWaybill from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSupplyWaybill from a dict"""
        if obj is None:
            return None
