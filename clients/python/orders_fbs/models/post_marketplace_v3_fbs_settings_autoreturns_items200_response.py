...
class PostMarketplaceV3FbsSettingsAutoreturnsItems200Response(BaseModel):
    """
    PostMarketplaceV3FbsSettingsAutoreturnsItems200Response
    """ # noqa: E501
    results: List[PostMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostMarketplaceV3FbsSettingsAutoreturnsItems200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostMarketplaceV3FbsSettingsAutoreturnsItems200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [PostMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
