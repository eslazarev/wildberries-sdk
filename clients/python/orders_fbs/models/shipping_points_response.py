...
class ShippingPointsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShippingPointsResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in shipping_points (list)
        _items = []
        if self.shipping_points:
            for _item_shipping_points in self.shipping_points:
                _items.append(_item_shipping_points.to_dict() if _item_shipping_points is not None else None)
            _dict['shippingPoints'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShippingPointsResponse from a dict"""
        if obj is None:
            return None
