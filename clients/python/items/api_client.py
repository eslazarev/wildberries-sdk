...
from wildberries_sdk.items.configuration import Configuration
from wildberries_sdk.items.api_response import ApiResponse, T as ApiResponseT
import wildberries_sdk.items.models
from wildberries_sdk.items import rest
from wildberries_sdk.items.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.1.109/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wildberries_sdk.items.models, klass)
