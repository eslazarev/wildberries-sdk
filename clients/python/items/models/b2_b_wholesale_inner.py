...
class B2BWholesaleInner(BaseModel):
    """
    B2BWholesaleInner
    """ # noqa: E501
    nm_id: StrictInt = Field(description="Артикул WB", alias="nmId", json_schema_extra={"examples": [694707813]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of B2BWholesaleInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of B2BWholesaleInner from a dict"""
        if obj is None:
            return None
