...
class PostV3StocksWarehouseId200Response(BaseModel):
    """
    PostV3StocksWarehouseId200Response
    """ # noqa: E501
    stocks: Optional[List[PostV3StocksWarehouseId200ResponseStocksInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3StocksWarehouseId200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3StocksWarehouseId200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stocks": [PostV3StocksWarehouseId200ResponseStocksInner.from_dict(_item) for _item in obj["stocks"]] if obj.get("stocks") is not None else None
        })
        return _obj
