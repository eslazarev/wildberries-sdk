...
class ContentV2CardsUpdatePostRequestInnerDocuments(BaseModel):
    """
    Документы
    """ # noqa: E501
    items: Optional[List[ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner]] = Field(default=None, description="Список документов")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentV2CardsUpdatePostRequestInnerDocuments from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentV2CardsUpdatePostRequestInnerDocuments from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
