...
class PostV2CardsUploadRequestInnerVariantsInner(BaseModel):
    """
    ...
    dimensions: Optional[PostV2CardsUploadRequestInnerVariantsInnerDimensions] = None
    sizes: Optional[List[PostV2CardsUploadRequestInnerVariantsInnerSizesInner]] = Field(default=None, description="Массив размеров.<br> Если не указать для размерного товара (обувь, одежда и др.), сгенерируется автоматически с `techSize` = \"A\", `wbSize` = \"1\" и баркодом ")
    ...
    __properties: ClassVar[List[str]] = ["brand", "title", "description", "vendorCode", "kizMarked", "wholesale", "dimensions", "sizes", "characteristics", "documents"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2CardsUploadRequestInnerVariantsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2CardsUploadRequestInnerVariantsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dimensions": PostV2CardsUploadRequestInnerVariantsInnerDimensions.from_dict(obj["dimensions"]) if obj.get("dimensions") is not None else None,
            "sizes": [PostV2CardsUploadRequestInnerVariantsInnerSizesInner.from_dict(_item) for _item in obj["sizes"]] if obj.get("sizes") is not None else None,
