...
class GetV3DbwWarehousesWarehouseIdContacts200Response(BaseModel):
    """
    Список контактов склада продавца
    """ # noqa: E501
    contacts: Optional[List[GetV3DbwWarehousesWarehouseIdContacts200ResponseContactsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV3DbwWarehousesWarehouseIdContacts200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV3DbwWarehousesWarehouseIdContacts200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "contacts": [GetV3DbwWarehousesWarehouseIdContacts200ResponseContactsInner.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None
        })
        return _obj
