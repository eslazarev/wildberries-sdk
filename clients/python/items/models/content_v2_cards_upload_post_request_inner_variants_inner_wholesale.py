...
class ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale(BaseModel):
    """
    B2B-продажа
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=False, description="Предназначен ли товар для продажи только B2B-покупателям:   - `true` — товар предназначен для продажи только B2B-покупателям   - `false` — товар предназначен для продажи B2B и B2C-покупателям ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale from a dict"""
        if obj is None:
            return None
