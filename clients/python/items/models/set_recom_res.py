...
class SetRecomRes(BaseModel):
    ...
    SetRecomRes
    """ # noqa: E501
    is_error: StrictBool = Field(description="Есть ли ошибки:   - `false` — ошибок нет. Запрос полностью успешен   - `true` — ошибки есть ", alias="isError", json_schema_extra={"examples": [True]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetRecomRes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetRecomRes from a dict"""
        if obj is None:
            return None
