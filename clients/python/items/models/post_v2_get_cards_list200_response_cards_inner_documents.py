...
class PostV2GetCardsList200ResponseCardsInnerDocuments(BaseModel):
    """
    Документы
    """ # noqa: E501
    items: Optional[List[PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInner]] = Field(default=None, description="Список документов")
    overall_verdict: Optional[PostV2GetCardsList200ResponseCardsInnerDocumentsOverallVerdict] = Field(default=None, alias="overallVerdict")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200ResponseCardsInnerDocuments from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200ResponseCardsInnerDocuments from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "overallVerdict": PostV2GetCardsList200ResponseCardsInnerDocumentsOverallVerdict.from_dict(obj["overallVerdict"]) if obj.get("overallVerdict") is not None else None,
