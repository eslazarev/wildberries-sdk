...
class PostV2GetCardsList200ResponseCardsInnerPhotosInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200ResponseCardsInnerPhotosInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200ResponseCardsInnerPhotosInner from a dict"""
        if obj is None:
            return None
