...
class Response208SetRecom(BaseModel):
    ...
    detail: StrictStr = Field(description="Детали ответа", json_schema_extra={"examples": ["Recommendations already set"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Response208SetRecom from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Response208SetRecom from a dict"""
        if obj is None:
            return None
