...
class Response400GetRecom(BaseModel):
    """
    Response400GetRecom
    """ # noqa: E501
    ...
    detail: StrictStr = Field(description="Детали ошибки", json_schema_extra={"examples": ["Search string length limit exceeded, maximum 72 required"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Response400GetRecom from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Response400GetRecom from a dict"""
        if obj is None:
            return None
