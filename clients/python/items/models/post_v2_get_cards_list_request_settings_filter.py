...
class PostV2GetCardsListRequestSettingsFilter(BaseModel):
    ...
    """ # noqa: E501
    with_photo: Optional[StrictInt] = Field(default=0, description="Фильтр по фото:   * `-1` — любые карточки товаров   * `0` — только карточки без фото. С [16 июня](/release-notes?id=531) — любые карточки товаров   * `1` — только карточки с фото   * `2` — только карточки без фото. С [16 июня](/release-notes?id=531) ", alias="withPhoto")
    ...
    imt_id: Optional[StrictInt] = Field(default=None, description="Поиск по [ID для объединённых карточек товаров](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov)", alias="imtID")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsListRequestSettingsFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsListRequestSettingsFilter from a dict"""
        if obj is None:
            return None
