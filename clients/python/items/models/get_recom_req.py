...
class GetRecomReq(BaseModel):
    ...
    """ # noqa: E501
    brand_names: Optional[Annotated[List[StrictStr], Field(max_length=30)]] = Field(default=None, description="Бренды", alias="brandNames", json_schema_extra={"examples": [["Comma"]]})
    limit: Optional[Annotated[int, Field(le=5000, strict=True, ge=0)]] = Field(default=20, description="Количество товаров в ответе")
    next: Optional[StrictInt] = Field(default=0, description="Курсор. Последний `nmId` в ответе", json_schema_extra={"examples": [123]})
    search: Optional[Annotated[str, Field(strict=True, max_length=72)]] = Field(default=None, description="Поиск:   - по артикулу WB `nmId` — полное совпадение   - по артикулу продавца `vendorCode` — частичное совпадение ", json_schema_extra={"examples": ["410"]})
    subject_ids: Optional[Annotated[List[StrictInt], Field(max_length=30)]] = Field(default=None, description="ID предметов", alias="subjectIds", json_schema_extra={"examples": [[123, 5231]]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRecomReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRecomReq from a dict"""
        if obj is None:
            return None
