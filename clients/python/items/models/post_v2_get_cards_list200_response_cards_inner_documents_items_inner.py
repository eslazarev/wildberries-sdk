...
class PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInner(BaseModel):
    """
    ...
    verdict: Optional[PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInnerVerdict] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "verdict": PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInnerVerdict.from_dict(obj["verdict"]) if obj.get("verdict") is not None else None,
