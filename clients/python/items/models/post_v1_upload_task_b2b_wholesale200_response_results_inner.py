...
class PostV1UploadTaskB2bWholesale200ResponseResultsInner(BaseModel):
    ...
    """ # noqa: E501
    nm_id: StrictInt = Field(description="Артикул WB", alias="nmId", json_schema_extra={"examples": [1]})
    success: StrictBool = Field(description="Успешна ли установка скидки на товар:   - `false` — неуспешна   - `true` — успешна ", json_schema_extra={"examples": [False]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1UploadTaskB2bWholesale200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1UploadTaskB2bWholesale200ResponseResultsInner from a dict"""
        if obj is None:
            return None
