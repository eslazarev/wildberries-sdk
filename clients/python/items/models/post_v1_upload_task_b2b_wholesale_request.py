...
class PostV1UploadTaskB2bWholesaleRequest(BaseModel):
    ...
    """ # noqa: E501
    data: Annotated[List[B2BWholesaleInner], Field(min_length=1, max_length=1000)] = Field(description="Товары и оптовые скидки для B2B")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1UploadTaskB2bWholesaleRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1UploadTaskB2bWholesaleRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [B2BWholesaleInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
