...
class PostV3ClickCollectOrdersMetaCustomsDeclarationRequestOrdersInner(BaseModel):
    """
    ...
    origin_country_code: Annotated[str, Field(strict=True, max_length=3)] = Field(description="Числовой код страны происхождения товара из [Общероссийского классификатора стран мира](https://esnsi.gosuslugi.ru/classifiers/16269)", alias="originCountryCode", json_schema_extra={"examples": ["643"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3ClickCollectOrdersMetaCustomsDeclarationRequestOrdersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3ClickCollectOrdersMetaCustomsDeclarationRequestOrdersInner from a dict"""
        if obj is None:
            return None
