...
class ApiOrderOptions(BaseModel):
    """
    Опции заказа
    """ # noqa: E501
    is_b2b: Optional[StrictBool] = Field(default=None, description="Признак B2B-продажи:   - `false` — не B2B-продажа   - `true` — B2B-продажа ", alias="isB2b", json_schema_extra={"examples": [False]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiOrderOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiOrderOptions from a dict"""
        if obj is None:
            return None
