...
class ApiStatusSetCustomsDeclarationResponse(BaseModel):
    """
    ...
    errors: Optional[List[ApiBatchCustomsDeclarationErrorResponse]] = Field(default=None, description="Детали ошибки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiStatusSetCustomsDeclarationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiStatusSetCustomsDeclarationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "errors": [ApiBatchCustomsDeclarationErrorResponse.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
