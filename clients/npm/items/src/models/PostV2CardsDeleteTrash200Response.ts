 ...
 * 
 * @export
 * @interface PostV2CardsDeleteTrash200Response
 */
export interface PostV2CardsDeleteTrash200Response {
    /**
     * 
     */
    data?: object | null;
...
/**
 * Check if a given object implements the PostV2CardsDeleteTrash200Response interface.
 */
export function instanceOfPostV2CardsDeleteTrash200Response(value: object): value is PostV2CardsDeleteTrash200Response {
    return true;
}

export function PostV2CardsDeleteTrash200ResponseFromJSON(json: any): PostV2CardsDeleteTrash200Response {
    return PostV2CardsDeleteTrash200ResponseFromJSONTyped(json, false);
}

export function PostV2CardsDeleteTrash200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV2CardsDeleteTrash200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV2CardsDeleteTrash200ResponseToJSON(json: any): PostV2CardsDeleteTrash200Response {
    return PostV2CardsDeleteTrash200ResponseToJSONTyped(json, false);
}

export function PostV2CardsDeleteTrash200ResponseToJSONTyped(value?: PostV2CardsDeleteTrash200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
