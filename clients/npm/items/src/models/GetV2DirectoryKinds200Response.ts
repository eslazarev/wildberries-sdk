 ...
 * 
 * @export
 * @interface GetV2DirectoryKinds200Response
 */
export interface GetV2DirectoryKinds200Response {
    /**
...
/**
 * Check if a given object implements the GetV2DirectoryKinds200Response interface.
 */
export function instanceOfGetV2DirectoryKinds200Response(value: object): value is GetV2DirectoryKinds200Response {
    return true;
}

export function GetV2DirectoryKinds200ResponseFromJSON(json: any): GetV2DirectoryKinds200Response {
    return GetV2DirectoryKinds200ResponseFromJSONTyped(json, false);
}

export function GetV2DirectoryKinds200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2DirectoryKinds200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV2DirectoryKinds200ResponseToJSON(json: any): GetV2DirectoryKinds200Response {
    return GetV2DirectoryKinds200ResponseToJSONTyped(json, false);
}

export function GetV2DirectoryKinds200ResponseToJSONTyped(value?: GetV2DirectoryKinds200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
