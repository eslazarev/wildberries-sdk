...
import type { GetV2CardsLimits200ResponseData } from './GetV2CardsLimits200ResponseData';
import {
    GetV2CardsLimits200ResponseDataFromJSON,
    GetV2CardsLimits200ResponseDataFromJSONTyped,
    GetV2CardsLimits200ResponseDataToJSON,
    GetV2CardsLimits200ResponseDataToJSONTyped,
} from './GetV2CardsLimits200ResponseData';

/**
 * 
 * @export
 * @interface GetV2CardsLimits200Response
 */
export interface GetV2CardsLimits200Response {
    /**
     * 
     */
    data?: GetV2CardsLimits200ResponseData;
    /**
     * Флаг ошибки
     */
    error?: boolean;
...
/**
 * Check if a given object implements the GetV2CardsLimits200Response interface.
 */
export function instanceOfGetV2CardsLimits200Response(value: object): value is GetV2CardsLimits200Response {
    return true;
}

export function GetV2CardsLimits200ResponseFromJSON(json: any): GetV2CardsLimits200Response {
    return GetV2CardsLimits200ResponseFromJSONTyped(json, false);
}

export function GetV2CardsLimits200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2CardsLimits200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : GetV2CardsLimits200ResponseDataFromJSON(json['data']),
...
export function GetV2CardsLimits200ResponseToJSON(json: any): GetV2CardsLimits200Response {
    return GetV2CardsLimits200ResponseToJSONTyped(json, false);
}

export function GetV2CardsLimits200ResponseToJSONTyped(value?: GetV2CardsLimits200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': GetV2CardsLimits200ResponseDataToJSON(value['data']),
        'error': value['error'],
