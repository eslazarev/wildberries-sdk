...
/**
 * Check if a given object implements the PostV2GetCardsTrashRequestSettingsSort interface.
 */
export function instanceOfPostV2GetCardsTrashRequestSettingsSort(value: object): value is PostV2GetCardsTrashRequestSettingsSort {
    return true;
}

export function PostV2GetCardsTrashRequestSettingsSortFromJSON(json: any): PostV2GetCardsTrashRequestSettingsSort {
    return PostV2GetCardsTrashRequestSettingsSortFromJSONTyped(json, false);
}

export function PostV2GetCardsTrashRequestSettingsSortFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV2GetCardsTrashRequestSettingsSort {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV2GetCardsTrashRequestSettingsSortToJSON(json: any): PostV2GetCardsTrashRequestSettingsSort {
    return PostV2GetCardsTrashRequestSettingsSortToJSONTyped(json, false);
}

export function PostV2GetCardsTrashRequestSettingsSortToJSONTyped(value?: PostV2GetCardsTrashRequestSettingsSort | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
