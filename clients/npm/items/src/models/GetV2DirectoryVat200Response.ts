 ...
 * 
 * @export
 * @interface GetV2DirectoryVat200Response
 */
export interface GetV2DirectoryVat200Response {
    /**
     * 
     */
    data?: Array<string>;
...
/**
 * Check if a given object implements the GetV2DirectoryVat200Response interface.
 */
export function instanceOfGetV2DirectoryVat200Response(value: object): value is GetV2DirectoryVat200Response {
    return true;
}

export function GetV2DirectoryVat200ResponseFromJSON(json: any): GetV2DirectoryVat200Response {
    return GetV2DirectoryVat200ResponseFromJSONTyped(json, false);
}

export function GetV2DirectoryVat200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2DirectoryVat200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV2DirectoryVat200ResponseToJSON(json: any): GetV2DirectoryVat200Response {
    return GetV2DirectoryVat200ResponseToJSONTyped(json, false);
}

export function GetV2DirectoryVat200ResponseToJSONTyped(value?: GetV2DirectoryVat200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
