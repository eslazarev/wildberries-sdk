 ...
 * 
 * @export
 * @interface GetV2DirectoryTnved200ResponseDataInner
 */
export interface GetV2DirectoryTnved200ResponseDataInner {
    /**
     * ТНВЭД-код
     */
    tnved?: string;
...
/**
 * Check if a given object implements the GetV2DirectoryTnved200ResponseDataInner interface.
 */
export function instanceOfGetV2DirectoryTnved200ResponseDataInner(value: object): value is GetV2DirectoryTnved200ResponseDataInner {
    return true;
}

export function GetV2DirectoryTnved200ResponseDataInnerFromJSON(json: any): GetV2DirectoryTnved200ResponseDataInner {
    return GetV2DirectoryTnved200ResponseDataInnerFromJSONTyped(json, false);
}

export function GetV2DirectoryTnved200ResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2DirectoryTnved200ResponseDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV2DirectoryTnved200ResponseDataInnerToJSON(json: any): GetV2DirectoryTnved200ResponseDataInner {
    return GetV2DirectoryTnved200ResponseDataInnerToJSONTyped(json, false);
}

export function GetV2DirectoryTnved200ResponseDataInnerToJSONTyped(value?: GetV2DirectoryTnved200ResponseDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
