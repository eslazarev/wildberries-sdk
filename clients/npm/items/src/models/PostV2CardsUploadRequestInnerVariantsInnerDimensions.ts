...
/**
 * Check if a given object implements the PostV2CardsUploadRequestInnerVariantsInnerDimensions interface.
 */
export function instanceOfPostV2CardsUploadRequestInnerVariantsInnerDimensions(value: object): value is PostV2CardsUploadRequestInnerVariantsInnerDimensions {
    return true;
}

export function PostV2CardsUploadRequestInnerVariantsInnerDimensionsFromJSON(json: any): PostV2CardsUploadRequestInnerVariantsInnerDimensions {
    return PostV2CardsUploadRequestInnerVariantsInnerDimensionsFromJSONTyped(json, false);
}

export function PostV2CardsUploadRequestInnerVariantsInnerDimensionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV2CardsUploadRequestInnerVariantsInnerDimensions {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV2CardsUploadRequestInnerVariantsInnerDimensionsToJSON(json: any): PostV2CardsUploadRequestInnerVariantsInnerDimensions {
    return PostV2CardsUploadRequestInnerVariantsInnerDimensionsToJSONTyped(json, false);
}

export function PostV2CardsUploadRequestInnerVariantsInnerDimensionsToJSONTyped(value?: PostV2CardsUploadRequestInnerVariantsInnerDimensions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
