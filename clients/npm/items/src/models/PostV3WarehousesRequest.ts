...
/**
 * Check if a given object implements the PostV3WarehousesRequest interface.
 */
export function instanceOfPostV3WarehousesRequest(value: object): value is PostV3WarehousesRequest {
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('officeId' in value) || value['officeId'] === undefined) return false;
    return true;
}

export function PostV3WarehousesRequestFromJSON(json: any): PostV3WarehousesRequest {
    return PostV3WarehousesRequestFromJSONTyped(json, false);
}

export function PostV3WarehousesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3WarehousesRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3WarehousesRequestToJSON(json: any): PostV3WarehousesRequest {
    return PostV3WarehousesRequestToJSONTyped(json, false);
}

export function PostV3WarehousesRequestToJSONTyped(value?: PostV3WarehousesRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
