 ...
 * 
 * @export
 * @interface GetV2DirectorySeasons200Response
 */
export interface GetV2DirectorySeasons200Response {
    /**
...
/**
 * Check if a given object implements the GetV2DirectorySeasons200Response interface.
 */
export function instanceOfGetV2DirectorySeasons200Response(value: object): value is GetV2DirectorySeasons200Response {
    return true;
}

export function GetV2DirectorySeasons200ResponseFromJSON(json: any): GetV2DirectorySeasons200Response {
    return GetV2DirectorySeasons200ResponseFromJSONTyped(json, false);
}

export function GetV2DirectorySeasons200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2DirectorySeasons200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV2DirectorySeasons200ResponseToJSON(json: any): GetV2DirectorySeasons200Response {
    return GetV2DirectorySeasons200ResponseToJSONTyped(json, false);
}

export function GetV2DirectorySeasons200ResponseToJSONTyped(value?: GetV2DirectorySeasons200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
