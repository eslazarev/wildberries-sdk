 ...
 * 
 * @export
 * @interface GetV2DirectoryColors200ResponseDataInner
 */
export interface GetV2DirectoryColors200ResponseDataInner {
    /**
     * Наименование цвета
     */
    name?: string;
...
/**
 * Check if a given object implements the GetV2DirectoryColors200ResponseDataInner interface.
 */
export function instanceOfGetV2DirectoryColors200ResponseDataInner(value: object): value is GetV2DirectoryColors200ResponseDataInner {
    return true;
}

export function GetV2DirectoryColors200ResponseDataInnerFromJSON(json: any): GetV2DirectoryColors200ResponseDataInner {
    return GetV2DirectoryColors200ResponseDataInnerFromJSONTyped(json, false);
}

export function GetV2DirectoryColors200ResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2DirectoryColors200ResponseDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV2DirectoryColors200ResponseDataInnerToJSON(json: any): GetV2DirectoryColors200ResponseDataInner {
    return GetV2DirectoryColors200ResponseDataInnerToJSONTyped(json, false);
}

export function GetV2DirectoryColors200ResponseDataInnerToJSONTyped(value?: GetV2DirectoryColors200ResponseDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
