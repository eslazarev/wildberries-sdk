 ...
 * 
 * @export
 * @interface ContentV2ObjectAllGet403Response
 */
export interface ContentV2ObjectAllGet403Response {
    /**
     * Заголовок ошибки
     */
    title?: string;
...
/**
 * Check if a given object implements the ContentV2ObjectAllGet403Response interface.
 */
export function instanceOfContentV2ObjectAllGet403Response(value: object): value is ContentV2ObjectAllGet403Response {
    return true;
}

export function ContentV2ObjectAllGet403ResponseFromJSON(json: any): ContentV2ObjectAllGet403Response {
    return ContentV2ObjectAllGet403ResponseFromJSONTyped(json, false);
}

export function ContentV2ObjectAllGet403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContentV2ObjectAllGet403Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ContentV2ObjectAllGet403ResponseToJSON(json: any): ContentV2ObjectAllGet403Response {
    return ContentV2ObjectAllGet403ResponseToJSONTyped(json, false);
}

export function ContentV2ObjectAllGet403ResponseToJSONTyped(value?: ContentV2ObjectAllGet403Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
