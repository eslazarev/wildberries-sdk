 ...
 * 
 * @export
 * @interface PostV3MediaFile200Response
 */
export interface PostV3MediaFile200Response {
    /**
     * 
     */
    data?: object;
...
/**
 * Check if a given object implements the PostV3MediaFile200Response interface.
 */
export function instanceOfPostV3MediaFile200Response(value: object): value is PostV3MediaFile200Response {
    return true;
}

export function PostV3MediaFile200ResponseFromJSON(json: any): PostV3MediaFile200Response {
    return PostV3MediaFile200ResponseFromJSONTyped(json, false);
}

export function PostV3MediaFile200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3MediaFile200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3MediaFile200ResponseToJSON(json: any): PostV3MediaFile200Response {
    return PostV3MediaFile200ResponseToJSONTyped(json, false);
}

export function PostV3MediaFile200ResponseToJSONTyped(value?: PostV3MediaFile200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
