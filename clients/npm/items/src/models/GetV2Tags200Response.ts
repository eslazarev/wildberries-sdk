...
import type { GetV2Tags200ResponseData } from './GetV2Tags200ResponseData';
import {
    GetV2Tags200ResponseDataFromJSON,
    GetV2Tags200ResponseDataFromJSONTyped,
    GetV2Tags200ResponseDataToJSON,
    GetV2Tags200ResponseDataToJSONTyped,
} from './GetV2Tags200ResponseData';

/**
 * 
 * @export
 * @interface GetV2Tags200Response
 */
export interface GetV2Tags200Response {
    /**
     * 
     */
    data?: GetV2Tags200ResponseData;
    /**
     * Флаг ошибки
     */
    error?: boolean;
...
/**
 * Check if a given object implements the GetV2Tags200Response interface.
 */
export function instanceOfGetV2Tags200Response(value: object): value is GetV2Tags200Response {
    return true;
}

export function GetV2Tags200ResponseFromJSON(json: any): GetV2Tags200Response {
    return GetV2Tags200ResponseFromJSONTyped(json, false);
}

export function GetV2Tags200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2Tags200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : GetV2Tags200ResponseDataFromJSON(json['data']),
...
export function GetV2Tags200ResponseToJSON(json: any): GetV2Tags200Response {
    return GetV2Tags200ResponseToJSONTyped(json, false);
}

export function GetV2Tags200ResponseToJSONTyped(value?: GetV2Tags200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': GetV2Tags200ResponseDataToJSON(value['data']),
        'error': value['error'],
