 ...
 * 
 * @export
 * @interface GetV2Tags200ResponseData
 */
export interface GetV2Tags200ResponseData {
    /**
     * Числовой ID ярлыка
     */
    id?: number;
...
/**
 * Check if a given object implements the GetV2Tags200ResponseData interface.
 */
export function instanceOfGetV2Tags200ResponseData(value: object): value is GetV2Tags200ResponseData {
    return true;
}

export function GetV2Tags200ResponseDataFromJSON(json: any): GetV2Tags200ResponseData {
    return GetV2Tags200ResponseDataFromJSONTyped(json, false);
}

export function GetV2Tags200ResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2Tags200ResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV2Tags200ResponseDataToJSON(json: any): GetV2Tags200ResponseData {
    return GetV2Tags200ResponseDataToJSONTyped(json, false);
}

export function GetV2Tags200ResponseDataToJSONTyped(value?: GetV2Tags200ResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
