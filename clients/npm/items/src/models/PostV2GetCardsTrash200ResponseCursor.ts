 ...
 * Пагинатор
 * @export
 * @interface PostV2GetCardsTrash200ResponseCursor
 */
export interface PostV2GetCardsTrash200ResponseCursor {
    /**
...
/**
 * Check if a given object implements the PostV2GetCardsTrash200ResponseCursor interface.
 */
export function instanceOfPostV2GetCardsTrash200ResponseCursor(value: object): value is PostV2GetCardsTrash200ResponseCursor {
    return true;
}

export function PostV2GetCardsTrash200ResponseCursorFromJSON(json: any): PostV2GetCardsTrash200ResponseCursor {
    return PostV2GetCardsTrash200ResponseCursorFromJSONTyped(json, false);
}

export function PostV2GetCardsTrash200ResponseCursorFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV2GetCardsTrash200ResponseCursor {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV2GetCardsTrash200ResponseCursorToJSON(json: any): PostV2GetCardsTrash200ResponseCursor {
    return PostV2GetCardsTrash200ResponseCursorToJSONTyped(json, false);
}

export function PostV2GetCardsTrash200ResponseCursorToJSONTyped(value?: PostV2GetCardsTrash200ResponseCursor | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
