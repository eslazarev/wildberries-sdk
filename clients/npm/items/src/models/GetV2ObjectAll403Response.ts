...
/**
 * Check if a given object implements the GetV2ObjectAll403Response interface.
 */
export function instanceOfGetV2ObjectAll403Response(value: object): value is GetV2ObjectAll403Response {
    return true;
}

export function GetV2ObjectAll403ResponseFromJSON(json: any): GetV2ObjectAll403Response {
    return GetV2ObjectAll403ResponseFromJSONTyped(json, false);
}

export function GetV2ObjectAll403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2ObjectAll403Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV2ObjectAll403ResponseToJSON(json: any): GetV2ObjectAll403Response {
    return GetV2ObjectAll403ResponseToJSONTyped(json, false);
}

export function GetV2ObjectAll403ResponseToJSONTyped(value?: GetV2ObjectAll403Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
