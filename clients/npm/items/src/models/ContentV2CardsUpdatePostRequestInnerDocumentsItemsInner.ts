 ...
 * 
 * @export
 * @interface ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner
 */
export interface ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner {
    /**
     * Тип документа:
...
/**
 * Check if a given object implements the ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner interface.
 */
export function instanceOfContentV2CardsUpdatePostRequestInnerDocumentsItemsInner(value: object): value is ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner {
    return true;
}

export function ContentV2CardsUpdatePostRequestInnerDocumentsItemsInnerFromJSON(json: any): ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner {
    return ContentV2CardsUpdatePostRequestInnerDocumentsItemsInnerFromJSONTyped(json, false);
}

export function ContentV2CardsUpdatePostRequestInnerDocumentsItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ContentV2CardsUpdatePostRequestInnerDocumentsItemsInnerToJSON(json: any): ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner {
    return ContentV2CardsUpdatePostRequestInnerDocumentsItemsInnerToJSONTyped(json, false);
}

export function ContentV2CardsUpdatePostRequestInnerDocumentsItemsInnerToJSONTyped(value?: ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
