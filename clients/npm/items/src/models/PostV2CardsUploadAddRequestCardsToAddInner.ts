...
import {
    ...
    PostV2CardsUploadAddRequestCardsToAddInnerSizesInnerFromJSONTyped,
    PostV2CardsUploadAddRequestCardsToAddInnerSizesInnerToJSON,
    PostV2CardsUploadAddRequestCardsToAddInnerSizesInnerToJSONTyped,
} from './PostV2CardsUploadAddRequestCardsToAddInnerSizesInner';
import type { PostV2CardsUploadAddRequestCardsToAddInnerDimensions } from './PostV2CardsUploadAddRequestCardsToAddInnerDimensions';
import {
    PostV2CardsUploadAddRequestCardsToAddInnerDimensionsFromJSON,
    PostV2CardsUploadAddRequestCardsToAddInnerDimensionsFromJSONTyped,
    PostV2CardsUploadAddRequestCardsToAddInnerDimensionsToJSON,
    PostV2CardsUploadAddRequestCardsToAddInnerDimensionsToJSONTyped,
} from './PostV2CardsUploadAddRequestCardsToAddInnerDimensions';
...
/**
 * Check if a given object implements the PostV2CardsUploadAddRequestCardsToAddInner interface.
 */
export function instanceOfPostV2CardsUploadAddRequestCardsToAddInner(value: object): value is PostV2CardsUploadAddRequestCardsToAddInner {
    if (!('vendorCode' in value) || value['vendorCode'] === undefined) return false;
    return true;
}

export function PostV2CardsUploadAddRequestCardsToAddInnerFromJSON(json: any): PostV2CardsUploadAddRequestCardsToAddInner {
    return PostV2CardsUploadAddRequestCardsToAddInnerFromJSONTyped(json, false);
}

export function PostV2CardsUploadAddRequestCardsToAddInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV2CardsUploadAddRequestCardsToAddInner {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV2CardsUploadAddRequestCardsToAddInnerToJSON(json: any): PostV2CardsUploadAddRequestCardsToAddInner {
    return PostV2CardsUploadAddRequestCardsToAddInnerToJSONTyped(json, false);
}

export function PostV2CardsUploadAddRequestCardsToAddInnerToJSONTyped(value?: PostV2CardsUploadAddRequestCardsToAddInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
