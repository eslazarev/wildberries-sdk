...
/**
 * Check if a given object implements the GetV2Tags402Response interface.
 */
export function instanceOfGetV2Tags402Response(value: object): value is GetV2Tags402Response {
    return true;
}

export function GetV2Tags402ResponseFromJSON(json: any): GetV2Tags402Response {
    return GetV2Tags402ResponseFromJSONTyped(json, false);
}

export function GetV2Tags402ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV2Tags402Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV2Tags402ResponseToJSON(json: any): GetV2Tags402Response {
    return GetV2Tags402ResponseToJSONTyped(json, false);
}

export function GetV2Tags402ResponseToJSONTyped(value?: GetV2Tags402Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
