...
/**
 * Check if a given object implements the GetPing403Response interface.
 */
export function instanceOfGetPing403Response(value: object): value is GetPing403Response {
    return true;
}

export function GetPing403ResponseFromJSON(json: any): GetPing403Response {
    return GetPing403ResponseFromJSONTyped(json, false);
}

export function GetPing403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetPing403Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetPing403ResponseToJSON(json: any): GetPing403Response {
    return GetPing403ResponseToJSONTyped(json, false);
}

export function GetPing403ResponseToJSONTyped(value?: GetPing403Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
