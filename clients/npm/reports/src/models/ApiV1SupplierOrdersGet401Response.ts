 ...
 * 
 * @export
 * @interface ApiV1SupplierOrdersGet401Response
 */
export interface ApiV1SupplierOrdersGet401Response {
    /**
     * Заголовок ошибки
     * @type {string}
     * @memberof ApiV1SupplierOrdersGet401Response
     */
    title?: string;
    /**
     * Детали ошибки
...
/**
 * Check if a given object implements the ApiV1SupplierOrdersGet401Response interface.
 */
export function instanceOfApiV1SupplierOrdersGet401Response(value: object): value is ApiV1SupplierOrdersGet401Response {
    return true;
}

export function ApiV1SupplierOrdersGet401ResponseFromJSON(json: any): ApiV1SupplierOrdersGet401Response {
    return ApiV1SupplierOrdersGet401ResponseFromJSONTyped(json, false);
}

export function ApiV1SupplierOrdersGet401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1SupplierOrdersGet401Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1SupplierOrdersGet401ResponseToJSON(json: any): ApiV1SupplierOrdersGet401Response {
    return ApiV1SupplierOrdersGet401ResponseToJSONTyped(json, false);
}

export function ApiV1SupplierOrdersGet401ResponseToJSONTyped(value?: ApiV1SupplierOrdersGet401Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
