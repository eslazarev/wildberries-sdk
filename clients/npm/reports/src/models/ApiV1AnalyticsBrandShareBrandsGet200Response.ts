 ...
 * 
 * @export
 * @interface ApiV1AnalyticsBrandShareBrandsGet200Response
 */
...
/**
 * Check if a given object implements the ApiV1AnalyticsBrandShareBrandsGet200Response interface.
 */
export function instanceOfApiV1AnalyticsBrandShareBrandsGet200Response(value: object): value is ApiV1AnalyticsBrandShareBrandsGet200Response {
    return true;
}

export function ApiV1AnalyticsBrandShareBrandsGet200ResponseFromJSON(json: any): ApiV1AnalyticsBrandShareBrandsGet200Response {
    return ApiV1AnalyticsBrandShareBrandsGet200ResponseFromJSONTyped(json, false);
}

export function ApiV1AnalyticsBrandShareBrandsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1AnalyticsBrandShareBrandsGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1AnalyticsBrandShareBrandsGet200ResponseToJSON(json: any): ApiV1AnalyticsBrandShareBrandsGet200Response {
    return ApiV1AnalyticsBrandShareBrandsGet200ResponseToJSONTyped(json, false);
}

export function ApiV1AnalyticsBrandShareBrandsGet200ResponseToJSONTyped(value?: ApiV1AnalyticsBrandShareBrandsGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
