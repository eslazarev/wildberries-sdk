...
/**
 * Check if a given object implements the GetV1SupplierOrders403Response interface.
 */
export function instanceOfGetV1SupplierOrders403Response(value: object): value is GetV1SupplierOrders403Response {
    return true;
}

export function GetV1SupplierOrders403ResponseFromJSON(json: any): GetV1SupplierOrders403Response {
    return GetV1SupplierOrders403ResponseFromJSONTyped(json, false);
}

export function GetV1SupplierOrders403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1SupplierOrders403Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1SupplierOrders403ResponseToJSON(json: any): GetV1SupplierOrders403Response {
    return GetV1SupplierOrders403ResponseToJSONTyped(json, false);
}

export function GetV1SupplierOrders403ResponseToJSONTyped(value?: GetV1SupplierOrders403Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
