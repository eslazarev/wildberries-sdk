...
/**
 * Check if a given object implements the AdvertSubcategory interface.
 */
export function instanceOfAdvertSubcategory(value: object): value is AdvertSubcategory {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function AdvertSubcategoryFromJSON(json: any): AdvertSubcategory {
    return AdvertSubcategoryFromJSONTyped(json, false);
}

export function AdvertSubcategoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdvertSubcategory {
    if (json == null) {
        return json;
    }
    return {
...
export function AdvertSubcategoryToJSON(json: any): AdvertSubcategory {
    return AdvertSubcategoryToJSONTyped(json, false);
}

export function AdvertSubcategoryToJSONTyped(value?: AdvertSubcategory | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
