...
/**
 * Check if a given object implements the FullStatsErrorErrorsInner interface.
 */
export function instanceOfFullStatsErrorErrorsInner(value: object): value is FullStatsErrorErrorsInner {
    return true;
}

export function FullStatsErrorErrorsInnerFromJSON(json: any): FullStatsErrorErrorsInner {
    return FullStatsErrorErrorsInnerFromJSONTyped(json, false);
}

export function FullStatsErrorErrorsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): FullStatsErrorErrorsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function FullStatsErrorErrorsInnerToJSON(json: any): FullStatsErrorErrorsInner {
    return FullStatsErrorErrorsInnerToJSONTyped(json, false);
}

export function FullStatsErrorErrorsInnerToJSONTyped(value?: FullStatsErrorErrorsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
