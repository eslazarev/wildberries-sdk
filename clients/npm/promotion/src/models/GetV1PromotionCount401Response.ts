...
/**
 * Check if a given object implements the GetV1PromotionCount401Response interface.
 */
export function instanceOfGetV1PromotionCount401Response(value: object): value is GetV1PromotionCount401Response {
    return true;
}

export function GetV1PromotionCount401ResponseFromJSON(json: any): GetV1PromotionCount401Response {
    return GetV1PromotionCount401ResponseFromJSONTyped(json, false);
}

export function GetV1PromotionCount401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1PromotionCount401Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1PromotionCount401ResponseToJSON(json: any): GetV1PromotionCount401Response {
    return GetV1PromotionCount401ResponseToJSONTyped(json, false);
}

export function GetV1PromotionCount401ResponseToJSONTyped(value?: GetV1PromotionCount401Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
