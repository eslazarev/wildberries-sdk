 ...
 * 
 * @export
 * @interface PromotionsItemsList
 */
export interface PromotionsItemsList {
    /**
     * Артикул WB
     * @type {number}
     * @memberof PromotionsItemsList
     */
    id?: number;
    /**
     * Участвует в акции:
...
/**
 * Check if a given object implements the PromotionsItemsList interface.
 */
export function instanceOfPromotionsItemsList(value: object): value is PromotionsItemsList {
    return true;
}

export function PromotionsItemsListFromJSON(json: any): PromotionsItemsList {
    return PromotionsItemsListFromJSONTyped(json, false);
}

export function PromotionsItemsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PromotionsItemsList {
    if (json == null) {
        return json;
    }
    return {
...
export function PromotionsItemsListToJSON(json: any): PromotionsItemsList {
    return PromotionsItemsListToJSONTyped(json, false);
}

export function PromotionsItemsListToJSONTyped(value?: PromotionsItemsList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
