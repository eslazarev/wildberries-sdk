 ...
 * 
 * @export
 * @interface PostV1BudgetDeposit400Response
 */
export interface PostV1BudgetDeposit400Response {
    /**
     * 
     */
    error?: string;
...
/**
 * Check if a given object implements the PostV1BudgetDeposit400Response interface.
 */
export function instanceOfPostV1BudgetDeposit400Response(value: object): value is PostV1BudgetDeposit400Response {
    return true;
}

export function PostV1BudgetDeposit400ResponseFromJSON(json: any): PostV1BudgetDeposit400Response {
    return PostV1BudgetDeposit400ResponseFromJSONTyped(json, false);
}

export function PostV1BudgetDeposit400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV1BudgetDeposit400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV1BudgetDeposit400ResponseToJSON(json: any): PostV1BudgetDeposit400Response {
    return PostV1BudgetDeposit400ResponseToJSONTyped(json, false);
}

export function PostV1BudgetDeposit400ResponseToJSONTyped(value?: PostV1BudgetDeposit400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
