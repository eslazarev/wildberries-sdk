 ...
 * Карточки товаров
 * @export
 * @interface PatchV0AuctionNms200ResponseNmsInnerNms
 */
export interface PatchV0AuctionNms200ResponseNmsInnerNms {
    /**
...
/**
 * Check if a given object implements the PatchV0AuctionNms200ResponseNmsInnerNms interface.
 */
export function instanceOfPatchV0AuctionNms200ResponseNmsInnerNms(value: object): value is PatchV0AuctionNms200ResponseNmsInnerNms {
    if (!('added' in value) || value['added'] === undefined) return false;
    if (!('deleted' in value) || value['deleted'] === undefined) return false;
    return true;
}

export function PatchV0AuctionNms200ResponseNmsInnerNmsFromJSON(json: any): PatchV0AuctionNms200ResponseNmsInnerNms {
    return PatchV0AuctionNms200ResponseNmsInnerNmsFromJSONTyped(json, false);
}

export function PatchV0AuctionNms200ResponseNmsInnerNmsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchV0AuctionNms200ResponseNmsInnerNms {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchV0AuctionNms200ResponseNmsInnerNmsToJSON(json: any): PatchV0AuctionNms200ResponseNmsInnerNms {
    return PatchV0AuctionNms200ResponseNmsInnerNmsToJSONTyped(json, false);
}

export function PatchV0AuctionNms200ResponseNmsInnerNmsToJSONTyped(value?: PatchV0AuctionNms200ResponseNmsInnerNms | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
