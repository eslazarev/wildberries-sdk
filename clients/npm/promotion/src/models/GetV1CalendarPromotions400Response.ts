...
/**
 * Check if a given object implements the GetV1CalendarPromotions400Response interface.
 */
export function instanceOfGetV1CalendarPromotions400Response(value: object): value is GetV1CalendarPromotions400Response {
    return true;
}

export function GetV1CalendarPromotions400ResponseFromJSON(json: any): GetV1CalendarPromotions400Response {
    return GetV1CalendarPromotions400ResponseFromJSONTyped(json, false);
}

export function GetV1CalendarPromotions400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1CalendarPromotions400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1CalendarPromotions400ResponseToJSON(json: any): GetV1CalendarPromotions400Response {
    return GetV1CalendarPromotions400ResponseToJSONTyped(json, false);
}

export function GetV1CalendarPromotions400ResponseToJSONTyped(value?: GetV1CalendarPromotions400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
