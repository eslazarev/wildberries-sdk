...
/**
 * Check if a given object implements the V2BudgetRequest interface.
 */
export function instanceOfV2BudgetRequest(value: object): value is V2BudgetRequest {
    if (!('advertIds' in value) || value['advertIds'] === undefined) return false;
    return true;
}

export function V2BudgetRequestFromJSON(json: any): V2BudgetRequest {
    return V2BudgetRequestFromJSONTyped(json, false);
}

export function V2BudgetRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2BudgetRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'advertIds': json['advertIds'],
    };
}

export function V2BudgetRequestToJSON(json: any): V2BudgetRequest {
    return V2BudgetRequestToJSONTyped(json, false);
}

export function V2BudgetRequestToJSONTyped(value?: V2BudgetRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
