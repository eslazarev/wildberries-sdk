...
/**
 * Check if a given object implements the V0BidRecommendationReachMedium interface.
 */
export function instanceOfV0BidRecommendationReachMedium(value: object): value is V0BidRecommendationReachMedium {
    return true;
}

export function V0BidRecommendationReachMediumFromJSON(json: any): V0BidRecommendationReachMedium {
    return V0BidRecommendationReachMediumFromJSONTyped(json, false);
}

export function V0BidRecommendationReachMediumFromJSONTyped(json: any, ignoreDiscriminator: boolean): V0BidRecommendationReachMedium {
    if (json == null) {
        return json;
    }
    return {
...
export function V0BidRecommendationReachMediumToJSON(json: any): V0BidRecommendationReachMedium {
    return V0BidRecommendationReachMediumToJSONTyped(json, false);
}

export function V0BidRecommendationReachMediumToJSONTyped(value?: V0BidRecommendationReachMedium | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
