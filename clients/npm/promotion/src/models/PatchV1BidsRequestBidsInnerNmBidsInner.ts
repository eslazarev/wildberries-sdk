...
export type PatchV1BidsRequestBidsInnerNmBidsInnerPlacementEnum = typeof PatchV1BidsRequestBidsInnerNmBidsInnerPlacementEnum[keyof typeof PatchV1BidsRequestBidsInnerNmBidsInnerPlacementEnum];


/**
 * Check if a given object implements the PatchV1BidsRequestBidsInnerNmBidsInner interface.
 */
export function instanceOfPatchV1BidsRequestBidsInnerNmBidsInner(value: object): value is PatchV1BidsRequestBidsInnerNmBidsInner {
...
export function PatchV1BidsRequestBidsInnerNmBidsInnerFromJSON(json: any): PatchV1BidsRequestBidsInnerNmBidsInner {
    return PatchV1BidsRequestBidsInnerNmBidsInnerFromJSONTyped(json, false);
}

export function PatchV1BidsRequestBidsInnerNmBidsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchV1BidsRequestBidsInnerNmBidsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchV1BidsRequestBidsInnerNmBidsInnerToJSON(json: any): PatchV1BidsRequestBidsInnerNmBidsInner {
    return PatchV1BidsRequestBidsInnerNmBidsInnerToJSONTyped(json, false);
}

export function PatchV1BidsRequestBidsInnerNmBidsInnerToJSONTyped(value?: PatchV1BidsRequestBidsInnerNmBidsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
