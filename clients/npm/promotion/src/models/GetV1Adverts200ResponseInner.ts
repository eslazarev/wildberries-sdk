 ...
 * 
 * @export
 * @interface GetV1Adverts200ResponseInner
 */
export interface GetV1Adverts200ResponseInner {
    /**
     * ID медиакампании
     */
    advertId?: number;
...
/**
 * Check if a given object implements the GetV1Adverts200ResponseInner interface.
 */
export function instanceOfGetV1Adverts200ResponseInner(value: object): value is GetV1Adverts200ResponseInner {
    return true;
}

export function GetV1Adverts200ResponseInnerFromJSON(json: any): GetV1Adverts200ResponseInner {
    return GetV1Adverts200ResponseInnerFromJSONTyped(json, false);
}

export function GetV1Adverts200ResponseInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1Adverts200ResponseInner {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1Adverts200ResponseInnerToJSON(json: any): GetV1Adverts200ResponseInner {
    return GetV1Adverts200ResponseInnerToJSONTyped(json, false);
}

export function GetV1Adverts200ResponseInnerToJSONTyped(value?: GetV1Adverts200ResponseInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
