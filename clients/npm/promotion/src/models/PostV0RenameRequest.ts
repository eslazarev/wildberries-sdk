...
/**
 * Check if a given object implements the PostV0RenameRequest interface.
 */
export function instanceOfPostV0RenameRequest(value: object): value is PostV0RenameRequest {
    if (!('advertId' in value) || value['advertId'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function PostV0RenameRequestFromJSON(json: any): PostV0RenameRequest {
    return PostV0RenameRequestFromJSONTyped(json, false);
}

export function PostV0RenameRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV0RenameRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV0RenameRequestToJSON(json: any): PostV0RenameRequest {
    return PostV0RenameRequestToJSONTyped(json, false);
}

export function PostV0RenameRequestToJSONTyped(value?: PostV0RenameRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
