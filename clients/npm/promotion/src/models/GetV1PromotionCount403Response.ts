...
/**
 * Check if a given object implements the GetV1PromotionCount403Response interface.
 */
export function instanceOfGetV1PromotionCount403Response(value: object): value is GetV1PromotionCount403Response {
    return true;
}

export function GetV1PromotionCount403ResponseFromJSON(json: any): GetV1PromotionCount403Response {
    return GetV1PromotionCount403ResponseFromJSONTyped(json, false);
}

export function GetV1PromotionCount403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1PromotionCount403Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1PromotionCount403ResponseToJSON(json: any): GetV1PromotionCount403Response {
    return GetV1PromotionCount403ResponseToJSONTyped(json, false);
}

export function GetV1PromotionCount403ResponseToJSONTyped(value?: GetV1PromotionCount403Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
