 ...
 * 
 * @export
 * @interface PostV3SuppliesSupplyIdTrbx201Response
 */
export interface PostV3SuppliesSupplyIdTrbx201Response {
    /**
...
/**
 * Check if a given object implements the PostV3SuppliesSupplyIdTrbx201Response interface.
 */
export function instanceOfPostV3SuppliesSupplyIdTrbx201Response(value: object): value is PostV3SuppliesSupplyIdTrbx201Response {
    return true;
}

export function PostV3SuppliesSupplyIdTrbx201ResponseFromJSON(json: any): PostV3SuppliesSupplyIdTrbx201Response {
    return PostV3SuppliesSupplyIdTrbx201ResponseFromJSONTyped(json, false);
}

export function PostV3SuppliesSupplyIdTrbx201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3SuppliesSupplyIdTrbx201Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3SuppliesSupplyIdTrbx201ResponseToJSON(json: any): PostV3SuppliesSupplyIdTrbx201Response {
    return PostV3SuppliesSupplyIdTrbx201ResponseToJSONTyped(json, false);
}

export function PostV3SuppliesSupplyIdTrbx201ResponseToJSONTyped(value?: PostV3SuppliesSupplyIdTrbx201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
