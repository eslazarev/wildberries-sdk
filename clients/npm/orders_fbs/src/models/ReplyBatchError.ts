...
/**
 * Check if a given object implements the ReplyBatchError interface.
 */
export function instanceOfReplyBatchError(value: object): value is ReplyBatchError {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('detail' in value) || value['detail'] === undefined) return false;
    return true;
}

export function ReplyBatchErrorFromJSON(json: any): ReplyBatchError {
    return ReplyBatchErrorFromJSONTyped(json, false);
}

export function ReplyBatchErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReplyBatchError {
    if (json == null) {
        return json;
    }
    return {
...
export function ReplyBatchErrorToJSON(json: any): ReplyBatchError {
    return ReplyBatchErrorToJSONTyped(json, false);
}

export function ReplyBatchErrorToJSONTyped(value?: ReplyBatchError | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
