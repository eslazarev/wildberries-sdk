 ...
 * 
 * @export
 * @interface PostV3Supplies201Response
 */
export interface PostV3Supplies201Response {
    /**
     * ID поставки
     */
    id?: string;
...
/**
 * Check if a given object implements the PostV3Supplies201Response interface.
 */
export function instanceOfPostV3Supplies201Response(value: object): value is PostV3Supplies201Response {
    return true;
}

export function PostV3Supplies201ResponseFromJSON(json: any): PostV3Supplies201Response {
    return PostV3Supplies201ResponseFromJSONTyped(json, false);
}

export function PostV3Supplies201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3Supplies201Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3Supplies201ResponseToJSON(json: any): PostV3Supplies201Response {
    return PostV3Supplies201ResponseToJSONTyped(json, false);
}

export function PostV3Supplies201ResponseToJSONTyped(value?: PostV3Supplies201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
