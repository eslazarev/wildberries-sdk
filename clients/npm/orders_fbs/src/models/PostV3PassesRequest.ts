...
/**
 * Check if a given object implements the PostV3PassesRequest interface.
 */
export function instanceOfPostV3PassesRequest(value: object): value is PostV3PassesRequest {
...
export function PostV3PassesRequestFromJSON(json: any): PostV3PassesRequest {
    return PostV3PassesRequestFromJSONTyped(json, false);
}

export function PostV3PassesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3PassesRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3PassesRequestToJSON(json: any): PostV3PassesRequest {
    return PostV3PassesRequestToJSONTyped(json, false);
}

export function PostV3PassesRequestToJSONTyped(value?: PostV3PassesRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
