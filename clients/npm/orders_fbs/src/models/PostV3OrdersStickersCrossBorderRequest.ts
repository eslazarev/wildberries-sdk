...
/**
 * Check if a given object implements the PostV3OrdersStickersCrossBorderRequest interface.
 */
export function instanceOfPostV3OrdersStickersCrossBorderRequest(value: object): value is PostV3OrdersStickersCrossBorderRequest {
    return true;
}

export function PostV3OrdersStickersCrossBorderRequestFromJSON(json: any): PostV3OrdersStickersCrossBorderRequest {
    return PostV3OrdersStickersCrossBorderRequestFromJSONTyped(json, false);
}

export function PostV3OrdersStickersCrossBorderRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3OrdersStickersCrossBorderRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3OrdersStickersCrossBorderRequestToJSON(json: any): PostV3OrdersStickersCrossBorderRequest {
    return PostV3OrdersStickersCrossBorderRequestToJSONTyped(json, false);
}

export function PostV3OrdersStickersCrossBorderRequestToJSONTyped(value?: PostV3OrdersStickersCrossBorderRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
