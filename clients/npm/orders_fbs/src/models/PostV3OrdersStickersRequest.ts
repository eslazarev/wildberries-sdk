...
/**
 * Check if a given object implements the PostV3OrdersStickersRequest interface.
 */
export function instanceOfPostV3OrdersStickersRequest(value: object): value is PostV3OrdersStickersRequest {
    return true;
}

export function PostV3OrdersStickersRequestFromJSON(json: any): PostV3OrdersStickersRequest {
    return PostV3OrdersStickersRequestFromJSONTyped(json, false);
}

export function PostV3OrdersStickersRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3OrdersStickersRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3OrdersStickersRequestToJSON(json: any): PostV3OrdersStickersRequest {
    return PostV3OrdersStickersRequestToJSONTyped(json, false);
}

export function PostV3OrdersStickersRequestToJSONTyped(value?: PostV3OrdersStickersRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
