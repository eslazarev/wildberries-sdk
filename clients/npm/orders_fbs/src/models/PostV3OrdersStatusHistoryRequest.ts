...
/**
 * Check if a given object implements the PostV3OrdersStatusHistoryRequest interface.
 */
export function instanceOfPostV3OrdersStatusHistoryRequest(value: object): value is PostV3OrdersStatusHistoryRequest {
    return true;
}

export function PostV3OrdersStatusHistoryRequestFromJSON(json: any): PostV3OrdersStatusHistoryRequest {
    return PostV3OrdersStatusHistoryRequestFromJSONTyped(json, false);
}

export function PostV3OrdersStatusHistoryRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3OrdersStatusHistoryRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3OrdersStatusHistoryRequestToJSON(json: any): PostV3OrdersStatusHistoryRequest {
    return PostV3OrdersStatusHistoryRequestToJSONTyped(json, false);
}

export function PostV3OrdersStatusHistoryRequestToJSONTyped(value?: PostV3OrdersStatusHistoryRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
