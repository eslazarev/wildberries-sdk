...
/**
 * Check if a given object implements the PutV3OrdersOrderIdMetaExpirationRequest interface.
 */
export function instanceOfPutV3OrdersOrderIdMetaExpirationRequest(value: object): value is PutV3OrdersOrderIdMetaExpirationRequest {
    if (!('expiration' in value) || value['expiration'] === undefined) return false;
    return true;
}

export function PutV3OrdersOrderIdMetaExpirationRequestFromJSON(json: any): PutV3OrdersOrderIdMetaExpirationRequest {
    return PutV3OrdersOrderIdMetaExpirationRequestFromJSONTyped(json, false);
}

export function PutV3OrdersOrderIdMetaExpirationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutV3OrdersOrderIdMetaExpirationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PutV3OrdersOrderIdMetaExpirationRequestToJSON(json: any): PutV3OrdersOrderIdMetaExpirationRequest {
    return PutV3OrdersOrderIdMetaExpirationRequestToJSONTyped(json, false);
}

export function PutV3OrdersOrderIdMetaExpirationRequestToJSONTyped(value?: PutV3OrdersOrderIdMetaExpirationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
