...
/**
 * Check if a given object implements the PutV3OrdersOrderIdMetaGtinRequest interface.
 */
export function instanceOfPutV3OrdersOrderIdMetaGtinRequest(value: object): value is PutV3OrdersOrderIdMetaGtinRequest {
    if (!('gtin' in value) || value['gtin'] === undefined) return false;
    return true;
}

export function PutV3OrdersOrderIdMetaGtinRequestFromJSON(json: any): PutV3OrdersOrderIdMetaGtinRequest {
    return PutV3OrdersOrderIdMetaGtinRequestFromJSONTyped(json, false);
}

export function PutV3OrdersOrderIdMetaGtinRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutV3OrdersOrderIdMetaGtinRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PutV3OrdersOrderIdMetaGtinRequestToJSON(json: any): PutV3OrdersOrderIdMetaGtinRequest {
    return PutV3OrdersOrderIdMetaGtinRequestToJSONTyped(json, false);
}

export function PutV3OrdersOrderIdMetaGtinRequestToJSONTyped(value?: PutV3OrdersOrderIdMetaGtinRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
