 ...
 * 
 * @export
 * @interface GetV3OrdersNew200Response
 */
export interface GetV3OrdersNew200Response {
    /**
...
/**
 * Check if a given object implements the GetV3OrdersNew200Response interface.
 */
export function instanceOfGetV3OrdersNew200Response(value: object): value is GetV3OrdersNew200Response {
    return true;
}

export function GetV3OrdersNew200ResponseFromJSON(json: any): GetV3OrdersNew200Response {
    return GetV3OrdersNew200ResponseFromJSONTyped(json, false);
}

export function GetV3OrdersNew200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV3OrdersNew200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV3OrdersNew200ResponseToJSON(json: any): GetV3OrdersNew200Response {
    return GetV3OrdersNew200ResponseToJSONTyped(json, false);
}

export function GetV3OrdersNew200ResponseToJSONTyped(value?: GetV3OrdersNew200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
