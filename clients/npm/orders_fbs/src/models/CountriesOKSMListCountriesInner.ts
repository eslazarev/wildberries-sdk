...
/**
 * Check if a given object implements the CountriesOKSMListCountriesInner interface.
 */
export function instanceOfCountriesOKSMListCountriesInner(value: object): value is CountriesOKSMListCountriesInner {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function CountriesOKSMListCountriesInnerFromJSON(json: any): CountriesOKSMListCountriesInner {
    return CountriesOKSMListCountriesInnerFromJSONTyped(json, false);
}

export function CountriesOKSMListCountriesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountriesOKSMListCountriesInner {
    if (json == null) {
        return json;
    }
    return {
...
export function CountriesOKSMListCountriesInnerToJSON(json: any): CountriesOKSMListCountriesInner {
    return CountriesOKSMListCountriesInnerToJSONTyped(json, false);
}

export function CountriesOKSMListCountriesInnerToJSONTyped(value?: CountriesOKSMListCountriesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
