 ...
 * 
 * @export
 * @interface GetV3Orders200Response
 */
export interface GetV3Orders200Response {
    /**
...
/**
 * Check if a given object implements the GetV3Orders200Response interface.
 */
export function instanceOfGetV3Orders200Response(value: object): value is GetV3Orders200Response {
    return true;
}

export function GetV3Orders200ResponseFromJSON(json: any): GetV3Orders200Response {
    return GetV3Orders200ResponseFromJSONTyped(json, false);
}

export function GetV3Orders200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV3Orders200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV3Orders200ResponseToJSON(json: any): GetV3Orders200Response {
    return GetV3Orders200ResponseToJSONTyped(json, false);
}

export function GetV3Orders200ResponseToJSONTyped(value?: GetV3Orders200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
