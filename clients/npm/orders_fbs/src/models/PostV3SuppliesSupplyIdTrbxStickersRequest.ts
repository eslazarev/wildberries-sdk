...
/**
 * Check if a given object implements the PostV3SuppliesSupplyIdTrbxStickersRequest interface.
 */
export function instanceOfPostV3SuppliesSupplyIdTrbxStickersRequest(value: object): value is PostV3SuppliesSupplyIdTrbxStickersRequest {
    if (!('trbxIds' in value) || value['trbxIds'] === undefined) return false;
    return true;
}

export function PostV3SuppliesSupplyIdTrbxStickersRequestFromJSON(json: any): PostV3SuppliesSupplyIdTrbxStickersRequest {
    return PostV3SuppliesSupplyIdTrbxStickersRequestFromJSONTyped(json, false);
}

export function PostV3SuppliesSupplyIdTrbxStickersRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3SuppliesSupplyIdTrbxStickersRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3SuppliesSupplyIdTrbxStickersRequestToJSON(json: any): PostV3SuppliesSupplyIdTrbxStickersRequest {
    return PostV3SuppliesSupplyIdTrbxStickersRequestToJSONTyped(json, false);
}

export function PostV3SuppliesSupplyIdTrbxStickersRequestToJSONTyped(value?: PostV3SuppliesSupplyIdTrbxStickersRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
