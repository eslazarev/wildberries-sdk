 ...
 * 
 * @export
 * @interface PostV3Passes201Response
 */
export interface PostV3Passes201Response {
    /**
...
/**
 * Check if a given object implements the PostV3Passes201Response interface.
 */
export function instanceOfPostV3Passes201Response(value: object): value is PostV3Passes201Response {
    return true;
}

export function PostV3Passes201ResponseFromJSON(json: any): PostV3Passes201Response {
    return PostV3Passes201ResponseFromJSONTyped(json, false);
}

export function PostV3Passes201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3Passes201Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV3Passes201ResponseToJSON(json: any): PostV3Passes201Response {
    return PostV3Passes201ResponseToJSONTyped(json, false);
}

export function PostV3Passes201ResponseToJSONTyped(value?: PostV3Passes201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
