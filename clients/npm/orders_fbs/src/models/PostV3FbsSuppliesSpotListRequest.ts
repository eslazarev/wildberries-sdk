...
/**
 * Check if a given object implements the PostV3FbsSuppliesSpotListRequest interface.
 */
export function instanceOfPostV3FbsSuppliesSpotListRequest(value: object): value is PostV3FbsSuppliesSpotListRequest {
    if (!('supplyIds' in value) || value['supplyIds'] === undefined) return false;
    return true;
}

export function PostV3FbsSuppliesSpotListRequestFromJSON(json: any): PostV3FbsSuppliesSpotListRequest {
    return PostV3FbsSuppliesSpotListRequestFromJSONTyped(json, false);
}

export function PostV3FbsSuppliesSpotListRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV3FbsSuppliesSpotListRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'supplyIds': json['supplyIds'],
    };
}

export function PostV3FbsSuppliesSpotListRequestToJSON(json: any): PostV3FbsSuppliesSpotListRequest {
    return PostV3FbsSuppliesSpotListRequestToJSONTyped(json, false);
}

export function PostV3FbsSuppliesSpotListRequestToJSONTyped(value?: PostV3FbsSuppliesSpotListRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
