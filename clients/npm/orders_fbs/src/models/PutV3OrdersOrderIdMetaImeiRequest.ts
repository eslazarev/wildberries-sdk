...
/**
 * Check if a given object implements the PutV3OrdersOrderIdMetaImeiRequest interface.
 */
export function instanceOfPutV3OrdersOrderIdMetaImeiRequest(value: object): value is PutV3OrdersOrderIdMetaImeiRequest {
    if (!('imei' in value) || value['imei'] === undefined) return false;
    return true;
}

export function PutV3OrdersOrderIdMetaImeiRequestFromJSON(json: any): PutV3OrdersOrderIdMetaImeiRequest {
    return PutV3OrdersOrderIdMetaImeiRequestFromJSONTyped(json, false);
}

export function PutV3OrdersOrderIdMetaImeiRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutV3OrdersOrderIdMetaImeiRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PutV3OrdersOrderIdMetaImeiRequestToJSON(json: any): PutV3OrdersOrderIdMetaImeiRequest {
    return PutV3OrdersOrderIdMetaImeiRequestToJSONTyped(json, false);
}

export function PutV3OrdersOrderIdMetaImeiRequestToJSONTyped(value?: PutV3OrdersOrderIdMetaImeiRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
