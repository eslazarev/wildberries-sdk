...
/**
 * Check if a given object implements the GetV3PassesOffices401Response interface.
 */
export function instanceOfGetV3PassesOffices401Response(value: object): value is GetV3PassesOffices401Response {
    return true;
}

export function GetV3PassesOffices401ResponseFromJSON(json: any): GetV3PassesOffices401Response {
    return GetV3PassesOffices401ResponseFromJSONTyped(json, false);
}

export function GetV3PassesOffices401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV3PassesOffices401Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV3PassesOffices401ResponseToJSON(json: any): GetV3PassesOffices401Response {
    return GetV3PassesOffices401ResponseToJSONTyped(json, false);
}

export function GetV3PassesOffices401ResponseToJSONTyped(value?: GetV3PassesOffices401Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
