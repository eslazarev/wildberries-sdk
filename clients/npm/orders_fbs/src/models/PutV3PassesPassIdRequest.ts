...
/**
 * Check if a given object implements the PutV3PassesPassIdRequest interface.
 */
export function instanceOfPutV3PassesPassIdRequest(value: object): value is PutV3PassesPassIdRequest {
...
export function PutV3PassesPassIdRequestFromJSON(json: any): PutV3PassesPassIdRequest {
    return PutV3PassesPassIdRequestFromJSONTyped(json, false);
}

export function PutV3PassesPassIdRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutV3PassesPassIdRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PutV3PassesPassIdRequestToJSON(json: any): PutV3PassesPassIdRequest {
    return PutV3PassesPassIdRequestToJSONTyped(json, false);
}

export function PutV3PassesPassIdRequestToJSONTyped(value?: PutV3PassesPassIdRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
