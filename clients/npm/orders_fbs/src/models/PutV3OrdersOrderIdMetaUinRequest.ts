...
/**
 * Check if a given object implements the PutV3OrdersOrderIdMetaUinRequest interface.
 */
export function instanceOfPutV3OrdersOrderIdMetaUinRequest(value: object): value is PutV3OrdersOrderIdMetaUinRequest {
    if (!('uin' in value) || value['uin'] === undefined) return false;
    return true;
}

export function PutV3OrdersOrderIdMetaUinRequestFromJSON(json: any): PutV3OrdersOrderIdMetaUinRequest {
    return PutV3OrdersOrderIdMetaUinRequestFromJSONTyped(json, false);
}

export function PutV3OrdersOrderIdMetaUinRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutV3OrdersOrderIdMetaUinRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PutV3OrdersOrderIdMetaUinRequestToJSON(json: any): PutV3OrdersOrderIdMetaUinRequest {
    return PutV3OrdersOrderIdMetaUinRequestToJSONTyped(json, false);
}

export function PutV3OrdersOrderIdMetaUinRequestToJSONTyped(value?: PutV3OrdersOrderIdMetaUinRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
