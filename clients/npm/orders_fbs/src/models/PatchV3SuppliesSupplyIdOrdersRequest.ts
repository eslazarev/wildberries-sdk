...
/**
 * Check if a given object implements the PatchV3SuppliesSupplyIdOrdersRequest interface.
 */
export function instanceOfPatchV3SuppliesSupplyIdOrdersRequest(value: object): value is PatchV3SuppliesSupplyIdOrdersRequest {
    return true;
}

export function PatchV3SuppliesSupplyIdOrdersRequestFromJSON(json: any): PatchV3SuppliesSupplyIdOrdersRequest {
    return PatchV3SuppliesSupplyIdOrdersRequestFromJSONTyped(json, false);
}

export function PatchV3SuppliesSupplyIdOrdersRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchV3SuppliesSupplyIdOrdersRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchV3SuppliesSupplyIdOrdersRequestToJSON(json: any): PatchV3SuppliesSupplyIdOrdersRequest {
    return PatchV3SuppliesSupplyIdOrdersRequestToJSONTyped(json, false);
}

export function PatchV3SuppliesSupplyIdOrdersRequestToJSONTyped(value?: PatchV3SuppliesSupplyIdOrdersRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
