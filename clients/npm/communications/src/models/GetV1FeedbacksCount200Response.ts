 ...
 * 
 * @export
 * @interface GetV1FeedbacksCount200Response
 */
export interface GetV1FeedbacksCount200Response {
    /**
     * Количество отзывов
     */
    data?: number;
...
/**
 * Check if a given object implements the GetV1FeedbacksCount200Response interface.
 */
export function instanceOfGetV1FeedbacksCount200Response(value: object): value is GetV1FeedbacksCount200Response {
    return true;
}

export function GetV1FeedbacksCount200ResponseFromJSON(json: any): GetV1FeedbacksCount200Response {
    return GetV1FeedbacksCount200ResponseFromJSONTyped(json, false);
}

export function GetV1FeedbacksCount200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1FeedbacksCount200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1FeedbacksCount200ResponseToJSON(json: any): GetV1FeedbacksCount200Response {
    return GetV1FeedbacksCount200ResponseToJSONTyped(json, false);
}

export function GetV1FeedbacksCount200ResponseToJSONTyped(value?: GetV1FeedbacksCount200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
