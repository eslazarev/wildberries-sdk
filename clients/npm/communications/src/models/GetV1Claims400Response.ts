...
/**
 * Check if a given object implements the GetV1Claims400Response interface.
 */
export function instanceOfGetV1Claims400Response(value: object): value is GetV1Claims400Response {
    return true;
}

export function GetV1Claims400ResponseFromJSON(json: any): GetV1Claims400Response {
    return GetV1Claims400ResponseFromJSONTyped(json, false);
}

export function GetV1Claims400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1Claims400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1Claims400ResponseToJSON(json: any): GetV1Claims400Response {
    return GetV1Claims400ResponseToJSONTyped(json, false);
}

export function GetV1Claims400ResponseToJSONTyped(value?: GetV1Claims400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
