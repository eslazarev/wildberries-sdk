 ...
 * 
 * @export
 * @interface DeleteFeedbacksV1Pins200Response
 */
export interface DeleteFeedbacksV1Pins200Response {
    /**
...
/**
 * Check if a given object implements the DeleteFeedbacksV1Pins200Response interface.
 */
export function instanceOfDeleteFeedbacksV1Pins200Response(value: object): value is DeleteFeedbacksV1Pins200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function DeleteFeedbacksV1Pins200ResponseFromJSON(json: any): DeleteFeedbacksV1Pins200Response {
    return DeleteFeedbacksV1Pins200ResponseFromJSONTyped(json, false);
}

export function DeleteFeedbacksV1Pins200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteFeedbacksV1Pins200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteFeedbacksV1Pins200ResponseToJSON(json: any): DeleteFeedbacksV1Pins200Response {
    return DeleteFeedbacksV1Pins200ResponseToJSONTyped(json, false);
}

export function DeleteFeedbacksV1Pins200ResponseToJSONTyped(value?: DeleteFeedbacksV1Pins200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
