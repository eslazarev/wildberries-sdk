 ...
 * 
 * @export
 * @interface PatchV1Questions200Response
 */
export interface PatchV1Questions200Response {
    /**
     * 
     */
    data?: object | null;
...
/**
 * Check if a given object implements the PatchV1Questions200Response interface.
 */
export function instanceOfPatchV1Questions200Response(value: object): value is PatchV1Questions200Response {
    return true;
}

export function PatchV1Questions200ResponseFromJSON(json: any): PatchV1Questions200Response {
    return PatchV1Questions200ResponseFromJSONTyped(json, false);
}

export function PatchV1Questions200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchV1Questions200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchV1Questions200ResponseToJSON(json: any): PatchV1Questions200Response {
    return PatchV1Questions200ResponseToJSONTyped(json, false);
}

export function PatchV1Questions200ResponseToJSONTyped(value?: PatchV1Questions200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
