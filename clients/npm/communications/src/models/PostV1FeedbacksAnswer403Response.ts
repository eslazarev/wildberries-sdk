...
/**
 * Check if a given object implements the PostV1FeedbacksAnswer403Response interface.
 */
export function instanceOfPostV1FeedbacksAnswer403Response(value: object): value is PostV1FeedbacksAnswer403Response {
    return true;
}

export function PostV1FeedbacksAnswer403ResponseFromJSON(json: any): PostV1FeedbacksAnswer403Response {
    return PostV1FeedbacksAnswer403ResponseFromJSONTyped(json, false);
}

export function PostV1FeedbacksAnswer403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostV1FeedbacksAnswer403Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PostV1FeedbacksAnswer403ResponseToJSON(json: any): PostV1FeedbacksAnswer403Response {
    return PostV1FeedbacksAnswer403ResponseToJSONTyped(json, false);
}

export function PostV1FeedbacksAnswer403ResponseToJSONTyped(value?: PostV1FeedbacksAnswer403Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
