 ...
 * 
 * @export
 * @interface GetV1QuestionsCount200Response
 */
export interface GetV1QuestionsCount200Response {
    /**
     * Количество вопросов
     */
    data?: number;
...
/**
 * Check if a given object implements the GetV1QuestionsCount200Response interface.
 */
export function instanceOfGetV1QuestionsCount200Response(value: object): value is GetV1QuestionsCount200Response {
    return true;
}

export function GetV1QuestionsCount200ResponseFromJSON(json: any): GetV1QuestionsCount200Response {
    return GetV1QuestionsCount200ResponseFromJSONTyped(json, false);
}

export function GetV1QuestionsCount200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1QuestionsCount200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1QuestionsCount200ResponseToJSON(json: any): GetV1QuestionsCount200Response {
    return GetV1QuestionsCount200ResponseToJSONTyped(json, false);
}

export function GetV1QuestionsCount200ResponseToJSONTyped(value?: GetV1QuestionsCount200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
