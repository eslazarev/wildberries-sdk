 ...
 * Структура ответа
 * @export
 * @interface GetV1Feedback200ResponseDataAnswer
 */
export interface GetV1Feedback200ResponseDataAnswer {
    /**
     * Текст ответа
     */
    text?: string;
...
/**
 * Check if a given object implements the GetV1Feedback200ResponseDataAnswer interface.
 */
export function instanceOfGetV1Feedback200ResponseDataAnswer(value: object): value is GetV1Feedback200ResponseDataAnswer {
    return true;
}

export function GetV1Feedback200ResponseDataAnswerFromJSON(json: any): GetV1Feedback200ResponseDataAnswer {
    return GetV1Feedback200ResponseDataAnswerFromJSONTyped(json, false);
}

export function GetV1Feedback200ResponseDataAnswerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetV1Feedback200ResponseDataAnswer {
    if (json == null) {
        return json;
    }
    return {
...
export function GetV1Feedback200ResponseDataAnswerToJSON(json: any): GetV1Feedback200ResponseDataAnswer {
    return GetV1Feedback200ResponseDataAnswerToJSONTyped(json, false);
}

export function GetV1Feedback200ResponseDataAnswerToJSONTyped(value?: GetV1Feedback200ResponseDataAnswer | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
