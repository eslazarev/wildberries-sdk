...
/**
 * Check if a given object implements the PatchV1Claim400Response interface.
 */
export function instanceOfPatchV1Claim400Response(value: object): value is PatchV1Claim400Response {
    return true;
}

export function PatchV1Claim400ResponseFromJSON(json: any): PatchV1Claim400Response {
    return PatchV1Claim400ResponseFromJSONTyped(json, false);
}

export function PatchV1Claim400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchV1Claim400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchV1Claim400ResponseToJSON(json: any): PatchV1Claim400Response {
    return PatchV1Claim400ResponseToJSONTyped(json, false);
}

export function PatchV1Claim400ResponseToJSONTyped(value?: PatchV1Claim400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
