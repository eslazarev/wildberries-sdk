...
/**
 * Check if a given object implements the VisibilityInfoVisibility interface.
 */
export function instanceOfVisibilityInfoVisibility(value: object): value is VisibilityInfoVisibility {
    if (!('current' in value) || value['current'] === undefined) return false;
    return true;
}

export function VisibilityInfoVisibilityFromJSON(json: any): VisibilityInfoVisibility {
    return VisibilityInfoVisibilityFromJSONTyped(json, false);
}

export function VisibilityInfoVisibilityFromJSONTyped(json: any, ignoreDiscriminator: boolean): VisibilityInfoVisibility {
    if (json == null) {
        return json;
    }
    return {
...
export function VisibilityInfoVisibilityToJSON(json: any): VisibilityInfoVisibility {
    return VisibilityInfoVisibilityToJSONTyped(json, false);
}

export function VisibilityInfoVisibilityToJSONTyped(value?: VisibilityInfoVisibility | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
