...
/**
 * Check if a given object implements the CommonInfoAdvertisedProducts interface.
 */
export function instanceOfCommonInfoAdvertisedProducts(value: object): value is CommonInfoAdvertisedProducts {
    if (!('current' in value) || value['current'] === undefined) return false;
    return true;
}

export function CommonInfoAdvertisedProductsFromJSON(json: any): CommonInfoAdvertisedProducts {
    return CommonInfoAdvertisedProductsFromJSONTyped(json, false);
}

export function CommonInfoAdvertisedProductsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommonInfoAdvertisedProducts {
    if (json == null) {
        return json;
    }
    return {
...
export function CommonInfoAdvertisedProductsToJSON(json: any): CommonInfoAdvertisedProducts {
    return CommonInfoAdvertisedProductsToJSONTyped(json, false);
}

export function CommonInfoAdvertisedProductsToJSONTyped(value?: CommonInfoAdvertisedProducts | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
