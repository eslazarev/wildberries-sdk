...
/**
 * Check if a given object implements the ItemRatingRequestV1 interface.
 */
export function instanceOfItemRatingRequestV1(value: object): value is ItemRatingRequestV1 {
...
export function ItemRatingRequestV1FromJSON(json: any): ItemRatingRequestV1 {
    return ItemRatingRequestV1FromJSONTyped(json, false);
}

export function ItemRatingRequestV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemRatingRequestV1 {
    if (json == null) {
        return json;
    }
    return {
...
export function ItemRatingRequestV1ToJSON(json: any): ItemRatingRequestV1 {
    return ItemRatingRequestV1ToJSONTyped(json, false);
}

export function ItemRatingRequestV1ToJSONTyped(value?: ItemRatingRequestV1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
