...
/**
 * Check if a given object implements the PositionInfoMedian interface.
 */
export function instanceOfPositionInfoMedian(value: object): value is PositionInfoMedian {
    if (!('current' in value) || value['current'] === undefined) return false;
    return true;
}

export function PositionInfoMedianFromJSON(json: any): PositionInfoMedian {
    return PositionInfoMedianFromJSONTyped(json, false);
}

export function PositionInfoMedianFromJSONTyped(json: any, ignoreDiscriminator: boolean): PositionInfoMedian {
    if (json == null) {
        return json;
    }
    return {
...
export function PositionInfoMedianToJSON(json: any): PositionInfoMedian {
    return PositionInfoMedianToJSONTyped(json, false);
}

export function PositionInfoMedianToJSONTyped(value?: PositionInfoMedian | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
