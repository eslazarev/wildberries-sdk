...
/**
 * Check if a given object implements the CommonShippingOfficeFilters interface.
 */
export function instanceOfCommonShippingOfficeFilters(value: object): value is CommonShippingOfficeFilters {
...
export function CommonShippingOfficeFiltersFromJSON(json: any): CommonShippingOfficeFilters {
    return CommonShippingOfficeFiltersFromJSONTyped(json, false);
}

export function CommonShippingOfficeFiltersFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommonShippingOfficeFilters {
    if (json == null) {
        return json;
    }
    return {
...
export function CommonShippingOfficeFiltersToJSON(json: any): CommonShippingOfficeFilters {
    return CommonShippingOfficeFiltersToJSONTyped(json, false);
}

export function CommonShippingOfficeFiltersToJSONTyped(value?: CommonShippingOfficeFilters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
