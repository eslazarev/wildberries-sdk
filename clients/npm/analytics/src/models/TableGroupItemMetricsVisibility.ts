...
/**
 * Check if a given object implements the TableGroupItemMetricsVisibility interface.
 */
export function instanceOfTableGroupItemMetricsVisibility(value: object): value is TableGroupItemMetricsVisibility {
    if (!('current' in value) || value['current'] === undefined) return false;
    return true;
}

export function TableGroupItemMetricsVisibilityFromJSON(json: any): TableGroupItemMetricsVisibility {
    return TableGroupItemMetricsVisibilityFromJSONTyped(json, false);
}

export function TableGroupItemMetricsVisibilityFromJSONTyped(json: any, ignoreDiscriminator: boolean): TableGroupItemMetricsVisibility {
    if (json == null) {
        return json;
    }
    return {
...
export function TableGroupItemMetricsVisibilityToJSON(json: any): TableGroupItemMetricsVisibility {
    return TableGroupItemMetricsVisibilityToJSONTyped(json, false);
}

export function TableGroupItemMetricsVisibilityToJSONTyped(value?: TableGroupItemMetricsVisibility | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
