...
/**
 * Check if a given object implements the TableSizeRequest interface.
 */
export function instanceOfTableSizeRequest(value: object): value is TableSizeRequest {
...
export function TableSizeRequestFromJSON(json: any): TableSizeRequest {
    return TableSizeRequestFromJSONTyped(json, false);
}

export function TableSizeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TableSizeRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function TableSizeRequestToJSON(json: any): TableSizeRequest {
    return TableSizeRequestToJSONTyped(json, false);
}

export function TableSizeRequestToJSONTyped(value?: TableSizeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
