...
/**
 * GetV3DbwWarehousesWarehouseIdContacts200ResponseContactsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class GetV3DbwWarehousesWarehouseIdContacts200ResponseContactsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getV3DbwWarehousesWarehouseIdContacts_200_response_contacts_inner';
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling GetV3DbwWarehousesWarehouseIdContacts200ResponseContactsInner., must be smaller than or equal to 1000.');
        }
