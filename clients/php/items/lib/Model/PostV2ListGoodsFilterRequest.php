...
/**
 * PostV2ListGoodsFilterRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV2ListGoodsFilterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2ListGoodsFilter_request';
    ...
    public function setNmList($nm_list)
    {
        ...
        if ((count($nm_list) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $nm_list when calling PostV2ListGoodsFilterRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($nm_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nm_list when calling PostV2ListGoodsFilterRequest., number of items must be greater than or equal to 1.');
        }
