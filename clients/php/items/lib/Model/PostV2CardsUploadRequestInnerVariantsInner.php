...
/**
 * PostV2CardsUploadRequestInnerVariantsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV2CardsUploadRequestInnerVariantsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2CardsUpload_request_inner_variants_inner';
    ...
    protected static $openAPITypes = [
        ...
        'dimensions' => '\Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInnerDimensions',
        'sizes' => '\Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInnerSizesInner[]',
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $title when calling PostV2CardsUploadRequestInnerVariantsInner., must be smaller than or equal to 60.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Описание товара.<br> Максимальное количество символов зависит от категории товара<br> Стандарт — 2000, минимум — 1000, максимум — 5000<br> Подробно о **правилах заполнения карточки товара** в [Справочном центре](https://seller.wildberries.ru/instructions/ru/ru/material/how-to-create-card) на портале продавцов
     *
     * @return self
     */
    ...
    public function setVendorCode($vendor_code)
    {
        ...
        if ((mb_strlen($vendor_code) > 72)) {
            throw new \InvalidArgumentException('invalid length for $vendor_code when calling PostV2CardsUploadRequestInnerVariantsInner., must be smaller than or equal to 72.');
        }
     ...
     * Gets wholesale
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInnerWholesale|null
     */
     ...
     * Sets wholesale
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInnerWholesale|null $wholesale wholesale
     *
     * @return self
     */
     ...
     * Gets dimensions
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInnerDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInnerDimensions|null $dimensions dimensions
     *
     * @return self
     */
     ...
     * Gets sizes
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInnerSizesInner[]|null
     */
     ...
     * Sets sizes
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInnerSizesInner[]|null $sizes Массив размеров.<br> Если не указать для размерного товара (обувь, одежда и др.), сгенерируется автоматически с `techSize` = \"A\", `wbSize` = \"1\" и баркодом
     *
     * @return self
     */
     ...
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerCharacteristicsInner[]|null
     */
     ...
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerCharacteristicsInner[]|null $characteristics Характеристики товара. <br> Можно получить методом [Характеристики предмета](./item-management#tag/categoriesSubcategoriesAndCharacteristics/operation/getV2ObjectCharcsSubjectId)
     *
     * @return self
     */
