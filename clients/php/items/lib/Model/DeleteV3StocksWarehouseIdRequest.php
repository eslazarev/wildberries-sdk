...
/**
 * DeleteV3StocksWarehouseIdRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class DeleteV3StocksWarehouseIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'deleteV3StocksWarehouseId_request';
    ...
    public function setChrtIds($chrt_ids)
    {
        ...
        if ((count($chrt_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $chrt_ids when calling DeleteV3StocksWarehouseIdRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($chrt_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $chrt_ids when calling DeleteV3StocksWarehouseIdRequest., number of items must be greater than or equal to 1.');
        }
