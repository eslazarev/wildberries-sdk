...
/**
 * PutV3StocksWarehouseIdRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PutV3StocksWarehouseIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3StocksWarehouseId_request';
    ...
    protected static $openAPITypes = [
        'stocks' => '\Wildberries\Sdk\Items\Model\PutV3StocksWarehouseIdRequestStocksInner[]'
    ];
     ...
     * Gets stocks
     *
     * @return \Wildberries\Sdk\Items\Model\PutV3StocksWarehouseIdRequestStocksInner[]
     */
     ...
     * Sets stocks
     *
     * @param \Wildberries\Sdk\Items\Model\PutV3StocksWarehouseIdRequestStocksInner[] $stocks Массив ID размеров товаров и их остатков
     *
     * @return self
     */
    public function setStocks($stocks)
    {
        ...
        if ((count($stocks) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $stocks when calling PutV3StocksWarehouseIdRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($stocks) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stocks when calling PutV3StocksWarehouseIdRequest., number of items must be greater than or equal to 1.');
        }
