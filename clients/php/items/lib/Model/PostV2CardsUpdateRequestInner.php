...
/**
 * PostV2CardsUpdateRequestInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV2CardsUpdateRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2CardsUpdate_request_inner';
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'string',
        'description' => 'string',
        'dimensions' => '\Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerDimensions',
        'documents' => '\Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerDocuments',
        'characteristics' => '\Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerCharacteristicsInner[]',
        'sizes' => '\Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerSizesInner[]'
    ];
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $title when calling PostV2CardsUpdateRequestInner., must be smaller than or equal to 60.');
        }
     ...
     * Gets dimensions
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerDimensions|null $dimensions dimensions
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerDocuments|null
     */
     ...
     * Sets documents
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerDocuments|null $documents documents
     *
     * @return self
     */
     ...
     * Gets sizes
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerSizesInner[]
     */
     ...
     * Sets sizes
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUpdateRequestInnerSizesInner[] $sizes Массив размеров<br> Для безразмерного товара всё равно нужно передавать данный массив без параметров (wbSize и techSize), но с баркодом
     *
     * @return self
     */
