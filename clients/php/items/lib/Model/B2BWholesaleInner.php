...
/**
 * B2BWholesaleInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class B2BWholesaleInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'B2BWholesale_inner';
    ...
    protected static $openAPITypes = [
        'nm_id' => 'int',
        'wholesale_discount_threshold' => '\Wildberries\Sdk\Items\Model\WholesaleDiscountThresholdReq[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wholesale_discount_threshold'] === null) {
            $invalidProperties[] = "'wholesale_discount_threshold' can't be null";
        }
     ...
     *
     * @return \Wildberries\Sdk\Items\Model\WholesaleDiscountThresholdReq[]
     */
     ...
     *
     * @param \Wildberries\Sdk\Items\Model\WholesaleDiscountThresholdReq[] $wholesale_discount_threshold Оптовые скидки разных уровней для B2B
     *
     * @return self
     */
