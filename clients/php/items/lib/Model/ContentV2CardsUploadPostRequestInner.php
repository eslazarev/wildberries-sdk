...
class ContentV2CardsUploadPostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets variants
     *
     * @param \Wildberries\Sdk\Items\Model\ContentV2CardsUploadPostRequestInnerVariantsInner[] $variants [Объединённые](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточки товаров.<br>Чтобы создать отдельную карточку, передайте только один объект
     *
     * @return self
     */
