...
/**
 * PostV2UploadTaskSizeRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV2UploadTaskSizeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2UploadTaskSize_request';
    ...
    protected static $openAPITypes = [
        'data' => '\Wildberries\Sdk\Items\Model\SizeGoodReq[]'
    ];
     ...
     * Gets data
     *
     * @return \Wildberries\Sdk\Items\Model\SizeGoodReq[]
     */
     ...
     * Sets data
     *
     * @param \Wildberries\Sdk\Items\Model\SizeGoodReq[] $data Размеры и цены для них. Максимум 1 000 размеров. <br><br> Для товаров с поразмерной установкой цен [карантин](https://seller.wildberries.ru/instructions/ru/ru/material/price-quarantine) не применяется
     *
     * @return self
     */
