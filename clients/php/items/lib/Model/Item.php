...
class Item implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets price
     *
     * @param int|null $price Цена. Валюту можно получить с помощью методов [Получить товары с ценами](./item-management#tag/pricesAndDiscounts/operation/getV2ListGoodsFilter) и [Получить товары с ценами по артикулам](./item-management#tag/pricesAndDiscounts/operation/postV2ListGoodsFilter), поле `currencyIsoCode4217`
     *
     * @return self
     */
