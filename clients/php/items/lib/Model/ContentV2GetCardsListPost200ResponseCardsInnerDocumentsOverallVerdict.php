...
/**
 * ContentV2GetCardsListPost200ResponseCardsInnerDocumentsOverallVerdict Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentV2GetCardsListPost200ResponseCardsInnerDocumentsOverallVerdict implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_get_cards_list_post_200_response_cards_inner_documents_overallVerdict';
    ...
    protected static $setters = [
        'is_fully_checked' => 'setIsFullyChecked',
        'status' => 'setStatus',
        'reason' => 'setReason',
    ...
    protected static $getters = [
        'is_fully_checked' => 'getIsFullyChecked',
        'status' => 'getStatus',
        'reason' => 'getReason',
    ...
    {
        $this->setIfExists('is_fully_checked', $data ?? [], null);
    ...
    /**
     * Gets is_fully_checked
     *
     * @return bool|null
     */
    public function getIsFullyChecked()
    {
        return $this->container['is_fully_checked'];
    }

    /**
     * Sets is_fully_checked
     *
     * @param bool|null $is_fully_checked - `true` — карточка товара проверена - `false` — карточка товара не проверена
     *
     * @return self
     */
    public function setIsFullyChecked($is_fully_checked)
    {
        if (is_null($is_fully_checked)) {
            throw new \InvalidArgumentException('non-nullable is_fully_checked cannot be null');
        }
        $this->container['is_fully_checked'] = $is_fully_checked;
     ...
     * Sets status
     *
     * @param int|null $status Результат проверки карточки товара:   - `1` — проверка пройдена   - `2` — проверка не пройдена
     *
     * @return self
     */
