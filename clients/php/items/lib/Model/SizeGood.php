...
class SizeGood implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets size_id
     *
     * @param int|null $size_id ID размера. Можно получить с помощью метода [Получение списка товаров по артикулам](./item-management#tag/pricesAndDiscounts/operation/getV2ListGoodsFilter), поле `sizeID`. В методах Контента это поле `chrtID`
     *
     * @return self
     */
