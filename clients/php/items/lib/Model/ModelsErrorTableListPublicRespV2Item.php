...
class ModelsErrorTableListPublicRespV2Item implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'batch_uuid' => 'string',
        'subjects' => 'array<string,\Wildberries\Sdk\Items\Model\ModelsErrorSubcategory>',
        'brands' => 'array<string,\Wildberries\Sdk\Items\Model\ModelsErrorBrand>',
        'vendor_codes' => 'string[]',
     ...
     * Gets subjects
     *
     * @return array<string,\Wildberries\Sdk\Items\Model\ModelsErrorSubcategory>
     */
     ...
     * Sets subjects
     *
     * @param array<string,\Wildberries\Sdk\Items\Model\ModelsErrorSubcategory> $subjects Предметы. Разбивка по `vendorCodes`
     *
     * @return self
     */
     ...
     * Gets brands
     *
     * @return array<string,\Wildberries\Sdk\Items\Model\ModelsErrorBrand>
     */
     ...
     * Sets brands
     *
     * @param array<string,\Wildberries\Sdk\Items\Model\ModelsErrorBrand> $brands Бренды. Разбивка по `vendorCodes`
     *
     * @return self
     */
