...
/**
 * PostV2GetCardsListRequestSettingsFilter Class Doc Comment
 *
 * @category Class
 ...
 */
class PostV2GetCardsListRequestSettingsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2GetCardsList_request_settings_filter';
     ...
     * Sets with_photo
     *
     * @param int|null $with_photo Фильтр по фото:   * `-1` — любые карточки товаров   * `0` — только карточки без фото. С [16 июня](/release-notes?id=531) — любые карточки товаров   * `1` — только карточки с фото   * `2` — только карточки без фото. С [16 июня](/release-notes?id=531)
     *
     * @return self
     */
     ...
     * Sets imt_id
     *
     * @param int|null $imt_id Поиск по [ID для объединённых карточек товаров](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov)
     *
     * @return self
     */
