...
/**
 * PutV3StocksWarehouseIdRequestStocksInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PutV3StocksWarehouseIdRequestStocksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3StocksWarehouseId_request_stocks_inner';
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 100000)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PutV3StocksWarehouseIdRequestStocksInner., must be smaller than or equal to 100000.');
        }
