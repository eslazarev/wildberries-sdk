...
/**
 * PostV1UploadTaskB2bWholesale200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV1UploadTaskB2bWholesale200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV1UploadTaskB2bWholesale_200_response';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'already_exists' => 'bool',
        'results' => '\Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale200ResponseResultsInner[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['already_exists'] === null) {
            $invalidProperties[] = "'already_exists' can't be null";
        }
     ...
     * Sets already_exists
     *
     * @param bool $already_exists Дублирование загрузки: `true` — такая загрузка уже есть
     *
     * @return self
     */
     ...
     * Gets results
     *
     * @return \Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale200ResponseResultsInner[]
     */
     ...
     * Sets results
     *
     * @param \Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale200ResponseResultsInner[] $results Результаты обработки запроса
     *
     * @return self
     */
