...
/**
 * SetRecomReqRecListInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class SetRecomReqRecListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SetRecomReq_recList_inner';
    ...
    protected static $openAPITypes = [
        'nm_id' => 'int',
        'recommendations' => '\Wildberries\Sdk\Items\Model\SetRecomReqRecListInnerRecommendationsInner[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['recommendations']) && (count($this->container['recommendations']) > 20)) {
            $invalidProperties[] = "invalid value for 'recommendations', number of items must be less than or equal to 20.";
        }

        if (!is_null($this->container['recommendations']) && (count($this->container['recommendations']) < 0)) {
            $invalidProperties[] = "invalid value for 'recommendations', number of items must be greater than or equal to 0.";
        }
     ...
     *
     * @return \Wildberries\Sdk\Items\Model\SetRecomReqRecListInnerRecommendationsInner[]|null
     */
    ...
    public function setRecommendations($recommendations)
    {
        ...
        if ((count($recommendations) < 0)) {
            throw new \InvalidArgumentException('invalid length for $recommendations when calling SetRecomReqRecListInner., number of items must be greater than or equal to 0.');
        }
