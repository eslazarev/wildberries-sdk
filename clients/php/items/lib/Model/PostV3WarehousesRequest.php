...
/**
 * PostV3WarehousesRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV3WarehousesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3Warehouses_request';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostV3WarehousesRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostV3WarehousesRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets office_id
     *
     * @param int $office_id ID [склада WB](./item-management#tag/sellerWarehouses/operation/getV3Offices).<br>Нельзя привязывать склад WB, который уже используется
     *
     * @return self
     */
    public function setOfficeId($office_id)
    {
        ...
        if (($office_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $office_id when calling PostV3WarehousesRequest., must be bigger than or equal to 1.');
        }
