...
/**
 * ContentV2GetCardsListPost200ResponseCardsInnerDocumentsItemsInnerVerdict Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentV2GetCardsListPost200ResponseCardsInnerDocumentsItemsInnerVerdict implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_get_cards_list_post_200_response_cards_inner_documents_items_inner_verdict';
     ...
     * Sets verified
     *
     * @param bool|null $verified - `true` — документ проверен - `false` — документ не проверен
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param int|null $status Результат проверки документа:   - `1` — проверка пройдена   - `2` — проверка не пройдена
     *
     * @return self
     */
     ...
     *
     * @param object|null $additional_data Дополнительная информация
     *
     * @return self
     */
