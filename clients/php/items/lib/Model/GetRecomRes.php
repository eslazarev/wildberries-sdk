...
/**
 * GetRecomRes Class Doc Comment
 *
 * @category Class
 * @description Товары с рекомендациями
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetRecomRes implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetRecomRes';
    ...
    protected static $openAPITypes = [
        'data' => '\Wildberries\Sdk\Items\Model\GetRecomResDataInner[]',
        'next' => 'int'
    ];
     ...
     * Gets data
     *
     * @return \Wildberries\Sdk\Items\Model\GetRecomResDataInner[]
     */
     ...
     * Sets data
     *
     * @param \Wildberries\Sdk\Items\Model\GetRecomResDataInner[] $data Данные о товарах и их рекомендациях
     *
     * @return self
     */
