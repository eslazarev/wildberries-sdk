...
/**
 * ApiV3WarehousesWarehouseIdPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3WarehousesWarehouseIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_warehouses__warehouseId__put_request';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApiV3WarehousesWarehouseIdPutRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApiV3WarehousesWarehouseIdPutRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets office_id
     *
     * @param int $office_id ID [склада WB](./work-with-products#tag/Sklady-prodavca/paths/~1api~1v3~1offices/get).<br>Нельзя привязывать склад WB, который уже используется.<br>Можно менять не чаще одного раза в сутки
     *
     * @return self
     */
    public function setOfficeId($office_id)
    {
        ...
        if (($office_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $office_id when calling ApiV3WarehousesWarehouseIdPutRequest., must be bigger than or equal to 1.');
        }
