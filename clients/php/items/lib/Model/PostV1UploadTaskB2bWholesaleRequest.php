...
/**
 * PostV1UploadTaskB2bWholesaleRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV1UploadTaskB2bWholesaleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV1UploadTaskB2bWholesale_request';
    ...
    protected static $openAPITypes = [
        'data' => '\Wildberries\Sdk\Items\Model\B2BWholesaleInner[]'
    ];
     ...
     * Gets data
     *
     * @return \Wildberries\Sdk\Items\Model\B2BWholesaleInner[]
     */
     ...
     * Sets data
     *
     * @param \Wildberries\Sdk\Items\Model\B2BWholesaleInner[] $data Товары и оптовые скидки для B2B
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling PostV1UploadTaskB2bWholesaleRequest., number of items must be greater than or equal to 1.');
        }
