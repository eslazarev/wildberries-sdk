...
/**
 * PostV2CardsUploadAddRequestCardsToAddInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV2CardsUploadAddRequestCardsToAddInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2CardsUploadAdd_request_cardsToAdd_inner';
    ...
    public function setVendorCode($vendor_code)
    {
        ...
        if ((mb_strlen($vendor_code) > 72)) {
            throw new \InvalidArgumentException('invalid length for $vendor_code when calling PostV2CardsUploadAddRequestCardsToAddInner., must be smaller than or equal to 72.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $title when calling PostV2CardsUploadAddRequestCardsToAddInner., must be smaller than or equal to 60.');
        }
     ...
     * Gets dimensions
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUploadAddRequestCardsToAddInnerDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUploadAddRequestCardsToAddInnerDimensions|null $dimensions dimensions
     *
     * @return self
     */
     ...
     * Gets sizes
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUploadAddRequestCardsToAddInnerSizesInner[]|null
     */
     ...
     * Sets sizes
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUploadAddRequestCardsToAddInnerSizesInner[]|null $sizes Массив размеров.<br> Если не указать для размерного товара (обувь, одежда и др.), сгенерируется автоматически с `techSize` = \"A\", `wbSize` = \"1\" и баркодом
     *
     * @return self
     */
