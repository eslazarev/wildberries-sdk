...
/**
 * GetRecomReq Class Doc Comment
 *
 * @category Class
 * @description Запрос для получения рекомендаций
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetRecomReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetRecomReq';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['brand_names']) && (count($this->container['brand_names']) > 30)) {
            $invalidProperties[] = "invalid value for 'brand_names', number of items must be less than or equal to 30.";
        }
        ...
        if (!is_null($this->container['search']) && (mb_strlen($this->container['search']) > 72)) {
            $invalidProperties[] = "invalid value for 'search', the character length must be smaller than or equal to 72.";
        }

        if (!is_null($this->container['subject_ids']) && (count($this->container['subject_ids']) > 30)) {
            $invalidProperties[] = "invalid value for 'subject_ids', number of items must be less than or equal to 30.";
        }
     ...
     * Sets brand_names
     *
     * @param string[]|null $brand_names Бренды
     *
     * @return self
     */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling GetRecomReq., must be bigger than or equal to 0.');
        }
     ...
     * Sets search
     *
     * @param string|null $search Поиск:   - по артикулу WB `nmId` — полное совпадение   - по артикулу продавца `vendorCode` — частичное совпадение
     *
     * @return self
     */
    public function setSearch($search)
    {
        ...
        if ((mb_strlen($search) > 72)) {
            throw new \InvalidArgumentException('invalid length for $search when calling GetRecomReq., must be smaller than or equal to 72.');
        }
     ...
     * Sets subject_ids
     *
     * @param int[]|null $subject_ids ID предметов
     *
     * @return self
     */
