...
/**
 * PostV2CardsUploadRequestInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV2CardsUploadRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2CardsUpload_request_inner';
    ...
    protected static $openAPITypes = [
        'subject_id' => 'int',
        'variants' => '\Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInner[]'
    ];
     ...
     * Gets variants
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInner[]
     */
     ...
     * Sets variants
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUploadRequestInnerVariantsInner[] $variants [Объединённые](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточки товаров.<br>Чтобы создать отдельную карточку, передайте только один объект
     *
     * @return self
     */
