...
/**
 * SetRecomReqRecListInnerRecommendationsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class SetRecomReqRecListInnerRecommendationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SetRecomReq_recList_inner_recommendations_inner';
    ...
    {
        $this->setIfExists('recom_nm', $data ?? [], 0);
        $this->setIfExists('sort', $data ?? [], 20);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sort']) && ($this->container['sort'] > 20)) {
            $invalidProperties[] = "invalid value for 'sort', must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['sort']) && ($this->container['sort'] < 0)) {
     ...
     * Sets recom_nm
     *
     * @param int|null $recom_nm Артикул WB рекомендуемого товара
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param int|null $sort На каком месте находится товар в списке рекомендаций
     *
     * @return self
     */
    public function setSort($sort)
    {
        ...
        if (($sort < 0)) {
            throw new \InvalidArgumentException('invalid value for $sort when calling SetRecomReqRecListInnerRecommendationsInner., must be bigger than or equal to 0.');
        }
