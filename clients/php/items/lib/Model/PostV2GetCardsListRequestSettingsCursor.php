...
/**
 * PostV2GetCardsListRequestSettingsCursor Class Doc Comment
 *
 * @category Class
 * @description Курсор
 * @package  Wildberries\Sdk\Items
 ...
 */
class PostV2GetCardsListRequestSettingsCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2GetCardsList_request_settings_cursor';
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 100)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling PostV2GetCardsListRequestSettingsCursor., must be smaller than or equal to 100.');
        }
