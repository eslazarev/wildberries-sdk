...
/**
 * PostV2CardsUploadAddRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV2CardsUploadAddRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2CardsUploadAdd_request';
    ...
    protected static $openAPITypes = [
        'imt_id' => 'int',
        'cards_to_add' => '\Wildberries\Sdk\Items\Model\PostV2CardsUploadAddRequestCardsToAddInner[]'
    ];
     ...
     * Sets imt_id
     *
     * @param int|null $imt_id `imtID` отдельной карточки товара или группы [объединённых](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточек товаров, к которой присоединяются создаваемые карточки
     *
     * @return self
     */
     ...
     * Gets cards_to_add
     *
     * @return \Wildberries\Sdk\Items\Model\PostV2CardsUploadAddRequestCardsToAddInner[]|null
     */
     ...
     * Sets cards_to_add
     *
     * @param \Wildberries\Sdk\Items\Model\PostV2CardsUploadAddRequestCardsToAddInner[]|null $cards_to_add Добавляемые карточки товаров
     *
     * @return self
     */
