...
/**
 * PostV2GetCardsTrashRequestSettingsCursor Class Doc Comment
 *
 * @category Class
 ...
 */
class PostV2GetCardsTrashRequestSettingsCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV2GetCardsTrash_request_settings_cursor';
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 100)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling PostV2GetCardsTrashRequestSettingsCursor., must be smaller than or equal to 100.');
        }
