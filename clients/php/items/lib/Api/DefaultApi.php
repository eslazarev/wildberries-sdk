...
namespace Wildberries\Sdk\Items\Api;
...
use Wildberries\Sdk\Items\ApiException;
use Wildberries\Sdk\Items\Configuration;
use Wildberries\Sdk\Items\FormDataProcessor;
use Wildberries\Sdk\Items\HeaderSelector;
...
class DefaultApi
{
     ...
     * @return \Wildberries\Sdk\Items\Model\BrandsResponse|\Wildberries\Sdk\Items\Model\BrandsResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\BrandsResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\BrandsResponse',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\BrandsResponseError',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\BrandsResponse';
        $request = $this->apiContentV1BrandsGetRequest($subject_id, $next, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ApiV2BufferGoodsTaskGet200Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Items\Model\ApiV2BufferGoodsTaskGet200Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV2BufferGoodsTaskGetWithHttpInfo($limit, $upload_id, $offset = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV2BufferGoodsTaskGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV2BufferGoodsTaskGet200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ResponseError',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV2BufferGoodsTaskGet200Response';
        $request = $this->apiV2BufferGoodsTaskGetRequest($limit, $upload_id, $offset, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ApiV2BufferTasksGet200Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function apiV2BufferTasksGetWithHttpInfo($upload_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV2BufferTasksGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV2BufferTasksGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV2BufferTasksGet200Response';
        $request = $this->apiV2BufferTasksGetRequest($upload_id, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ApiV2HistoryGoodsTaskGet200Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function apiV2HistoryGoodsTaskGetWithHttpInfo($limit, $upload_id, $offset = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV2HistoryGoodsTaskGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV2HistoryGoodsTaskGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV2HistoryGoodsTaskGet200Response';
        $request = $this->apiV2HistoryGoodsTaskGetRequest($limit, $upload_id, $offset, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ApiV2HistoryTasksGet200Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Items\Model\ApiV2HistoryTasksGet200Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV2HistoryTasksGetWithHttpInfo($upload_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV2HistoryTasksGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV2HistoryTasksGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV2HistoryTasksGet200Response';
        $request = $this->apiV2HistoryTasksGetRequest($upload_id, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    public function apiV2ListGoodsFilterGetWithHttpInfo($limit, $offset = null, $filter_nm_id = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV2ListGoodsFilterGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV2ListGoodsFilterGet200Response',
                        $request,
                        $response,
                    );
                case 400:
                ...
                case 402:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response',
                        $request,
                        $response,
                    );
                case 403:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV2ListGoodsFilterGet200Response';
        $request = $this->apiV2ListGoodsFilterGetRequest($limit, $offset, $filter_nm_id, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ApiV2ListGoodsFilterPostRequest $api_v2_list_goods_filter_post_request api_v2_list_goods_filter_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ApiV2ListGoodsFilterPostRequest $api_v2_list_goods_filter_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV2ListGoodsFilterPost'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ApiV2ListGoodsSizeNmGet200Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function apiV2ListGoodsSizeNmGetWithHttpInfo($limit, $nm_id, $offset = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV2ListGoodsSizeNmGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV2ListGoodsSizeNmGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV2ListGoodsSizeNmGet200Response';
        $request = $this->apiV2ListGoodsSizeNmGetRequest($limit, $nm_id, $offset, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    public function apiV2QuarantineGoodsGetWithHttpInfo($limit, $offset = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV2QuarantineGoodsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV2QuarantineGoodsGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV2QuarantineGoodsGet200Response';
        $request = $this->apiV2QuarantineGoodsGetRequest($limit, $offset, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ApiV2UploadTaskClubDiscountPostRequest $api_v2_upload_task_club_discount_post_request api_v2_upload_task_club_discount_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\TaskCreated|\Wildberries\Sdk\Items\Model\RequestAlreadyExistsError|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ResponseError|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ApiV2UploadTaskClubDiscountPostRequest $api_v2_upload_task_club_discount_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV2UploadTaskClubDiscountPost'] to see the possible values for this operation
     *
    ...
    public function apiV2UploadTaskClubDiscountPostWithHttpInfo($api_v2_upload_task_club_discount_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV2UploadTaskClubDiscountPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\TaskCreated',
                        $request,
                        $response,
                    );
                case 208:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\RequestAlreadyExistsError',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\TaskCreated';
        $request = $this->apiV2UploadTaskClubDiscountPostRequest($api_v2_upload_task_club_discount_post_request, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ApiV2UploadTaskPostRequest $api_v2_upload_task_post_request api_v2_upload_task_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ApiV2UploadTaskPostRequest $api_v2_upload_task_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV2UploadTaskPost'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ApiV2UploadTaskSizePostRequest $api_v2_upload_task_size_post_request api_v2_upload_task_size_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ApiV2UploadTaskSizePostRequest $api_v2_upload_task_size_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV2UploadTaskSizePost'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ApiV3DbwWarehousesWarehouseIdContactsGet200Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function apiV3DbwWarehousesWarehouseIdContactsGetWithHttpInfo($warehouse_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV3DbwWarehousesWarehouseIdContactsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV3DbwWarehousesWarehouseIdContactsGet200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\Error',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV3DbwWarehousesWarehouseIdContactsGet200Response';
        $request = $this->apiV3DbwWarehousesWarehouseIdContactsGetRequest($warehouse_id, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     *
     * @param  int $warehouse_id ID склада продавца (required)
     * @param  \Wildberries\Sdk\Items\Model\StoreContactRequestBody $store_contact_request_body store_contact_request_body (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     *
     * @param  int $warehouse_id ID склада продавца (required)
     * @param  \Wildberries\Sdk\Items\Model\StoreContactRequestBody $store_contact_request_body (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV3DbwWarehousesWarehouseIdContactsPut'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\Office[]|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Items\Model\Office[]|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV3OfficesGetWithHttpInfo(?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV3OfficesGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\Office[]',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\Office[]';
        $request = $this->apiV3OfficesGetRequest($hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     *
     * @param  int $warehouse_id ID склада продавца (required)
     * @param  \Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdDeleteRequest $api_v3_stocks_warehouse_id_delete_request api_v3_stocks_warehouse_id_delete_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     *
     * @param  int $warehouse_id ID склада продавца (required)
     * @param  \Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdDeleteRequest $api_v3_stocks_warehouse_id_delete_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV3StocksWarehouseIdDelete'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     *
     * @param  int $warehouse_id ID склада продавца (required)
     * @param  \Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdPostRequest $api_v3_stocks_warehouse_id_post_request api_v3_stocks_warehouse_id_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdPost200Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     *
     * @param  int $warehouse_id ID склада продавца (required)
     * @param  \Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdPostRequest $api_v3_stocks_warehouse_id_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV3StocksWarehouseIdPost'] to see the possible values for this operation
     *
    ...
    public function apiV3StocksWarehouseIdPostWithHttpInfo($warehouse_id, $api_v3_stocks_warehouse_id_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV3StocksWarehouseIdPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdPost200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdPost200Response';
        $request = $this->apiV3StocksWarehouseIdPostRequest($warehouse_id, $api_v3_stocks_warehouse_id_post_request, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     *
     * @param  int $warehouse_id ID склада продавца (required)
     * @param  \Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdPutRequest|null $api_v3_stocks_warehouse_id_put_request api_v3_stocks_warehouse_id_put_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     *
     * @param  int $warehouse_id ID склада продавца (required)
     * @param  \Wildberries\Sdk\Items\Model\ApiV3StocksWarehouseIdPutRequest|null $api_v3_stocks_warehouse_id_put_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV3StocksWarehouseIdPut'] to see the possible values for this operation
     *
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wildberries\Sdk\Items\Model\StocksWarehouseErrorInner[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    throw $e;
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\Warehouse[]|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Items\Model\Warehouse[]|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV3WarehousesGetWithHttpInfo(?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV3WarehousesGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\Warehouse[]',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\Warehouse[]';
        $request = $this->apiV3WarehousesGetRequest($hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ApiV3WarehousesPost201Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\Error|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function apiV3WarehousesPostWithHttpInfo($api_v3_warehouses_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV3WarehousesPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ApiV3WarehousesPost201Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ApiV3WarehousesPost201Response';
        $request = $this->apiV3WarehousesPostRequest($api_v3_warehouses_post_request, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2BarcodesPostRequest $content_v2_barcodes_post_request content_v2_barcodes_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2DirectoryKindsGet200Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2BarcodesPostRequest $content_v2_barcodes_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2BarcodesPost'] to see the possible values for this operation
     *
    ...
    public function contentV2BarcodesPostWithHttpInfo($content_v2_barcodes_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2BarcodesPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2DirectoryKindsGet200Response',
                        $request,
                        $response,
                    );
                case 401:
                ...
                case 403:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ResponseBodyContentError403',
                        $request,
                        $response,
                    );
                case 429:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2DirectoryKindsGet200Response';
        $request = $this->contentV2BarcodesPostRequest($content_v2_barcodes_post_request, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsDeleteTrashPostRequest $content_v2_cards_delete_trash_post_request content_v2_cards_delete_trash_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2CardsDeleteTrashPost200Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsDeleteTrashPostRequest $content_v2_cards_delete_trash_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2CardsDeleteTrashPost'] to see the possible values for this operation
     *
    ...
    public function contentV2CardsDeleteTrashPostWithHttpInfo($content_v2_cards_delete_trash_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2CardsDeleteTrashPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2CardsDeleteTrashPost200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ResponseBodyContentError400',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2CardsDeleteTrashPost200Response';
        $request = $this->contentV2CardsDeleteTrashPostRequest($content_v2_cards_delete_trash_post_request, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\RequestPublicViewerPublicErrorsTableListV2 $request_public_viewer_public_errors_table_list_v2 request_public_viewer_public_errors_table_list_v2 (required)
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\RequestPublicViewerPublicErrorsTableListV2 $request_public_viewer_public_errors_table_list_v2 (required)
     * @param  string|null $locale Язык названий предметов:   - &#x60;ru&#x60; — русский   - &#x60;en&#x60; — английский   - &#x60;zh&#x60; — китайский (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2CardsErrorListPost'] to see the possible values for this operation
    ...
    public function contentV2CardsErrorListPostWithHttpInfo($request_public_viewer_public_errors_table_list_v2, $locale = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2CardsErrorListPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ResponsePublicViewerPublicErrorsTableListV2',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ResponsePublicViewerPublicErrorsTableListV2';
        $request = $this->contentV2CardsErrorListPostRequest($request_public_viewer_public_errors_table_list_v2, $locale, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2CardsLimitsGet200Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Items\Model\ContentV2CardsLimitsGet200Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function contentV2CardsLimitsGetWithHttpInfo(?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2CardsLimitsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2CardsLimitsGet200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2CardsLimitsGet200Response';
        $request = $this->contentV2CardsLimitsGetRequest($hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsMoveNmPostRequest|null $content_v2_cards_move_nm_post_request content_v2_cards_move_nm_post_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ResponseItemList|\Wildberries\Sdk\Items\Model\ContentV2CardsMoveNmPost400Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseItemList|string|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsMoveNmPostRequest|null $content_v2_cards_move_nm_post_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2CardsMoveNmPost'] to see the possible values for this operation
     *
    ...
    public function contentV2CardsMoveNmPostWithHttpInfo($content_v2_cards_move_nm_post_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2CardsMoveNmPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ResponseItemList',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2CardsMoveNmPost400Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ResponseItemList';
        $request = $this->contentV2CardsMoveNmPostRequest($content_v2_cards_move_nm_post_request, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsUpdatePostRequestInner[]|null $content_v2_cards_update_post_request_inner content_v2_cards_update_post_request_inner (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsUpdatePostRequestInner[]|null $content_v2_cards_update_post_request_inner (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2CardsUpdatePost'] to see the possible values for this operation
     *
    ...
    public function contentV2CardsUpdatePostWithHttpInfo($content_v2_cards_update_post_request_inner = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2CardsUpdatePost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 413:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2CardsUpdatePost413Response',
                        $request,
                        $response,
                    );
                case 429:
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsUploadAddPostRequest|null $content_v2_cards_upload_add_post_request content_v2_cards_upload_add_post_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsUploadAddPostRequest|null $content_v2_cards_upload_add_post_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2CardsUploadAddPost'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsUploadPostRequestInner[]|null $content_v2_cards_upload_post_request_inner content_v2_cards_upload_post_request_inner (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2CardsUploadPostRequestInner[]|null $content_v2_cards_upload_post_request_inner (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2CardsUploadPost'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2DirectoryColorsGet200Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function contentV2DirectoryColorsGetWithHttpInfo($locale = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2DirectoryColorsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2DirectoryColorsGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2DirectoryColorsGet200Response';
        $request = $this->contentV2DirectoryColorsGetRequest($locale, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2DirectoryCountriesGet200Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function contentV2DirectoryCountriesGetWithHttpInfo($locale = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2DirectoryCountriesGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2DirectoryCountriesGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2DirectoryCountriesGet200Response';
        $request = $this->contentV2DirectoryCountriesGetRequest($locale, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2DirectoryTnvedGet200Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function contentV2DirectoryTnvedGetWithHttpInfo($subject_id, $search = null, $locale = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2DirectoryTnvedGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2DirectoryTnvedGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2DirectoryTnvedGet200Response';
        $request = $this->contentV2DirectoryTnvedGetRequest($subject_id, $search, $locale, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2GetCardsListPostRequest $content_v2_get_cards_list_post_request content_v2_get_cards_list_post_request (required)
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2GetCardsListPost200Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2GetCardsListPostRequest $content_v2_get_cards_list_post_request (required)
     * @param  string|null $locale Язык полей ответа &#x60;name&#x60;, &#x60;value&#x60; и &#x60;object&#x60;:   - &#x60;ru&#x60; — русский   - &#x60;en&#x60; — английский   - &#x60;zh&#x60; — китайский  Не используется в песочнице (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2GetCardsListPost'] to see the possible values for this operation
    ...
    public function contentV2GetCardsListPostWithHttpInfo($content_v2_get_cards_list_post_request, $locale = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2GetCardsListPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2GetCardsListPost200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2GetCardsListPost200Response';
        $request = $this->contentV2GetCardsListPostRequest($content_v2_get_cards_list_post_request, $locale, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2GetCardsTrashPostRequest $content_v2_get_cards_trash_post_request content_v2_get_cards_trash_post_request (required)
     * @param  string|null $locale Язык полей ответа &#x60;name&#x60;, &#x60;value&#x60; и &#x60;object&#x60;:   - &#x60;ru&#x60; — русский   - &#x60;en&#x60; — английский   - &#x60;zh&#x60; — китайский  Не используется в песочнице (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2GetCardsTrashPost200Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2GetCardsTrashPostRequest $content_v2_get_cards_trash_post_request (required)
     * @param  string|null $locale Язык полей ответа &#x60;name&#x60;, &#x60;value&#x60; и &#x60;object&#x60;:   - &#x60;ru&#x60; — русский   - &#x60;en&#x60; — английский   - &#x60;zh&#x60; — китайский  Не используется в песочнице (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2GetCardsTrashPost'] to see the possible values for this operation
    ...
    public function contentV2GetCardsTrashPostWithHttpInfo($content_v2_get_cards_trash_post_request, $locale = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2GetCardsTrashPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2GetCardsTrashPost200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2GetCardsTrashPost200Response';
        $request = $this->contentV2GetCardsTrashPostRequest($content_v2_get_cards_trash_post_request, $locale, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2ObjectAllGet200Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Items\Model\ContentV2ObjectAllGet200Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function contentV2ObjectAllGetWithHttpInfo($locale = null, $name = null, $limit = 30, $offset = 0, $parent_id = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2ObjectAllGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2ObjectAllGet200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2ObjectAllGet200Response';
        $request = $this->contentV2ObjectAllGetRequest($locale, $name, $limit, $offset, $parent_id, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2ObjectCharcsSubjectIdGet200Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function contentV2ObjectCharcsSubjectIdGetWithHttpInfo($subject_id, $locale = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2ObjectCharcsSubjectIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2ObjectCharcsSubjectIdGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2ObjectCharcsSubjectIdGet200Response';
        $request = $this->contentV2ObjectCharcsSubjectIdGetRequest($subject_id, $locale, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet200Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function contentV2ObjectParentAllGetWithHttpInfo($locale = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2ObjectParentAllGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet200Response';
        $request = $this->contentV2ObjectParentAllGetRequest($locale, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ResponseContentError|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function contentV2TagIdDeleteWithHttpInfo($id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2TagIdDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ResponseContentError',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ResponseContentError';
        $request = $this->contentV2TagIdDeleteRequest($id, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     *
     * @param  int $id Числовой ID ярлыка (required)
     * @param  \Wildberries\Sdk\Items\Model\ContentV2TagPostRequest $content_v2_tag_post_request content_v2_tag_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @return \Wildberries\Sdk\Items\Model\ResponseContentError|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    public function contentV2TagIdPatch($id, $content_v2_tag_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2TagIdPatch'][0])
    {
        list($response) = $this->contentV2TagIdPatchWithHttpInfo($id, $content_v2_tag_post_request, $hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $id Числовой ID ярлыка (required)
     * @param  \Wildberries\Sdk\Items\Model\ContentV2TagPostRequest $content_v2_tag_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2TagIdPatch'] to see the possible values for this operation
     *
     ...
     * @return array of \Wildberries\Sdk\Items\Model\ResponseContentError|\Wildberries\Sdk\Items\Model\ResponseBodyContentError400|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function contentV2TagIdPatchWithHttpInfo($id, $content_v2_tag_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2TagIdPatch'][0])
    {
        $request = $this->contentV2TagIdPatchRequest($id, $content_v2_tag_post_request, $hostIndex, $variables, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contentV2TagIdPatchAsync($id, $content_v2_tag_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2TagIdPatch'][0])
    {
        return $this->contentV2TagIdPatchAsyncWithHttpInfo($id, $content_v2_tag_post_request, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contentV2TagIdPatchAsyncWithHttpInfo($id, $content_v2_tag_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2TagIdPatch'][0])
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ResponseContentError';
        $request = $this->contentV2TagIdPatchRequest($id, $content_v2_tag_post_request, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contentV2TagIdPatchRequest($id, $content_v2_tag_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2TagIdPatch'][0])
    {
        ...
        if ($content_v2_tag_post_request === null || (is_array($content_v2_tag_post_request) && count($content_v2_tag_post_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content_v2_tag_post_request when calling contentV2TagIdPatch'
            );
        }
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2TagNomenclatureLinkPostRequest $content_v2_tag_nomenclature_link_post_request content_v2_tag_nomenclature_link_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV2TagNomenclatureLinkPostRequest $content_v2_tag_nomenclature_link_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV2TagNomenclatureLinkPost'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV2TagsGet200Response|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\ResponseBodyContentError403|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function contentV2TagsGetWithHttpInfo(?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV2TagsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV2TagsGet200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV2TagsGet200Response';
        $request = $this->contentV2TagsGetRequest($hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\ContentV3MediaFilePost200Response|\Wildberries\Sdk\Items\Model\MediaErrors|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ContentV2TagsGet402Response|\Wildberries\Sdk\Items\Model\MediaErrors|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    ...
    public function contentV3MediaFilePostWithHttpInfo($x_nm_id, $x_photo_number, $uploadfile = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contentV3MediaFilePost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ContentV3MediaFilePost200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\MediaErrors',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Wildberries\Sdk\Items\Model\ContentV3MediaFilePost200Response';
        $request = $this->contentV3MediaFilePostRequest($x_nm_id, $x_photo_number, $uploadfile, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV3MediaSavePostRequest $content_v3_media_save_post_request content_v3_media_save_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\ContentV3MediaSavePostRequest $content_v3_media_save_post_request (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contentV3MediaSavePost'] to see the possible values for this operation
     *
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    /**
     * Operation postV1UploadTaskB2bWholesale
     *
     ...
     * URL: https://discounts-prices-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesaleRequest $post_v1_upload_task_b2b_wholesale_request Установка оптовых скидок для B2B (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postV1UploadTaskB2bWholesale'] to see the possible values for this operation
     *
     * @throws \Wildberries\Sdk\Items\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale200Response|\Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale208Response|\Wildberries\Sdk\Items\Model\ResponseErrorV3|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseErrorV3|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response
     */
    public function postV1UploadTaskB2bWholesale($post_v1_upload_task_b2b_wholesale_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1UploadTaskB2bWholesale'][0])
    {
        list($response) = $this->postV1UploadTaskB2bWholesaleWithHttpInfo($post_v1_upload_task_b2b_wholesale_request, $hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     * @return array of \Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale200Response|\Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale208Response|\Wildberries\Sdk\Items\Model\ResponseErrorV3|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response|\Wildberries\Sdk\Items\Model\ResponseErrorV3|\Wildberries\Sdk\Items\Model\ContentV2ObjectParentAllGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postV1UploadTaskB2bWholesaleWithHttpInfo($post_v1_upload_task_b2b_wholesale_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1UploadTaskB2bWholesale'][0])
    {
        $request = $this->postV1UploadTaskB2bWholesaleRequest($post_v1_upload_task_b2b_wholesale_request, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale200Response',
                        $request,
                        $response,
                    );
                case 208:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale208Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Items\Model\ResponseErrorV3',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation postV1UploadTaskB2bWholesaleAsync
     *
     * Установить оптовые скидки для B2B-продаж
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postV1UploadTaskB2bWholesaleAsync($post_v1_upload_task_b2b_wholesale_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1UploadTaskB2bWholesale'][0])
    {
        return $this->postV1UploadTaskB2bWholesaleAsyncWithHttpInfo($post_v1_upload_task_b2b_wholesale_request, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postV1UploadTaskB2bWholesaleAsyncWithHttpInfo($post_v1_upload_task_b2b_wholesale_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1UploadTaskB2bWholesale'][0])
    {
        $returnType = '\Wildberries\Sdk\Items\Model\PostV1UploadTaskB2bWholesale200Response';
        $request = $this->postV1UploadTaskB2bWholesaleRequest($post_v1_upload_task_b2b_wholesale_request, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'postV1UploadTaskB2bWholesale'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://discounts-prices-api.wildberries.ru
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postV1UploadTaskB2bWholesaleRequest($post_v1_upload_task_b2b_wholesale_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1UploadTaskB2bWholesale'][0])
    {

        // verify the required parameter 'post_v1_upload_task_b2b_wholesale_request' is set
        if ($post_v1_upload_task_b2b_wholesale_request === null || (is_array($post_v1_upload_task_b2b_wholesale_request) && count($post_v1_upload_task_b2b_wholesale_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_v1_upload_task_b2b_wholesale_request when calling postV1UploadTaskB2bWholesale'
            );
        }


        $resourcePath = '/api/discounts-prices/v1/upload/task/b2b/wholesale';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($post_v1_upload_task_b2b_wholesale_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_v1_upload_task_b2b_wholesale_request));
            } else {
                $httpBody = $post_v1_upload_task_b2b_wholesale_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
        ...
        $hostSettings = $this->getHostSettingsForpostV1UploadTaskB2bWholesale();
    ...
    /**
     * Returns an array of host settings for Operation postV1UploadTaskB2bWholesale
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForpostV1UploadTaskB2bWholesale(): array
    {
        return [
            [
                "url" => "https://discounts-prices-api.wildberries.ru",
