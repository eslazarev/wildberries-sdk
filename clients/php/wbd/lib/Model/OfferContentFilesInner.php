...
/**
 * OfferContentFilesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OfferContentFilesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferContent_files_inner';
    ...
    */
     ...
     * Sets content_type
     *
     * @param string|null $content_type Тип контента
     *
     * @return self
     */
     ...
     * Sets uri
     *
     * @param string|null $uri URI адрес файла
     *
     * @return self
     */
