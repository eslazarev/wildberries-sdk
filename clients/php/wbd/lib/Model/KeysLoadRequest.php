...
/**
 * KeysLoadRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class KeysLoadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeysLoadRequest';
    ...
    */
     ...
     * Sets keys
     *
     * @param string[] $keys Список ключей.<br><br>  **Ограничения:** - Максимальное количество ключей — **1000** - Максимальная длина ключа — **200 символов**
     *
     * @return self
     */
    public function setKeys($keys)
    {
        ...
        if ((count($keys) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $keys when calling KeysLoadRequest., number of items must be less than or equal to 1000.');
        }
