...
/**
 * UploadChunkResponse Class Doc Comment
 *
 * @category Class
 * @description Файл успешно загружен.&lt;br&gt; Ответ содержит URI адрес контента
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UploadChunkResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadChunkResponse';
    ...
    */
     ...
     * Sets chunk
     *
     * @param int|null $chunk Количество переданных фреймов (частей контента)
     *
     * @return self
     */
     ...
     * Sets uri
     *
     * @param string|null $uri URI адреса загруженного файла
     *
     * @return self
     */
