...
/**
 * KeyRedeemedResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class KeyRedeemedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyRedeemedResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('buyed_at', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['buyed_at'] === null) {
            $invalidProperties[] = "'buyed_at' can't be null";
        }
        ...
        if ($this->container['offer_price'] === null) {
            $invalidProperties[] = "'offer_price' can't be null";
        }
     ...
     * Sets created_at
     *
     * @param string $created_at Дата создания ключа
     *
     * @return self
     */
    ...
    {
        return $this->container['buyed_at'];
    }

    /**
     * Sets buyed_at
     *
     * @param string $buyed_at Дата покупки ключа
     *
     * @return self
     */
    public function setBuyedAt($buyed_at)
    {
        if (is_null($buyed_at)) {
            throw new \InvalidArgumentException('non-nullable buyed_at cannot be null');
        }
        $this->container['buyed_at'] = $buyed_at;
     ...
     * Sets offer_title
     *
     * @param string $offer_title Название предложения
     *
     * @return self
     */
     ...
     * Sets offer_price
     *
     * @param int $offer_price Цена предложения
     *
     * @return self
     */
    public function setOfferPrice($offer_price)
    {
        if (is_null($offer_price)) {
            throw new \InvalidArgumentException('non-nullable offer_price cannot be null');
        }
