...
class KeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyResponse';
    ...
    */
     ...
     * Sets created_at
     *
     * @param string $created_at Дата и время создания ключа
     *
     * @return self
     */
     ...
     * Sets buyed_at
     *
     * @param string|null $buyed_at Дата и время покупки ключа
     *
     * @return self
     */
    ...
    {
        if (is_null($buyed_at)) {
            array_push($this->openAPINullablesSetToNull, 'buyed_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('buyed_at', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets deleted_at
     *
     * @param string|null $deleted_at Дата и время удаления ключа
     *
     * @return self
     */
