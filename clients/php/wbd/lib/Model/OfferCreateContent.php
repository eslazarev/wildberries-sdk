...
/**
 * OfferCreateContent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OfferCreateContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferCreateContent';
    ...
    */
     ...
     * Sets category_id
     *
     * @param int $category_id ID категории контента: - `1` — Видео - `2` — Аудиоконтент - `4` — Документ
     *
     * @return self
     */
