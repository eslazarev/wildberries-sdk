...
/**
 * PlanBuilderOption Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\General
 * @author   OpenAPI Generator team
 ...
 */
class PlanBuilderOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PlanBuilderOption';
    ...
    protected static $openAPITypes = [
        ...
        'promotion' => '\Wildberries\Sdk\General\Model\PlanBuilderPromotion'
    ];
     ...
     * Sets slug
     *
     * @param string|null $slug Код опции
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Название опции на языке из параметра `locale`
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Статус опции:   - `active` — активна   - `pendingActivation` — подключена, начнёт работать с 00:00 следующего дня   - `pendingDeactivation` — отключена, перестанет работать с 00:00 следующего дня
     *
     * @return self
     */
     ...
     *
     * @param float|null $commission_rate Стоимость подключения опции, % от оборота. Возвращается, если в ответе нет объекта `promotion`
     *
     * @return self
     */
     ...
     *
     * @param float|null $period_duration Минимальный срок действия опции в днях
     *
     * @return self
     */
     ...
     * Gets promotion
     *
     * @return \Wildberries\Sdk\General\Model\PlanBuilderPromotion|null
     */
