...
/**
 * GetV1SellerInfo200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\General
 * @author   OpenAPI Generator team
 ...
 */
class GetV1SellerInfo200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getV1SellerInfo_200_response';
     ...
     * Sets sid
     *
     * @param string|null $sid Уникальный ID продавца на Wildberries, [находящийся в публичном поле токена](./api-information#tag/authorization/Kak-ustroen-token)
     *
     * @return self
     */
