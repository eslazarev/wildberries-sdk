...
class APIApi
{
    ...
    /**
     * Operation apiCommunicationsV2NewsGet
     *
     ...
     * @return \OpenAPI\Client\Model\ApiCommunicationsV2NewsGet200Response|\OpenAPI\Client\Model\PingGet401Response|\OpenAPI\Client\Model\PingGet401Response
     */
    ...
    {
        list($response) = $this->apiCommunicationsV2NewsGetWithHttpInfo($from, $from_id, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation apiCommunicationsV2NewsGetWithHttpInfo
     *
     * Получение новостей портала продавцов
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ApiCommunicationsV2NewsGet200Response|\OpenAPI\Client\Model\PingGet401Response|\OpenAPI\Client\Model\PingGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\ApiCommunicationsV2NewsGet200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation apiCommunicationsV2NewsGetAsync
     *
     * Получение новостей портала продавцов
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     */
    public function apiCommunicationsV2NewsGetAsync($from = null, $from_id = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiCommunicationsV2NewsGet'][0])
    {
        return $this->apiCommunicationsV2NewsGetAsyncWithHttpInfo($from, $from_id, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiCommunicationsV2NewsGetAsyncWithHttpInfo
     *
     * Получение новостей портала продавцов
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    ...
    {
        $returnType = '\OpenAPI\Client\Model\ApiCommunicationsV2NewsGet200Response';
        $request = $this->apiCommunicationsV2NewsGetRequest($from, $from_id, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'apiCommunicationsV2NewsGet'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://common-api.wildberries.ru
     ...
     */
    public function apiCommunicationsV2NewsGetRequest($from = null, $from_id = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiCommunicationsV2NewsGet'][0])
    {
        ...
        $hostSettings = $this->getHostSettingsForapiCommunicationsV2NewsGet();
    ...
    /**
     * Returns an array of host settings for Operation apiCommunicationsV2NewsGet
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForapiCommunicationsV2NewsGet(): array
    {
        return [
            [
                "url" => "https://common-api.wildberries.ru",
