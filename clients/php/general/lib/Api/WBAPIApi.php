...
class WBAPIApi
{
     ...
     * @return \OpenAPI\Client\Model\PingGet200Response|\OpenAPI\Client\Model\PingGet401Response|\OpenAPI\Client\Model\PingGet401Response
     */
    public function pingGet(?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['pingGet'][0])
    {
        list($response) = $this->pingGetWithHttpInfo($hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PingGet200Response|\OpenAPI\Client\Model\PingGet401Response|\OpenAPI\Client\Model\PingGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\PingGet200Response',
                        $request,
                        $response,
                    );
                case 401:
     ...
     */
    public function pingGetAsync(?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['pingGet'][0])
    {
        return $this->pingGetAsyncWithHttpInfo($hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\PingGet200Response';
        $request = $this->pingGetRequest($hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     */
    public function pingGetRequest(?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['pingGet'][0])
    {
        ...
        $hostSettings = $this->getHostSettingsForpingGet();
    ...
    /**
     * Returns an array of host settings for Operation pingGet
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForpingGet(): array
    {
        return [
            [
                "url" => "https://common-api.wildberries.ru",
