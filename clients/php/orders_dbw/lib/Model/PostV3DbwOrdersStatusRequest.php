...
/**
 * PostV3DbwOrdersStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class PostV3DbwOrdersStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3DbwOrdersStatus_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling PostV3DbwOrdersStatusRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling PostV3DbwOrdersStatusRequest., number of items must be greater than or equal to 1.');
        }
