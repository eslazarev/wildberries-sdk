...
/**
 * PutV3DbwOrdersOrderIdMetaImeiRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class PutV3DbwOrdersOrderIdMetaImeiRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3DbwOrdersOrderIdMetaImei_request';
    ...
    public function setImei($imei)
    {
        ...
        if ((mb_strlen($imei) > 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling PutV3DbwOrdersOrderIdMetaImeiRequest., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($imei) < 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling PutV3DbwOrdersOrderIdMetaImeiRequest., must be bigger than or equal to 15.');
        }
