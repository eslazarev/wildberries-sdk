...
/**
 * PutV3DbwOrdersOrderIdMetaGtinRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class PutV3DbwOrdersOrderIdMetaGtinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3DbwOrdersOrderIdMetaGtin_request';
    ...
    public function setGtin($gtin)
    {
        ...
        if ((mb_strlen($gtin) > 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling PutV3DbwOrdersOrderIdMetaGtinRequest., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($gtin) < 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling PutV3DbwOrdersOrderIdMetaGtinRequest., must be bigger than or equal to 13.');
        }
