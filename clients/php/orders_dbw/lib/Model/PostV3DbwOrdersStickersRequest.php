...
/**
 * PostV3DbwOrdersStickersRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class PostV3DbwOrdersStickersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3DbwOrdersStickers_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 100)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling PostV3DbwOrdersStickersRequest., number of items must be less than or equal to 100.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling PostV3DbwOrdersStickersRequest., number of items must be greater than or equal to 1.');
        }
