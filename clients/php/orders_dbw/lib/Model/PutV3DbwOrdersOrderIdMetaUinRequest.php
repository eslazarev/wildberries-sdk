...
/**
 * PutV3DbwOrdersOrderIdMetaUinRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class PutV3DbwOrdersOrderIdMetaUinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3DbwOrdersOrderIdMetaUin_request';
    ...
    public function setUin($uin)
    {
        ...
        if ((mb_strlen($uin) > 16)) {
            throw new \InvalidArgumentException('invalid length for $uin when calling PutV3DbwOrdersOrderIdMetaUinRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($uin) < 16)) {
            throw new \InvalidArgumentException('invalid length for $uin when calling PutV3DbwOrdersOrderIdMetaUinRequest., must be bigger than or equal to 16.');
        }
