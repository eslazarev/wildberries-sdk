...
class ContentV2CardsUploadAddPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'imt_id' => 'int',
        'cards_to_add' => '\OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInner[]'
    ];
    ...
    */
     ...
     * Gets cards_to_add
     *
     * @return \OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInner[]|null
     */
     ...
     * Sets cards_to_add
     *
     * @param \OpenAPI\Client\Model\ContentV2CardsUploadAddPostRequestCardsToAddInner[]|null $cards_to_add Структура присоединяемой карточки товара
     *
     * @return self
     */
