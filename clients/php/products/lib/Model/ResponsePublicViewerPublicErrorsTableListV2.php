...
class ResponsePublicViewerPublicErrorsTableListV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ModelsErrorTableListPublicRespV2',
        'error' => 'bool',
        'error_text' => 'string',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ModelsErrorTableListPublicRespV2
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ModelsErrorTableListPublicRespV2 $data data
     *
     * @return self
     */
