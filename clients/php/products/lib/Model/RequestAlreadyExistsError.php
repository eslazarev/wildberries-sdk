...
class RequestAlreadyExistsError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\RequestAlreadyExistsErrorData',
        'error' => 'bool',
        'error_text' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\RequestAlreadyExistsErrorData|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\RequestAlreadyExistsErrorData|null $data data
     *
     * @return self
     */
