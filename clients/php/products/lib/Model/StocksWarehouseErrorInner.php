...
class StocksWarehouseErrorInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\StocksWarehouseErrorInnerDataInner[]',
        'code' => 'string',
        'message' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\StocksWarehouseErrorInnerDataInner[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\StocksWarehouseErrorInnerDataInner[]|null $data Дополнительная информация об ошибке
     *
     * @return self
     */
