...
class ApiV2UploadTaskSizePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\SizeGoodReq[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\SizeGoodReq[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\SizeGoodReq[] $data Размеры и цены для них. Максимум 1 000 размеров. <br><br> Для товаров с поразмерной установкой цен [карантин](https://seller.wildberries.ru/instructions/ru/ru/material/price-quarantine) не применяется
     *
     * @return self
     */
