...
class ContentV2CardsUploadPostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'subject_id' => 'int',
        'variants' => '\OpenAPI\Client\Model\ContentV2CardsUploadPostRequestInnerVariantsInner[]'
    ];
    ...
    */
     ...
     * Gets variants
     *
     * @return \OpenAPI\Client\Model\ContentV2CardsUploadPostRequestInnerVariantsInner[]
     */
     ...
     * Sets variants
     *
     * @param \OpenAPI\Client\Model\ContentV2CardsUploadPostRequestInnerVariantsInner[] $variants Массив вариантов товара.<br> В каждой объединённой карточке товара может быть не более 30 карточек товаров
     *
     * @return self
     */
