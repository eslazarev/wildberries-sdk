...
class ApiV3StocksWarehouseIdDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSkus($skus)
    {
        ...
        if ((count($skus) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $skus when calling ApiV3StocksWarehouseIdDeleteRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($skus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $skus when calling ApiV3StocksWarehouseIdDeleteRequest., number of items must be greater than or equal to 1.');
        }
