...
class ApiV2HistoryTasksGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\SupplierTaskMetadata',
        'error' => 'bool',
        'error_text' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\SupplierTaskMetadata|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\SupplierTaskMetadata|null $data data
     *
     * @return self
     */
