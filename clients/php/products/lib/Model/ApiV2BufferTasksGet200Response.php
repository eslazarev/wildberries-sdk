...
class ApiV2BufferTasksGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\SupplierTaskMetadataBuffer',
        'error' => 'bool',
        'error_text' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\SupplierTaskMetadataBuffer|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\SupplierTaskMetadataBuffer|null $data data
     *
     * @return self
     */
