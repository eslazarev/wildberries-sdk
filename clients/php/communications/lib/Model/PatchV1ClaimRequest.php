...
class PatchV1ClaimRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets action
     *
     * @param string $action Действие с заявкой.<br>Используйте одно из значений массива `actions` — ответа [метода получения заявок](./user-communication#tag/buyersReturns/operation/getV1Claims)
     *
     * @return self
     */
