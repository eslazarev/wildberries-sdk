...
class ApiFeedbacksV1PinsGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\OpenapiPinnedReviewItemResult[]',
        'next' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\OpenapiPinnedReviewItemResult[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\OpenapiPinnedReviewItemResult[] $data data
     *
     * @return self
     */
