...
/**
 * GetV1Claims200ResponseClaimsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Communications
 * @author   OpenAPI Generator team
 ...
 */
class GetV1Claims200ResponseClaimsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getV1Claims_200_response_claims_inner';
    ...
    public function setUserComment($user_comment)
    {
        ...
        if ((mb_strlen($user_comment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $user_comment when calling GetV1Claims200ResponseClaimsInner., must be smaller than or equal to 1000.');
        }
    ...
    public function setWbComment($wb_comment)
    {
        ...
        if (!is_null($wb_comment) && (mb_strlen($wb_comment) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $wb_comment when calling GetV1Claims200ResponseClaimsInner., must be smaller than or equal to 10000.');
        }
    ...
    public function setPhotos($photos)
    {
        ...
        if ((count($photos) > 10)) {
            throw new \InvalidArgumentException('invalid value for $photos when calling GetV1Claims200ResponseClaimsInner., number of items must be less than or equal to 10.');
        }
        if ((count($photos) < 0)) {
            throw new \InvalidArgumentException('invalid length for $photos when calling GetV1Claims200ResponseClaimsInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setVideoPaths($video_paths)
    {
        ...
        if ((count($video_paths) > 1)) {
            throw new \InvalidArgumentException('invalid value for $video_paths when calling GetV1Claims200ResponseClaimsInner., number of items must be less than or equal to 1.');
        }
        if ((count($video_paths) < 0)) {
            throw new \InvalidArgumentException('invalid length for $video_paths when calling GetV1Claims200ResponseClaimsInner., number of items must be greater than or equal to 0.');
        }
