...
class Event implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets reply_sign
     *
     * @param string|null $reply_sign Подпись чата. Доступна только при `\"isNewChat\": true`. Требуется при [отправке сообщения](./user-communication#tag/buyersChat/operation/postV1SellerMessage)
     *
     * @return self
     */
