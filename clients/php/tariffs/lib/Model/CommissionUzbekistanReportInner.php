...
class CommissionUzbekistanReportInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'kgvp_uzbekistan' => 'setKgvpUzbekistan',
    ...
    protected static $getters = [
        'kgvp_uzbekistan' => 'getKgvpUzbekistan',
    ...
    {
        $this->setIfExists('kgvp_uzbekistan', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets kgvp_uzbekistan
     *
     * @return float|null
     */
    public function getKgvpUzbekistan()
    {
        return $this->container['kgvp_uzbekistan'];
    }

    /**
     * Sets kgvp_uzbekistan
     *
     * @param float|null $kgvp_uzbekistan Комиссия для продавцов из Узбекистана, %
     *
     * @return self
     */
    public function setKgvpUzbekistan($kgvp_uzbekistan)
    {
        if (is_null($kgvp_uzbekistan)) {
            throw new \InvalidArgumentException('non-nullable kgvp_uzbekistan cannot be null');
        }
        $this->container['kgvp_uzbekistan'] = $kgvp_uzbekistan;
