...
namespace Wildberries\Sdk\Tariffs;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (Wildberries\Sdk\Tariffs) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: tariffs' . PHP_EOL;
