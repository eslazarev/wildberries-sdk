...
class ApiOrderGroupsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets groups
     *
     * @param string[]|null $groups Список значений `groupId`. Можно получить из [новых](./dbs#tag/dbsAssemblyOrders/operation/getV3DbsOrdersNew) и [завершенных](./dbs#tag/dbsAssemblyOrders/operation/getV3DbsOrders) сборочных заданий
     *
     * @return self
     */
