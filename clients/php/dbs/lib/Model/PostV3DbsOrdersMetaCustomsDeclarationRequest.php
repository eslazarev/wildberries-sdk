...
/**
 * PostV3DbsOrdersMetaCustomsDeclarationRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Dbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3DbsOrdersMetaCustomsDeclarationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3DbsOrdersMetaCustomsDeclaration_request';
    ...
    protected static $openAPITypes = [
        'orders' => '\Wildberries\Sdk\Dbs\Model\PostV3DbsOrdersMetaCustomsDeclarationRequestOrdersInner[]'
    ];
     ...
     * Gets orders
     *
     * @return \Wildberries\Sdk\Dbs\Model\PostV3DbsOrdersMetaCustomsDeclarationRequestOrdersInner[]
     */
     ...
     * Sets orders
     *
     * @param \Wildberries\Sdk\Dbs\Model\PostV3DbsOrdersMetaCustomsDeclarationRequestOrdersInner[] $orders orders
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling PostV3DbsOrdersMetaCustomsDeclarationRequest., number of items must be less than or equal to 1000.');
        }
