...
/**
 * ApiOrdersMetaDetailsResponse Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Dbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrdersMetaDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrdersMetaDetailsResponse';
    ...
    protected static $openAPITypes = [
        'request_id' => 'string',
        'orders' => '\Wildberries\Sdk\Dbs\Model\ApiOrdersMetaDetailsResponseOrdersInner[]'
    ];
     ...
     * Gets orders
     *
     * @return \Wildberries\Sdk\Dbs\Model\ApiOrdersMetaDetailsResponseOrdersInner[]|null
     */
     ...
     * Sets orders
     *
     * @param \Wildberries\Sdk\Dbs\Model\ApiOrdersMetaDetailsResponseOrdersInner[]|null $orders Идентификаторы маркировки сборочных заданий и статусы их валидации
     *
     * @return self
     */
