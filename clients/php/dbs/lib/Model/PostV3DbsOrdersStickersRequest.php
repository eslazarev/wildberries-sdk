...
/**
 * PostV3DbsOrdersStickersRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Dbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3DbsOrdersStickersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3DbsOrdersStickers_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 100)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling PostV3DbsOrdersStickersRequest., number of items must be less than or equal to 100.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling PostV3DbsOrdersStickersRequest., number of items must be greater than or equal to 1.');
        }
