...
class ApiBatchErrorDeliverResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'int',
        'detail' => 'string',
        'meta_details' => '\Wildberries\Sdk\Dbs\Model\ApiBatchErrorDeliverResponseMetaDetailsInner[]'
    ];
     ...
     * Sets detail
     *
     * @param string|null $detail - `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `ImeiIsNotFilled` — не заполнен IMEI - `MetaValidationFail` — ошибки валидации идентификатора маркировки
     *
     * @return self
     */
     ...
     * Gets meta_details
     *
     * @return \Wildberries\Sdk\Dbs\Model\ApiBatchErrorDeliverResponseMetaDetailsInner[]|null
     */
     ...
     * Sets meta_details
     *
     * @param \Wildberries\Sdk\Dbs\Model\ApiBatchErrorDeliverResponseMetaDetailsInner[]|null $meta_details Детали ошибки валидации идентификаторов маркировки
     *
     * @return self
     */
