...
/**
 * ModelsDraftDeleteitemsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbw
 * @author   OpenAPI Generator team
 ...
 */
class ModelsDraftDeleteitemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.DraftDeleteitemsRequest';
    ...
    public function setSkus($skus)
    {
        ...
        if ((count($skus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $skus when calling ModelsDraftDeleteitemsRequest., number of items must be greater than or equal to 1.');
        }
