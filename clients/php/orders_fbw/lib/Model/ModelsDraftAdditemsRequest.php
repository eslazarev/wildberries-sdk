...
/**
 * ModelsDraftAdditemsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbw
 * @author   OpenAPI Generator team
 ...
 */
class ModelsDraftAdditemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.DraftAdditemsRequest';
    ...
    protected static $openAPITypes = [
        'items' => '\Wildberries\Sdk\OrdersFbw\Model\ModelsItem[]'
    ];
     ...
     * Gets items
     *
     * @return \Wildberries\Sdk\OrdersFbw\Model\ModelsItem[]
     */
     ...
     * Sets items
     *
     * @param \Wildberries\Sdk\OrdersFbw\Model\ModelsItem[] $items Список товаров
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $items when calling ModelsDraftAdditemsRequest., number of items must be less than or equal to 1000.');
        }
