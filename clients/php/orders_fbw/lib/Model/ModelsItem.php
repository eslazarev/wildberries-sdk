 ...
 */
class ModelsItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.Item';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 999999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ModelsItem., must be smaller than or equal to 999999.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ModelsItem., must be bigger than or equal to 1.');
        }
     ...
     * Sets sku
     *
     * @param string $sku Баркод из карточки товара
     *
     * @return self
     */
