...
class MeasurementData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Measurement_data';
    ...
    protected static $openAPITypes = [
        'reports' => '\OpenAPI\Client\Model\MeasurementDataReportsInner[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets reports
     *
     * @return \OpenAPI\Client\Model\MeasurementDataReportsInner[]
     */
     ...
     * Sets reports
     *
     * @param \OpenAPI\Client\Model\MeasurementDataReportsInner[] $reports Замеры
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Количество замеров в отчёте. Без учёта `limit` и `offset`
     *
     * @return self
     */
