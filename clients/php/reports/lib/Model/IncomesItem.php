...
class IncomesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date Дата поступления. Если часовой пояс не указан, то берётся Московское время UTC+3.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_change_date Дата и время обновления информации в сервисе. Это поле соответствует параметру `dateFrom` в запросе. Если часовой пояс не указан, то берётся Московское время UTC+3.
     *
     * @return self
     */
     ...
     * Sets date_close
     *
     * @param \DateTime|null $date_close Дата принятия (закрытия) в WB. Если часовой пояс не указан, то берётся Московское время UTC+3
     *
     * @return self
     */
