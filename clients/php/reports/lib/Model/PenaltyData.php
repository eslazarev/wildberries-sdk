 ...
 */
class PenaltyData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Penalty_data';
    ...
    protected static $openAPITypes = [
        'reports' => '\OpenAPI\Client\Model\PenaltyDataReportsInner[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets reports
     *
     * @return \OpenAPI\Client\Model\PenaltyDataReportsInner[]
     */
     ...
     * Sets reports
     *
     * @param \OpenAPI\Client\Model\PenaltyDataReportsInner[] $reports Удержания
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Количество удержаний в отчёте. Без учёта `limit` и `offset`
     *
     * @return self
     */
