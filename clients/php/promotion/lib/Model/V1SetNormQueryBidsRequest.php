...
/**
 * V1SetNormQueryBidsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V1SetNormQueryBidsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V1SetNormQueryBidsRequest';
    ...
    protected static $openAPITypes = [
        'bids' => '\Wildberries\Sdk\Promotion\Model\V1SetNormQueryBidsRequestItem[]'
    ];
     ...
     * Gets bids
     *
     * @return \Wildberries\Sdk\Promotion\Model\V1SetNormQueryBidsRequestItem[]
     */
     ...
     * Sets bids
     *
     * @param \Wildberries\Sdk\Promotion\Model\V1SetNormQueryBidsRequestItem[] $bids bids
     *
     * @return self
     */
    public function setBids($bids)
    {
        ...
        if ((count($bids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $bids when calling V1SetNormQueryBidsRequest., number of items must be less than or equal to 100.');
        }
