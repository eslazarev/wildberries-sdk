...
/**
 * DaysInnerAppsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DaysInnerAppsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Days_inner_apps_inner';
    ...
    protected static $openAPITypes = [
        ...
        'shks' => 'int',
        'sum_price' => 'float',
        'nm' => '\OpenAPI\Client\Model\DaysInnerAppsInnerNmInner[]',
        'app_type' => 'int'
    ];
    ...
    */
     ...
     * Sets cr
     *
     * @param float|null $cr CR(conversion rate) — это отношение количества заказов к общему количеству посещений кампании
     *
     * @return self
     */
     ...
     * Gets nm
     *
     * @return \OpenAPI\Client\Model\DaysInnerAppsInnerNmInner[]|null
     */
     ...
     * Sets nm
     *
     * @param \OpenAPI\Client\Model\DaysInnerAppsInnerNmInner[]|null $nm Блок статистики по артикулам WB
     *
     * @return self
     */
