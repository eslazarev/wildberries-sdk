...
/**
 * GetV1CalendarPromotionsDetails200ResponseDataPromotionsInnerRangingInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class GetV1CalendarPromotionsDetails200ResponseDataPromotionsInnerRangingInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getV1CalendarPromotionsDetails_200_response_data_promotions_inner_ranging_inner';
    ...
    public function setParticipationRate($participation_rate)
    {
        ...
        if (($participation_rate > 100)) {
            throw new \InvalidArgumentException('invalid value for $participation_rate when calling GetV1CalendarPromotionsDetails200ResponseDataPromotionsInnerRangingInner., must be smaller than or equal to 100.');
        }
        if (($participation_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $participation_rate when calling GetV1CalendarPromotionsDetails200ResponseDataPromotionsInnerRangingInner., must be bigger than or equal to 0.');
        }
