...
/**
 * PostV1BudgetDepositRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class PostV1BudgetDepositRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV1BudgetDeposit_request';
     ...
     *
     * @param int|null $cashback_percent Процент от суммы пополнения, который можно пополнить промо-бонусами. Нужно указать значение поля percent из ответа метода получения [баланса](./promotion#tag/finances/operation/getV1Balance) <br> Если вы указали `cashback_sum`, параметр `cashback_percent` становится обязательным
     *
     * @return self
     */
