...
class V1SetNormQueryBidsRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int $bid_minor_units Ставка в разменных единицах — 0,01 от базовой единицы валюты [аккаунта продавца](https://cmp.wildberries.ru/campaigns/finances). Допустимый шаг ставки указан в ответе метода [GET /api/advert/v1/config](./promotion#tag/Upravlenie-kampaniyami/operation/getV1Config)
     *
     * @return self
     */
