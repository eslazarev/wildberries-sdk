...
/**
 * V1SetNormQueryBidsRequestItem Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V1SetNormQueryBidsRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V1SetNormQueryBidsRequestItem';
    ...
    protected static $setters = [
        ...
        'bid_minor_units' => 'setBidMinorUnits'
    ];
    ...
    protected static $getters = [
        ...
        'bid_minor_units' => 'getBidMinorUnits'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bid_minor_units', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bid_minor_units'] === null) {
            $invalidProperties[] = "'bid_minor_units' can't be null";
        }
    ...
    /**
     * Gets bid_minor_units
     *
     * @return int
     */
    public function getBidMinorUnits()
    {
        return $this->container['bid_minor_units'];
    }

    /**
     * Sets bid_minor_units
     *
     * @param int $bid_minor_units Ставка в разменных единицах — 0,01 от базовой валюты [аккаунта продавца](https://cmp.wildberries.ru/campaigns/finances). Допустимый шаг ставки указан в ответе метода [GET /api/advert/v1/config](./promotion#tag/campaignManagement/operation/getV1Config)
     *
     * @return self
     */
    public function setBidMinorUnits($bid_minor_units)
    {
        if (is_null($bid_minor_units)) {
            throw new \InvalidArgumentException('non-nullable bid_minor_units cannot be null');
        }
        $this->container['bid_minor_units'] = $bid_minor_units;
