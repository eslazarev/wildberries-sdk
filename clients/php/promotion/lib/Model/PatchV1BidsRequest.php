...
/**
 * PatchV1BidsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class PatchV1BidsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'patchV1Bids_request';
    ...
    protected static $openAPITypes = [
        'bids' => '\Wildberries\Sdk\Promotion\Model\PatchV1BidsRequestBidsInner[]'
    ];
     ...
     * Gets bids
     *
     * @return \Wildberries\Sdk\Promotion\Model\PatchV1BidsRequestBidsInner[]
     */
     ...
     * Sets bids
     *
     * @param \Wildberries\Sdk\Promotion\Model\PatchV1BidsRequestBidsInner[] $bids Ставки в кампаниях
     *
     * @return self
     */
    public function setBids($bids)
    {
        ...
        if ((count($bids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $bids when calling PatchV1BidsRequest., number of items must be less than or equal to 50.');
        }
