...
/**
 * AdvV0AuctionBidsPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0AuctionBidsPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_auction_bids_patch_request';
    ...
    protected static $openAPITypes = [
        'bids' => '\OpenAPI\Client\Model\AdvV0AuctionBidsPatchRequestBidsInner[]'
    ];
    ...
    */
     ...
     * Gets bids
     *
     * @return \OpenAPI\Client\Model\AdvV0AuctionBidsPatchRequestBidsInner[]
     */
     ...
     * Sets bids
     *
     * @param \OpenAPI\Client\Model\AdvV0AuctionBidsPatchRequestBidsInner[] $bids Ставки в кампаниях
     *
     * @return self
     */
    public function setBids($bids)
    {
        ...
        if ((count($bids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $bids when calling AdvV0AuctionBidsPatchRequest., number of items must be less than or equal to 50.');
        }
