...
/**
 * AdvertSubcategory Class Doc Comment
 *
 * @category Class
 * @description Предмет
 * @package  Wildberries\Sdk\Promotion
 ...
 */
class AdvertSubcategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AdvertSubcategory';
