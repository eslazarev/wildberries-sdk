...
/**
 * AdvV0AuctionBidsPatchRequestBidsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0AuctionBidsPatchRequestBidsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_auction_bids_patch_request_bids_inner';
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'nm_bids' => '\OpenAPI\Client\Model\AdvV0AuctionBidsPatchRequestBidsInnerNmBidsInner[]'
    ];
    ...
    */
     ...
     * Gets nm_bids
     *
     * @return \OpenAPI\Client\Model\AdvV0AuctionBidsPatchRequestBidsInnerNmBidsInner[]
     */
     ...
     * Sets nm_bids
     *
     * @param \OpenAPI\Client\Model\AdvV0AuctionBidsPatchRequestBidsInnerNmBidsInner[] $nm_bids Ставки
     *
     * @return self
     */
    public function setNmBids($nm_bids)
    {
        ...
        if ((count($nm_bids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $nm_bids when calling AdvV0AuctionBidsPatchRequestBidsInner., number of items must be less than or equal to 50.');
        }
