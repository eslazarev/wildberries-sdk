...
/**
 * ResponseWithDateInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseWithDateInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseWithDate_inner';
    ...
    */
     ...
     * Sets dates
     *
     * @param \DateTime[]|null $dates Даты, за которые нужно получить информацию
     *
     * @return self
     */
     ...
     * Sets views
     *
     * @param int|null $views Количество просмотров. <br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
     ...
     * Sets clicks
     *
     * @param int|null $clicks Количество кликов.<br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
     ...
     * Sets ctr
     *
     * @param float|null $ctr Показатель кликабельности.<br> Отношение числа кликов к количеству показов. Выражается в процентах<br> За все дни, по всем артикулам WB и платформам<br>
     *
     * @return self
     */
     ...
     * Sets cpc
     *
     * @param float|null $cpc Средняя стоимость клика, ₽.<br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
     ...
     * Sets sum
     *
     * @param float|null $sum Затраты, ₽.<br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
     ...
     * Sets atbs
     *
     * @param int|null $atbs Количество добавлений товаров в корзину.<br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
     ...
     * Sets orders
     *
     * @param int|null $orders Количество заказов.<br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
     ...
     * Sets cr
     *
     * @param float|null $cr CR(conversion rate) — это отношение количества заказов к общему количеству посещений кампании.<br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
     ...
     * Sets shks
     *
     * @param int|null $shks Количество заказанных товаров, шт.<br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
     ...
     * Sets sum_price
     *
     * @param float|null $sum_price Заказов на сумму, ₽.<br> За все дни, по всем артикулам WB и платформам
     *
     * @return self
     */
