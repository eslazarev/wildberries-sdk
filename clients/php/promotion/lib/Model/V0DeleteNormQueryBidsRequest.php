...
/**
 * V0DeleteNormQueryBidsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V0DeleteNormQueryBidsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V0DeleteNormQueryBidsRequest';
    ...
    protected static $openAPITypes = [
        'bids' => '\Wildberries\Sdk\Promotion\Model\V0DeleteNormQueryBidsRequestItem[]'
    ];
     ...
     * Gets bids
     *
     * @return \Wildberries\Sdk\Promotion\Model\V0DeleteNormQueryBidsRequestItem[]
     */
     ...
     * Sets bids
     *
     * @param \Wildberries\Sdk\Promotion\Model\V0DeleteNormQueryBidsRequestItem[] $bids bids
     *
     * @return self
     */
    public function setBids($bids)
    {
        ...
        if ((count($bids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $bids when calling V0DeleteNormQueryBidsRequest., number of items must be less than or equal to 100.');
        }
