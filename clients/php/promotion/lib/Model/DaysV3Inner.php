...
class DaysV3Inner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'apps' => '\OpenAPI\Client\Model\DaysV3InnerAppsInner[]',
        'atbs' => 'int',
        'canceled' => 'int',
        'date' => '\DateTime',
        'clicks' => 'int',
    ...
    */
     ...
     * Gets apps
     *
     * @return \OpenAPI\Client\Model\DaysV3InnerAppsInner[]
     */
     ...
     * Sets apps
     *
     * @param \OpenAPI\Client\Model\DaysV3InnerAppsInner[] $apps Блок информации о платформе
     *
     * @return self
     */
