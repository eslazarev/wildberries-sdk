...
class V0BidRecommendationReachMin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $bid_kopecks_min Минимальная ставка в разменных единицах — 0,01 от базовой валюты [аккаунта продавца](https://cmp.wildberries.ru/campaigns/finances)
     *
     * @return self
     */
