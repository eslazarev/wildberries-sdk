...
/**
 * V2BudgetResponse Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V2BudgetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2BudgetResponse';
    ...
    protected static $openAPITypes = [
        'adverts' => '\Wildberries\Sdk\Promotion\Model\V1BudgetAdvert[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['adverts'] === null && !$this->isNullableSetToNull('adverts')) {
            $invalidProperties[] = "'adverts' is required";
        }
     ...
     * Gets adverts
     *
     * @return \Wildberries\Sdk\Promotion\Model\V1BudgetAdvert[]|null
     */
     ...
     * Sets adverts
     *
     * @param \Wildberries\Sdk\Promotion\Model\V1BudgetAdvert[]|null $adverts Данные по кампаниям
     *
     * @return self
     */
