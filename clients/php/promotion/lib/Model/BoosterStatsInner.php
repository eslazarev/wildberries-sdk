...
/**
 * BoosterStatsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BoosterStatsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BoosterStats_inner';
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date Дата, за которую предоставлены данные
     *
     * @return self
     */
     ...
     * Sets avg_position
     *
     * @param int|null $avg_position Средняя позиция товара на страницах поисковой выдачи и каталога
     *
     * @return self
     */
