...
class V0GetNormQueryMinusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\V0GetNormQueryMinusRequestItem[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\V0GetNormQueryMinusRequestItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\V0GetNormQueryMinusRequestItem[] $items items
     *
     * @return self
     */
