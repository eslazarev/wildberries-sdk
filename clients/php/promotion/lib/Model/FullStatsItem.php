...
class FullStatsItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'atbs' => 'int',
        'booster_stats' => '\OpenAPI\Client\Model\BoosterStatsV3Inner[]',
        'canceled' => 'int',
        'clicks' => 'int',
        'cpc' => 'float',
        'cr' => 'float',
        'ctr' => 'float',
        'days' => '\OpenAPI\Client\Model\DaysV3Inner[]',
        'orders' => 'int',
        'shks' => 'int',
        'sum' => 'float',
        'sum_price' => 'float',
    ...
    */
     ...
     * Gets booster_stats
     *
     * @return \OpenAPI\Client\Model\BoosterStatsV3Inner[]|null
     */
     ...
     * Sets booster_stats
     *
     * @param \OpenAPI\Client\Model\BoosterStatsV3Inner[]|null $booster_stats Статистика по средней позиции товара (для кампаний с единой ставкой)
     *
     * @return self
     */
     ...
     * Gets days
     *
     * @return \OpenAPI\Client\Model\DaysV3Inner[]
     */
     ...
     * Sets days
     *
     * @param \OpenAPI\Client\Model\DaysV3Inner[] $days Статистка по дням
     *
     * @return self
     */
