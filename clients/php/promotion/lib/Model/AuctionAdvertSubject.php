...
/**
 * AuctionAdvertSubject Class Doc Comment
 *
 * @category Class
 * @description Предмет
 * @package  OpenAPI\Client
 ...
 */
class AuctionAdvertSubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuctionAdvertSubject';
