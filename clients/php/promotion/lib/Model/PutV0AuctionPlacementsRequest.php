...
/**
 * PutV0AuctionPlacementsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class PutV0AuctionPlacementsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV0AuctionPlacements_request';
    ...
    protected static $openAPITypes = [
        'placements' => '\Wildberries\Sdk\Promotion\Model\PutV0AuctionPlacementsRequestPlacementsInner[]'
    ];
     ...
     * Gets placements
     *
     * @return \Wildberries\Sdk\Promotion\Model\PutV0AuctionPlacementsRequestPlacementsInner[]
     */
     ...
     * Sets placements
     *
     * @param \Wildberries\Sdk\Promotion\Model\PutV0AuctionPlacementsRequestPlacementsInner[] $placements Места размещения в кампаниях
     *
     * @return self
     */
    public function setPlacements($placements)
    {
        ...
        if ((count($placements) > 50)) {
            throw new \InvalidArgumentException('invalid value for $placements when calling PutV0AuctionPlacementsRequest., number of items must be less than or equal to 50.');
        }
