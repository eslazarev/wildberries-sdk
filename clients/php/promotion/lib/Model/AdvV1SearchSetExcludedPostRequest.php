...
/**
 * AdvV1SearchSetExcludedPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1SearchSetExcludedPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_search_set_excluded_post_request';
    ...
    */
     ...
     * Sets excluded
     *
     * @param string[]|null $excluded Список минус-фраз, до 1000 фраз
     *
     * @return self
     */
