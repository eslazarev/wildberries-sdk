...
/**
 * PatchV0AuctionNmsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class PatchV0AuctionNmsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'patchV0AuctionNms_request';
    ...
    protected static $openAPITypes = [
        'nms' => '\Wildberries\Sdk\Promotion\Model\PatchV0AuctionNmsRequestNmsInner[]'
    ];
     ...
     * Gets nms
     *
     * @return \Wildberries\Sdk\Promotion\Model\PatchV0AuctionNmsRequestNmsInner[]
     */
     ...
     * Sets nms
     *
     * @param \Wildberries\Sdk\Promotion\Model\PatchV0AuctionNmsRequestNmsInner[] $nms Карточки товаров в кампаниях
     *
     * @return self
     */
    public function setNms($nms)
    {
        ...
        if ((count($nms) > 20)) {
            throw new \InvalidArgumentException('invalid value for $nms when calling PatchV0AuctionNmsRequest., number of items must be less than or equal to 20.');
        }
