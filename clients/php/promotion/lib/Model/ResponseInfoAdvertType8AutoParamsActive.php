...
/**
 * ResponseInfoAdvertType8AutoParamsActive Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseInfoAdvertType8AutoParamsActive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseInfoAdvertType8_autoParams_active';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('recom', $data ?? [], null);
        $this->setIfExists('booster', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets carousel
     *
     * @param bool|null $carousel Карточка товара   - `false` — отключено   - `true` — включено
     *
     * @return self
     */
    ...
    {
        return $this->container['recom'];
    }

    /**
     * Sets recom
     *
     * @param bool|null $recom Рекомендации на главной   - `false` — отключено   - `true` — включено
     *
     * @return self
     */
    ...
    {
        if (is_null($recom)) {
            throw new \InvalidArgumentException('non-nullable recom cannot be null');
        }
        $this->container['recom'] = $recom;
    ...
    {
        return $this->container['booster'];
    }

    /**
     * Sets booster
     *
     * @param bool|null $booster Ручная ставка   - `false` — отключено   - `true` — включено
     *
     * @return self
     */
    ...
    {
        if (is_null($booster)) {
            throw new \InvalidArgumentException('non-nullable booster cannot be null');
        }
        $this->container['booster'] = $booster;
