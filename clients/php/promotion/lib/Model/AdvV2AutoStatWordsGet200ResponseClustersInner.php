...
/**
 * AdvV2AutoStatWordsGet200ResponseClustersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvV2AutoStatWordsGet200ResponseClustersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v2_auto_stat_words_get_200_response_clusters_inner';
    ...
    */
     ...
     * Sets cluster
     *
     * @param string|null $cluster Кластер — набор похожих ключевых фраз
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param int|null $count Сколько раз товары показывались по всем фразам из кластера
     *
     * @return self
     */
     ...
     * Sets keywords
     *
     * @param string[]|null $keywords Ключевые фразы из кластера, по которым товары показывались хотя бы один раз
     *
     * @return self
     */
