 ...
 */
class AdvV2AutoStatWordsGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v2_auto_stat_words_get_200_response';
    ...
    protected static $openAPITypes = [
        'excluded' => 'string[]',
        'clusters' => '\OpenAPI\Client\Model\AdvV2AutoStatWordsGet200ResponseClustersInner[]'
    ];
    ...
    */
     ...
     * Sets excluded
     *
     * @param string[]|null $excluded Исключения (минус-фразы) для товаров из кампании. Можно задать помощью метода [установка/удаление минус-фраз](./ru/openapi/promotion#tag/Parametry-kampanij/paths/~1adv~1v1~1search~1set-phrase/post) или в настройках кампании в личном кабинете
     *
     * @return self
     */
     ...
     * Gets clusters
     *
     * @return \OpenAPI\Client\Model\AdvV2AutoStatWordsGet200ResponseClustersInner[]|null
     */
     ...
     * Sets clusters
     *
     * @param \OpenAPI\Client\Model\AdvV2AutoStatWordsGet200ResponseClustersInner[]|null $clusters Кластеры ключевых фраз
     *
     * @return self
     */
