...
/**
 * V0GetConfigCategoriesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V0GetConfigCategoriesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V0GetConfigCategoriesResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cpm_min', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cpm_min'] === null) {
            $invalidProperties[] = "'cpm_min' can't be null";
        }
     ...
     * Sets id
     *
     * @param int $id ID категории товара
     *
     * @return self
     */
    ...
    {
        return $this->container['cpm_min'];
    }

    /**
     * Sets cpm_min
     *
     * @param int $cpm_min Минимально допустимая ставка
     *
     * @return self
     */
    public function setCpmMin($cpm_min)
    {
        if (is_null($cpm_min)) {
            throw new \InvalidArgumentException('non-nullable cpm_min cannot be null');
        }
        $this->container['cpm_min'] = $cpm_min;
