...
/**
 * V0KeywordsStatistic Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V0KeywordsStatistic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V0KeywordsStatistic';
    ...
    */
     ...
     * Sets ctr
     *
     * @param float $ctr CTR (Click-Through Rate) — показатель кликабельности
     *
     * @return self
     */
     ...
     * Sets keyword
     *
     * @param string $keyword Ключевая фраза
     *
     * @return self
     */
     ...
     * Sets sum
     *
     * @param float $sum Сумма затрат по ключевой фразе
     *
     * @return self
     */
     ...
     * Sets views
     *
     * @param int $views Количество показов
     *
     * @return self
     */
