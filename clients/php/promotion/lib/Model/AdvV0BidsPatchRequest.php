 ...
 */
class AdvV0BidsPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_bids_patch_request';
    ...
    protected static $openAPITypes = [
        'bids' => '\OpenAPI\Client\Model\V0AdvertMultibid[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['bids']) > 20)) {
            $invalidProperties[] = "invalid value for 'bids', number of items must be less than or equal to 20.";
        }
     ...
     * Gets bids
     *
     * @return \OpenAPI\Client\Model\V0AdvertMultibid[]
     */
     ...
     * Sets bids
     *
     * @param \OpenAPI\Client\Model\V0AdvertMultibid[] $bids bids
     *
     * @return self
     */
    public function setBids($bids)
    {
        ...
        if ((count($bids) > 20)) {
            throw new \InvalidArgumentException('invalid value for $bids when calling AdvV0BidsPatchRequest., number of items must be less than or equal to 20.');
        }
