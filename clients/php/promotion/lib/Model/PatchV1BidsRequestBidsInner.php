...
/**
 * PatchV1BidsRequestBidsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class PatchV1BidsRequestBidsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'patchV1Bids_request_bids_inner';
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'nm_bids' => '\Wildberries\Sdk\Promotion\Model\PatchV1BidsRequestBidsInnerNmBidsInner[]'
    ];
     ...
     * Gets nm_bids
     *
     * @return \Wildberries\Sdk\Promotion\Model\PatchV1BidsRequestBidsInnerNmBidsInner[]
     */
     ...
     * Sets nm_bids
     *
     * @param \Wildberries\Sdk\Promotion\Model\PatchV1BidsRequestBidsInnerNmBidsInner[] $nm_bids Ставки
     *
     * @return self
     */
    public function setNmBids($nm_bids)
    {
        ...
        if ((count($nm_bids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $nm_bids when calling PatchV1BidsRequestBidsInner., number of items must be less than or equal to 50.');
        }
