    ...
    public function advV0AuctionNmsPatchRequest($adv_v0_auction_nms_patch_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['advV0AuctionNmsPatch'][0])
    {
        ...
        if (isset($adv_v0_auction_nms_patch_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($adv_v0_auction_nms_patch_request), JSON_THROW_ON_ERROR);
    ...
    public function advV0AuctionPlacementsPutRequest($adv_v0_auction_placements_put_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['advV0AuctionPlacementsPut'][0])
    {
        ...
        if (isset($adv_v0_auction_placements_put_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($adv_v0_auction_placements_put_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function advV0RenamePostRequest($adv_v0_rename_post_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['advV0RenamePost'][0])
    {
        ...
        if (isset($adv_v0_rename_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($adv_v0_rename_post_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function advV1BudgetDepositPostRequest($id, $adv_v1_budget_deposit_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['advV1BudgetDepositPost'][0])
    {
        ...
        if (isset($adv_v1_budget_deposit_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($adv_v1_budget_deposit_post_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function advV1StatsPostRequest($adv_v1_stats_post_request_inner, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['advV1StatsPost'][0])
    {
        ...
        if (isset($adv_v1_stats_post_request_inner)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($adv_v1_stats_post_request_inner), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function advV2SeacatSaveAdPostRequest($adv_v2_seacat_save_ad_post_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['advV2SeacatSaveAdPost'][0])
    {
        ...
        if (isset($adv_v2_seacat_save_ad_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($adv_v2_seacat_save_ad_post_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function apiAdvertV1BidsMinPostRequest($api_advert_v1_bids_min_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiAdvertV1BidsMinPost'][0])
    {
        ...
        if (isset($api_advert_v1_bids_min_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($api_advert_v1_bids_min_post_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function apiAdvertV1BidsPatchRequest($api_advert_v1_bids_patch_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiAdvertV1BidsPatch'][0])
    {
        ...
        if (isset($api_advert_v1_bids_patch_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($api_advert_v1_bids_patch_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function apiV1CalendarPromotionsUploadPostRequest($api_v1_calendar_promotions_upload_post_request, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiV1CalendarPromotionsUploadPost'][0])
    {
        ...
        if (isset($api_v1_calendar_promotions_upload_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($api_v1_calendar_promotions_upload_post_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
