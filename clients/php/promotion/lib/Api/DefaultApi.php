...
class DefaultApi
{
    ...
    public const contentTypes = [
        ...
        'apiAdvertV0BidsRecommendationsGet' => [
            'application/json',
        ],
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    /**
     * Operation apiAdvertV0BidsRecommendationsGet
     *
     ...
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiAdvertV0BidsRecommendationsGet'] to see the possible values for this operation
     *
     * @throws \Wildberries\Sdk\Promotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Promotion\Model\V0BidsRecommendationsResponse|string|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response
     */
    public function apiAdvertV0BidsRecommendationsGet($nm_id, $advert_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiAdvertV0BidsRecommendationsGet'][0])
    {
        list($response) = $this->apiAdvertV0BidsRecommendationsGetWithHttpInfo($nm_id, $advert_id, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation apiAdvertV0BidsRecommendationsGetWithHttpInfo
     *
     * Рекомендуемые ставки для карточек товаров и поисковых кластеров
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @throws \Wildberries\Sdk\Promotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Promotion\Model\V0BidsRecommendationsResponse|string|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiAdvertV0BidsRecommendationsGetWithHttpInfo($nm_id, $advert_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiAdvertV0BidsRecommendationsGet'][0])
    {
        $request = $this->apiAdvertV0BidsRecommendationsGetRequest($nm_id, $advert_id, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Promotion\Model\V0BidsRecommendationsResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation apiAdvertV0BidsRecommendationsGetAsync
     *
     * Рекомендуемые ставки для карточек товаров и поисковых кластеров
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiAdvertV0BidsRecommendationsGetAsync($nm_id, $advert_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiAdvertV0BidsRecommendationsGet'][0])
    {
        return $this->apiAdvertV0BidsRecommendationsGetAsyncWithHttpInfo($nm_id, $advert_id, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiAdvertV0BidsRecommendationsGetAsyncWithHttpInfo
     *
     * Рекомендуемые ставки для карточек товаров и поисковых кластеров
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiAdvertV0BidsRecommendationsGetAsyncWithHttpInfo($nm_id, $advert_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiAdvertV0BidsRecommendationsGet'][0])
    {
        $returnType = '\Wildberries\Sdk\Promotion\Model\V0BidsRecommendationsResponse';
        $request = $this->apiAdvertV0BidsRecommendationsGetRequest($nm_id, $advert_id, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'apiAdvertV0BidsRecommendationsGet'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://advert-api.wildberries.ru
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiAdvertV0BidsRecommendationsGetRequest($nm_id, $advert_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['apiAdvertV0BidsRecommendationsGet'][0])
    {

        // verify the required parameter 'nm_id' is set
        if ($nm_id === null || (is_array($nm_id) && count($nm_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $nm_id when calling apiAdvertV0BidsRecommendationsGet'
            );
        }
        ...
        if ($advert_id === null || (is_array($advert_id) && count($advert_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $advert_id when calling apiAdvertV0BidsRecommendationsGet'
            );
        }
        ...
        $hostSettings = $this->getHostSettingsForapiAdvertV0BidsRecommendationsGet();
    ...
    /**
     * Returns an array of host settings for Operation apiAdvertV0BidsRecommendationsGet
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForapiAdvertV0BidsRecommendationsGet(): array
    {
        return [
            [
                "url" => "https://advert-api.wildberries.ru",
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    /**
     * Operation postV1RecommendationsList
     *
     ...
     *
     * @param  \Wildberries\Sdk\Promotion\Model\GetRecomReq|null $get_recom_req get_recom_req (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postV1RecommendationsList'] to see the possible values for this operation
     *
     * @throws \Wildberries\Sdk\Promotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Promotion\Model\GetRecomRes|\Wildberries\Sdk\Promotion\Model\Response400GetRecom|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response
     */
    ...
    {
        list($response) = $this->postV1RecommendationsListWithHttpInfo($get_recom_req, $hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Promotion\Model\GetRecomReq|null $get_recom_req (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postV1RecommendationsList'] to see the possible values for this operation
     *
     * @throws \Wildberries\Sdk\Promotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Promotion\Model\GetRecomRes|\Wildberries\Sdk\Promotion\Model\Response400GetRecom|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->postV1RecommendationsListRequest($get_recom_req, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Promotion\Model\GetRecomRes',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Promotion\Model\Response400GetRecom',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation postV1RecommendationsListAsync
     *
     * Список рекомендаций в карточках товаров
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postV1RecommendationsListAsync($get_recom_req = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1RecommendationsList'][0])
    {
        return $this->postV1RecommendationsListAsyncWithHttpInfo($get_recom_req, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postV1RecommendationsListAsyncWithHttpInfo($get_recom_req = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1RecommendationsList'][0])
    {
        $returnType = '\Wildberries\Sdk\Promotion\Model\GetRecomRes';
        $request = $this->postV1RecommendationsListRequest($get_recom_req, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'postV1RecommendationsList'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://content-api.wildberries.ru
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postV1RecommendationsListRequest($get_recom_req = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1RecommendationsList'][0])
    {



        $resourcePath = '/api/content/v1/recommendations/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($get_recom_req)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($get_recom_req));
            } else {
                $httpBody = $get_recom_req;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
        ...
        $hostSettings = $this->getHostSettingsForpostV1RecommendationsList();
    ...
    /**
     * Returns an array of host settings for Operation postV1RecommendationsList
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForpostV1RecommendationsList(): array
    {
        return [
            [
                "url" => "https://content-api.wildberries.ru",
    ...
    /**
     * Operation postV1RecommendationsSet
     *
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Promotion\Model\SetRecomReq $set_recom_req set_recom_req (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postV1RecommendationsSet'] to see the possible values for this operation
     *
     * @throws \Wildberries\Sdk\Promotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Promotion\Model\SetRecomRes|\Wildberries\Sdk\Promotion\Model\Response208SetRecom|\Wildberries\Sdk\Promotion\Model\Response400SetRecom|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response
     */
    ...
    {
        list($response) = $this->postV1RecommendationsSetWithHttpInfo($set_recom_req, $hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     * URL: https://content-api.wildberries.ru
     *
     * @param  \Wildberries\Sdk\Promotion\Model\SetRecomReq $set_recom_req (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postV1RecommendationsSet'] to see the possible values for this operation
     *
     * @throws \Wildberries\Sdk\Promotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Promotion\Model\SetRecomRes|\Wildberries\Sdk\Promotion\Model\Response208SetRecom|\Wildberries\Sdk\Promotion\Model\Response400SetRecom|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response|\Wildberries\Sdk\Promotion\Model\AdvV1PromotionCountGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->postV1RecommendationsSetRequest($set_recom_req, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Promotion\Model\SetRecomRes',
                        $request,
                        $response,
                    );
                case 208:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Promotion\Model\Response208SetRecom',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Wildberries\Sdk\Promotion\Model\Response400SetRecom',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation postV1RecommendationsSetAsync
     *
     * Установить рекомендации для товаров
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postV1RecommendationsSetAsync($set_recom_req, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1RecommendationsSet'][0])
    {
        return $this->postV1RecommendationsSetAsyncWithHttpInfo($set_recom_req, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postV1RecommendationsSetAsyncWithHttpInfo($set_recom_req, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1RecommendationsSet'][0])
    {
        $returnType = '\Wildberries\Sdk\Promotion\Model\SetRecomRes';
        $request = $this->postV1RecommendationsSetRequest($set_recom_req, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'postV1RecommendationsSet'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://content-api.wildberries.ru
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postV1RecommendationsSetRequest($set_recom_req, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1RecommendationsSet'][0])
    {

        // verify the required parameter 'set_recom_req' is set
        if ($set_recom_req === null || (is_array($set_recom_req) && count($set_recom_req) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $set_recom_req when calling postV1RecommendationsSet'
            );
        }


        $resourcePath = '/api/content/v1/recommendations/set';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($set_recom_req)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($set_recom_req));
            } else {
                $httpBody = $set_recom_req;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
        ...
        $hostSettings = $this->getHostSettingsForpostV1RecommendationsSet();
    ...
    /**
     * Returns an array of host settings for Operation postV1RecommendationsSet
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForpostV1RecommendationsSet(): array
    {
        return [
            [
                "url" => "https://content-api.wildberries.ru",
