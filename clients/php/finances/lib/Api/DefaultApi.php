...
class DefaultApi
{
    ...
    public const contentTypes = [
        ...
        'getV5SupplierReportDetailByPeriod' => [
            'application/json',
        ],
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    /**
     * Operation getV5SupplierReportDetailByPeriod
     *
     ...
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getV5SupplierReportDetailByPeriod'] to see the possible values for this operation
     *
     * @throws \Wildberries\Sdk\Finances\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Wildberries\Sdk\Finances\Model\DetailReportItem[]|\Wildberries\Sdk\Finances\Model\PostV1SalesReportsList400Response|\Wildberries\Sdk\Finances\Model\GetV1AccountBalance401Response|\Wildberries\Sdk\Finances\Model\GetV1AccountBalance402Response|\Wildberries\Sdk\Finances\Model\GetV1AccountBalance401Response
     * @deprecated
     */
    public function getV5SupplierReportDetailByPeriod($date_from, $date_to, $limit = 100000, $rrdid = 0, $period = 'weekly', ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getV5SupplierReportDetailByPeriod'][0])
    {
        list($response) = $this->getV5SupplierReportDetailByPeriodWithHttpInfo($date_from, $date_to, $limit, $rrdid, $period, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation getV5SupplierReportDetailByPeriodWithHttpInfo
     *
     * Отчёт о продажах по реализации
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @throws \Wildberries\Sdk\Finances\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Wildberries\Sdk\Finances\Model\DetailReportItem[]|\Wildberries\Sdk\Finances\Model\PostV1SalesReportsList400Response|\Wildberries\Sdk\Finances\Model\GetV1AccountBalance401Response|\Wildberries\Sdk\Finances\Model\GetV1AccountBalance402Response|\Wildberries\Sdk\Finances\Model\GetV1AccountBalance401Response, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getV5SupplierReportDetailByPeriodWithHttpInfo($date_from, $date_to, $limit = 100000, $rrdid = 0, $period = 'weekly', ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getV5SupplierReportDetailByPeriod'][0])
    {
        $request = $this->getV5SupplierReportDetailByPeriodRequest($date_from, $date_to, $limit, $rrdid, $period, $hostIndex, $variables, $contentType);
    ...
    /**
     * Operation getV5SupplierReportDetailByPeriodAsync
     *
     * Отчёт о продажах по реализации
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @deprecated
     */
    public function getV5SupplierReportDetailByPeriodAsync($date_from, $date_to, $limit = 100000, $rrdid = 0, $period = 'weekly', ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getV5SupplierReportDetailByPeriod'][0])
    {
        return $this->getV5SupplierReportDetailByPeriodAsyncWithHttpInfo($date_from, $date_to, $limit, $rrdid, $period, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getV5SupplierReportDetailByPeriodAsyncWithHttpInfo
     *
     * Отчёт о продажах по реализации
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @deprecated
     */
    public function getV5SupplierReportDetailByPeriodAsyncWithHttpInfo($date_from, $date_to, $limit = 100000, $rrdid = 0, $period = 'weekly', ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getV5SupplierReportDetailByPeriod'][0])
    {
    ...
    /**
     * Create request for operation 'getV5SupplierReportDetailByPeriod'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://statistics-api.wildberries.ru
     ...
     * @deprecated
     */
    public function getV5SupplierReportDetailByPeriodRequest($date_from, $date_to, $limit = 100000, $rrdid = 0, $period = 'weekly', ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getV5SupplierReportDetailByPeriod'][0])
    {

        // verify the required parameter 'date_from' is set
        if ($date_from === null || (is_array($date_from) && count($date_from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $date_from when calling getV5SupplierReportDetailByPeriod'
            );
        }
        ...
        if ($date_to === null || (is_array($date_to) && count($date_to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $date_to when calling getV5SupplierReportDetailByPeriod'
            );
        }

        if ($limit !== null && $limit > 100000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DefaultApi.getV5SupplierReportDetailByPeriod, must be smaller than or equal to 100000.');
        }
        ...
        $hostSettings = $this->getHostSettingsForgetV5SupplierReportDetailByPeriod();
    ...
    /**
     * Returns an array of host settings for Operation getV5SupplierReportDetailByPeriod
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForgetV5SupplierReportDetailByPeriod(): array
    {
        return [
            [
                "url" => "https://statistics-api.wildberries.ru",
