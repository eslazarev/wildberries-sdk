...
class GetCategoriesDataCategoriesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string|null $name ID категории документа из параметра [запроса](./financial-reports-and-accounting#tag/documents/operation/getV1DocumentsList) `category`
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Название категории документа из поля [ответа](./financial-reports-and-accounting#tag/documents/~1api~1v1~1documents~1list/get) `category`
     *
     * @return self
     */
