...
class GetListDataDocumentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets category
     *
     * @param string|null $category Название [категории документов](./documents-and-accounting#tag/documents/operation/getV1DocumentsCategories) из поля ответа `title`
     *
     * @return self
     */
