...
namespace Wildberries\Sdk\Finances;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (Wildberries\Sdk\Finances) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: finances' . PHP_EOL;
