...
/**
 * ItemOrdersRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 ...
 */
class ItemOrdersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ItemOrdersRequest';
    ...
    public function setSearchTexts($search_texts)
    {
        ...
        if ((count($search_texts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $search_texts when calling ItemOrdersRequest., number of items must be greater than or equal to 1.');
        }
