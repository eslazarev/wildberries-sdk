...
/**
 * DistributionTableItemV1FeedbackRating Class Doc Comment
 *
 * @category Class
 * @description Рейтинг товара по отзывам
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DistributionTableItemV1FeedbackRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DistributionTableItemV1_feedbackRating';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['percentile'] === null && !$this->isNullableSetToNull('percentile')) {
            $invalidProperties[] = "'percentile' is required";
        }
