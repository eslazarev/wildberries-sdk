...
/**
 * DistributionTableIndicatorsThreeStar Class Doc Comment
 *
 * @category Class
 * @description Отзывы 3 звезды
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DistributionTableIndicatorsThreeStar implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DistributionTableIndicators_threeStar';
