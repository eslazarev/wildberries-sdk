...
/**
 * DistributionTableIndicatorsTwoStar Class Doc Comment
 *
 * @category Class
 * @description Отзывы 2 звезды
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DistributionTableIndicatorsTwoStar implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DistributionTableIndicators_twoStar';
