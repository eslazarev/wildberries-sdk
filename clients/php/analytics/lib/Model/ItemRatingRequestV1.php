...
/**
 * ItemRatingRequestV1 Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemRatingRequestV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ItemRatingRequestV1';
    ...
    public function setNmIds($nm_ids)
    {
        ...
        if ((count($nm_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $nm_ids when calling ItemRatingRequestV1., number of items must be less than or equal to 50.');
        }
    ...
    public function setSubjectIds($subject_ids)
    {
        ...
        if ((count($subject_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $subject_ids when calling ItemRatingRequestV1., number of items must be less than or equal to 50.');
        }
    ...
    public function setBrandNames($brand_names)
    {
        ...
        if ((count($brand_names) > 50)) {
            throw new \InvalidArgumentException('invalid value for $brand_names when calling ItemRatingRequestV1., number of items must be less than or equal to 50.');
        }
    ...
    public function setTagIds($tag_ids)
    {
        ...
        if ((count($tag_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $tag_ids when calling ItemRatingRequestV1., number of items must be less than or equal to 50.');
        }
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 1000)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling ItemRatingRequestV1., must be smaller than or equal to 1000.');
        }
