...
class ItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'past_period' => '\Wildberries\Sdk\Analytics\Model\ItemsRequestSelectedPeriod',
        'nm_ids' => 'int[]',
        'brand_names' => 'string[]',
        'subject_ids' => 'int[]',
        'tag_ids' => 'int[]',
     ...
     * Gets past_period
     *
     * @return \Wildberries\Sdk\Analytics\Model\ItemsRequestSelectedPeriod|null
     */
     ...
     * Sets past_period
     *
     * @param \Wildberries\Sdk\Analytics\Model\ItemsRequestSelectedPeriod|null $past_period past_period
     *
     * @return self
     */
    ...
    public function setNmIds($nm_ids)
    {
        ...
        if ((count($nm_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nm_ids when calling ItemsRequest., number of items must be greater than or equal to 0.');
        }
