...
class ProductSearchTextsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\TableSearchTextItem[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\TableSearchTextItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\TableSearchTextItem[] $items Элементы таблицы
     *
     * @return self
     */
