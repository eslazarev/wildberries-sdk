...
/**
 * ItemHistoryRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 ...
 */
class ItemHistoryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ItemHistoryRequest';
    ...
    public function setNmIds($nm_ids)
    {
        ...
        if ((count($nm_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nm_ids when calling ItemHistoryRequest., number of items must be greater than or equal to 1.');
        }
