...
/**
 * SalesFunnelItemReqParams Class Doc Comment
 *
 * @category Class
 ...
 */
class SalesFunnelItemReqParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SalesFunnelItemReq_params';
    ...
    public function setNmIds($nm_ids)
    {
        ...
        if ((count($nm_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $nm_ids when calling SalesFunnelItemReqParams., number of items must be less than or equal to 1000.');
        }
        if ((count($nm_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nm_ids when calling SalesFunnelItemReqParams., number of items must be greater than or equal to 0.');
        }
