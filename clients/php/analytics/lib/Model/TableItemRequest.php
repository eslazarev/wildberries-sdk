...
/**
 * TableItemRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TableItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableItemRequest';
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 1000)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling TableItemRequest., must be smaller than or equal to 1000.');
        }
