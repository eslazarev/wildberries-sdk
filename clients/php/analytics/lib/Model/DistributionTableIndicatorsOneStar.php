...
/**
 * DistributionTableIndicatorsOneStar Class Doc Comment
 *
 * @category Class
 * @description Отзывы 1 звезда
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DistributionTableIndicatorsOneStar implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DistributionTableIndicators_oneStar';
