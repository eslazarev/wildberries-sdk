...
class ProductOrdersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total' => '\OpenAPI\Client\Model\ProductOrdersMetrics[]',
        'items' => '\OpenAPI\Client\Model\ProductOrdersTextItem[]'
    ];
    ...
    */
     ...
     * Sets total
     *
     * @param \OpenAPI\Client\Model\ProductOrdersMetrics[] $total Итог по товарам
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\ProductOrdersTextItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ProductOrdersTextItem[] $items Элементы таблицы
     *
     * @return self
     */
