...
/**
 * OrderByItemRating Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderByItemRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrderByItemRating';
    ...
    public const FIELD_FEEDBACK_RATING = 'feedbackRating';
    public const FIELD_FEEDBACK_COUNT = 'feedbackCount';
    public const FIELD_FIVE_STAR = 'fiveStar';
    public const FIELD_FOUR_STAR = 'fourStar';
    public const FIELD_THREE_STAR = 'threeStar';
    public const FIELD_TWO_STAR = 'twoStar';
    public const FIELD_ONE_STAR = 'oneStar';
    public const FIELD_DISQUALIFIED = 'disqualified';
    ...
    {
        return [
            self::FIELD_FEEDBACK_RATING,
            self::FIELD_FEEDBACK_COUNT,
            self::FIELD_FIVE_STAR,
            self::FIELD_FOUR_STAR,
            self::FIELD_THREE_STAR,
            self::FIELD_TWO_STAR,
            self::FIELD_ONE_STAR,
            self::FIELD_DISQUALIFIED,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Поле для сортировки:   - `feedbackRating` — Рейтинг товара по отзывам   - `feedbackCount` — Все отзывы за период   - `fiveStar` — Отзывы 5 звёзд   - `fourStar` — Отзывы 4 звезды   - `threeStar` — Отзывы 3 звезды   - `twoStar` — Отзывы 2 звезды   - `oneStar` — Отзывы 1 звезда   - `disqualified` — Отзывы, исключённые из рейтинга
     *
     * @return self
     */
