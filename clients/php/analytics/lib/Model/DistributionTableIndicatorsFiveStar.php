...
/**
 * DistributionTableIndicatorsFiveStar Class Doc Comment
 *
 * @category Class
 * @description Отзывы 5 звёзд
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DistributionTableIndicatorsFiveStar implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DistributionTableIndicators_fiveStar';
