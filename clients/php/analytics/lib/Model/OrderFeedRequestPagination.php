...
/**
 * OrderFeedRequestPagination Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderFeedRequestPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrderFeedRequest_pagination';
     ...
     * Sets limit
     *
     * @param int|null $limit Количество заказов в ответе
     *
     * @return self
     */
    public function setLimit($limit)
    {
        ...
        if (($limit > 10000)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling OrderFeedRequestPagination., must be smaller than or equal to 10000.');
        }
