...
/**
 * OrderFeedRequestSelectedPeriod Class Doc Comment
 *
 * @category Class
 * @description Запрашиваемый период. По дате текущего статуса заказа
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderFeedRequestSelectedPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrderFeedRequest_selectedPeriod';
