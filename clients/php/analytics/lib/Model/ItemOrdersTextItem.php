...
/**
 * ItemOrdersTextItem Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 ...
 */
class ItemOrdersTextItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ItemOrdersTextItem';
    ...
    protected static $openAPITypes = [
        'text' => 'string',
        'frequency' => 'int',
        'date_items' => '\Wildberries\Sdk\Analytics\Model\ItemOrdersMetrics[]'
    ];
     ...
     * Gets date_items
     *
     * @return \Wildberries\Sdk\Analytics\Model\ItemOrdersMetrics[]
     */
     ...
     * Sets date_items
     *
     * @param \Wildberries\Sdk\Analytics\Model\ItemOrdersMetrics[] $date_items Статистика по датам
     *
     * @return self
     */
