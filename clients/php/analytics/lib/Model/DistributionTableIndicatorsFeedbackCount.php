...
/**
 * DistributionTableIndicatorsFeedbackCount Class Doc Comment
 *
 * @category Class
 * @description Все отзывы за период
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DistributionTableIndicatorsFeedbackCount implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DistributionTableIndicators_feedbackCount';
