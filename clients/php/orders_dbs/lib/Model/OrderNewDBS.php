...
class OrderNewDBS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\OpenAPI\Client\Model\OrderNewDBSAddress',
        'order_uid' => 'string',
        'group_id' => 'string',
        'article' => 'string',
        'color_code' => 'string',
    ...
    */
     ...
     * Sets required_meta
     *
     * @param string[]|null $required_meta Список метаданных, доступных для сборочного задания. [Указывать IMEI](./orders-dbs#tag/Metadannye-DBS/paths/~1api~1v3~1dbs~1orders~1%7BorderId%7D~1meta~1imei/put) обязательно для [предмета](./work-with-products/#tag/Kategorii-predmety-i-harakteristiki/paths/~1content~1v2~1object~1all/get) `Смартфоны`, `\"subjectId\":515`
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\OrderNewDBSAddress|null
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\OrderNewDBSAddress|null $address address
     *
     * @return self
     */
