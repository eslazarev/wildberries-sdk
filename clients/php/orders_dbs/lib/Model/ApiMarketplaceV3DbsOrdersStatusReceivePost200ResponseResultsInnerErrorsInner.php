...
class ApiMarketplaceV3DbsOrdersStatusReceivePost200ResponseResultsInnerErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets detail
     *
     * @param string|null $detail - `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `SGTINIsNotFilled` — обязательный [код маркировки](./orders-dbs#tag/dbsLabelIdentifiers/paths/~1api~1marketplace~1v3~1dbs~1orders~1meta~1sgtin/post) не указан
     *
     * @return self
     */
