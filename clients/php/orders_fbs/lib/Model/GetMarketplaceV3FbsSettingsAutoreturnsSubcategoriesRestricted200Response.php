...
/**
 * GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted_200_response';
    ...
    protected static $openAPITypes = [
        'next' => 'int',
        'data' => '\Wildberries\Sdk\OrdersFbs\Model\GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner[]'
    ];
     ...
     * Gets data
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner[]
     */
     ...
     * Sets data
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner[] $data Список ID предметов, товары которых не хранятся на складах WB
     *
     * @return self
     */
