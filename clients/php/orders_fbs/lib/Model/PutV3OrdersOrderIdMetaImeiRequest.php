...
/**
 * PutV3OrdersOrderIdMetaImeiRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PutV3OrdersOrderIdMetaImeiRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3OrdersOrderIdMetaImei_request';
    ...
    public function setImei($imei)
    {
        ...
        if ((mb_strlen($imei) > 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling PutV3OrdersOrderIdMetaImeiRequest., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($imei) < 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling PutV3OrdersOrderIdMetaImeiRequest., must be bigger than or equal to 15.');
        }
