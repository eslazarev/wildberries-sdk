...
/**
 * PatchV3SuppliesSupplyIdOrdersRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PatchV3SuppliesSupplyIdOrdersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'patchV3SuppliesSupplyIdOrders_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 100)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling PatchV3SuppliesSupplyIdOrdersRequest., number of items must be less than or equal to 100.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling PatchV3SuppliesSupplyIdOrdersRequest., number of items must be greater than or equal to 1.');
        }
