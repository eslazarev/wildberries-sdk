...
/**
 * PutV3OrdersOrderIdMetaCustomsDeclarationRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PutV3OrdersOrderIdMetaCustomsDeclarationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3OrdersOrderIdMetaCustomsDeclaration_request';
    ...
    public function setCustomsDeclaration($customs_declaration)
    {
        ...
        if ((mb_strlen($customs_declaration) > 29)) {
            throw new \InvalidArgumentException('invalid length for $customs_declaration when calling PutV3OrdersOrderIdMetaCustomsDeclarationRequest., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($customs_declaration) < 17)) {
            throw new \InvalidArgumentException('invalid length for $customs_declaration when calling PutV3OrdersOrderIdMetaCustomsDeclarationRequest., must be bigger than or equal to 17.');
        }
