...
/**
 * PutV3PassesPassIdRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PutV3PassesPassIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3PassesPassId_request';
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling PutV3PassesPassIdRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) < 6)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling PutV3PassesPassIdRequest., must be bigger than or equal to 6.');
        }
    ...
    public function setCarModel($car_model)
    {
        ...
        if ((mb_strlen($car_model) > 100)) {
            throw new \InvalidArgumentException('invalid length for $car_model when calling PutV3PassesPassIdRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($car_model) < 1)) {
            throw new \InvalidArgumentException('invalid length for $car_model when calling PutV3PassesPassIdRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCarNumber($car_number)
    {
        ...
        if ((mb_strlen($car_number) > 9)) {
            throw new \InvalidArgumentException('invalid length for $car_number when calling PutV3PassesPassIdRequest., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($car_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $car_number when calling PutV3PassesPassIdRequest., must be bigger than or equal to 6.');
        }
    ...
    public function setOfficeId($office_id)
    {
        ...
        if (($office_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $office_id when calling PutV3PassesPassIdRequest., must be bigger than or equal to 1.');
        }
