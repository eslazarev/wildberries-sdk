...
/**
 * PutV3OrdersOrderIdMetaUinRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PutV3OrdersOrderIdMetaUinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3OrdersOrderIdMetaUin_request';
    ...
    public function setUin($uin)
    {
        ...
        if ((mb_strlen($uin) > 16)) {
            throw new \InvalidArgumentException('invalid length for $uin when calling PutV3OrdersOrderIdMetaUinRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($uin) < 16)) {
            throw new \InvalidArgumentException('invalid length for $uin when calling PutV3OrdersOrderIdMetaUinRequest., must be bigger than or equal to 16.');
        }
