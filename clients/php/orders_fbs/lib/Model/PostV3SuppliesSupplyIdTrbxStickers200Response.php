...
/**
 * PostV3SuppliesSupplyIdTrbxStickers200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3SuppliesSupplyIdTrbxStickers200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3SuppliesSupplyIdTrbxStickers_200_response';
    ...
    public function setStickers($stickers)
    {
        ...
        if ((count($stickers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stickers when calling PostV3SuppliesSupplyIdTrbxStickers200Response., number of items must be greater than or equal to 1.');
        }
