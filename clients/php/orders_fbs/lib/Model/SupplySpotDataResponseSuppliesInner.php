...
/**
 * SupplySpotDataResponseSuppliesInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class SupplySpotDataResponseSuppliesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SupplySpotDataResponse_supplies_inner';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'spot' => '\Wildberries\Sdk\OrdersFbs\Model\SupplySpotData',
        'error' => '\Wildberries\Sdk\OrdersFbs\Model\ApiErrorV3'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('spot', $data ?? [], null);
     ...
     * Gets spot
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\SupplySpotData|null
     */
     ...
     * Sets spot
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\SupplySpotData|null $spot Данные СПОТ
     *
     * @return self
     */
    ...
    {
        if (is_null($spot)) {
            throw new \InvalidArgumentException('non-nullable spot cannot be null');
        }
     ...
     * Gets error
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\ApiErrorV3|null
     */
     ...
     * Sets error
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\ApiErrorV3|null $error error
     *
     * @return self
     */
