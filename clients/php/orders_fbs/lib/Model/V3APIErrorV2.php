...
/**
 * V3APIErrorV2 Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class V3APIErrorV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'v3.APIErrorV2';
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'detail' => 'string',
        'errors' => '\Wildberries\Sdk\OrdersFbs\Model\V3APIErrorV2ErrorsInner[]',
        'origin' => 'string',
        'request_id' => 'string',
        'status' => 'int',
        'title' => 'string'
     ...
     * Gets errors
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\V3APIErrorV2ErrorsInner[]|null
     */
