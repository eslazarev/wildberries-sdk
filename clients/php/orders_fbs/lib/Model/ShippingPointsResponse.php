...
/**
 * ShippingPointsResponse Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ShippingPointsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ShippingPointsResponse';
    ...
    protected static $openAPITypes = [
        'shipping_points' => '\Wildberries\Sdk\OrdersFbs\Model\ShippingPoint[]'
    ];
    ...
    protected static $setters = [
        'shipping_points' => 'setShippingPoints'
    ];
    ...
    protected static $getters = [
        'shipping_points' => 'getShippingPoints'
    ];
    ...
    {
        $this->setIfExists('shipping_points', $data ?? [], null);
    }
     ...
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\ShippingPoint[]
     */
    public function getShippingPoints()
    {
        return $this->container['shipping_points'];
    }

    /**
     * Sets shipping_points
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\ShippingPoint[] $shipping_points Список пунктов отгрузки
     *
     * @return self
     */
    public function setShippingPoints($shipping_points)
    {
        if (is_null($shipping_points)) {
            throw new \InvalidArgumentException('non-nullable shipping_points cannot be null');
        }
        $this->container['shipping_points'] = $shipping_points;
