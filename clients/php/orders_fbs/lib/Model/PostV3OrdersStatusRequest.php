...
/**
 * PostV3OrdersStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3OrdersStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3OrdersStatus_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling PostV3OrdersStatusRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling PostV3OrdersStatusRequest., number of items must be greater than or equal to 1.');
        }
