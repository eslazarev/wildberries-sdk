...
/**
 * PutV3OrdersOrderIdMetaSgtinRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PutV3OrdersOrderIdMetaSgtinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3OrdersOrderIdMetaSgtin_request';
    ...
    public function setSgtins($sgtins)
    {
        ...
        if ((count($sgtins) > 100)) {
            throw new \InvalidArgumentException('invalid value for $sgtins when calling PutV3OrdersOrderIdMetaSgtinRequest., number of items must be less than or equal to 100.');
        }
        if ((count($sgtins) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sgtins when calling PutV3OrdersOrderIdMetaSgtinRequest., number of items must be greater than or equal to 1.');
        }
