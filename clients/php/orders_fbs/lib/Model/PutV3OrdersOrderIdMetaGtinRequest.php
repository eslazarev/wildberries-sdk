...
/**
 * PutV3OrdersOrderIdMetaGtinRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PutV3OrdersOrderIdMetaGtinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'putV3OrdersOrderIdMetaGtin_request';
    ...
    public function setGtin($gtin)
    {
        ...
        if ((mb_strlen($gtin) > 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling PutV3OrdersOrderIdMetaGtinRequest., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($gtin) < 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling PutV3OrdersOrderIdMetaGtinRequest., must be bigger than or equal to 13.');
        }
