...
/**
 * ApiMarketplaceV3FbsOrdersArchiveGet403Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiMarketplaceV3FbsOrdersArchiveGet403Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_marketplace_v3_fbs_orders_archive_get_403_response';
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'detail' => 'string',
        'errors' => '\Wildberries\Sdk\OrdersFbs\Model\ArhiveOrderError400ErrorsInner[]',
        'origin' => 'string',
        'request_id' => 'string',
        'status' => 'float',
        'title' => 'string',
     ...
     * Gets errors
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\ArhiveOrderError400ErrorsInner[]|null
     */
     ...
     * Sets errors
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\ArhiveOrderError400ErrorsInner[]|null $errors Информация об ошибке
     *
     * @return self
     */
