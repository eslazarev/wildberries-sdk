...
/**
 * PostV3SuppliesSupplyIdTrbxRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3SuppliesSupplyIdTrbxRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3SuppliesSupplyIdTrbx_request';
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 1000)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PostV3SuppliesSupplyIdTrbxRequest., must be smaller than or equal to 1000.');
        }
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PostV3SuppliesSupplyIdTrbxRequest., must be bigger than or equal to 1.');
        }
