...
/**
 * GetV3SettingsAutoreturnsSubcategoriesRestricted200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class GetV3SettingsAutoreturnsSubcategoriesRestricted200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getV3SettingsAutoreturnsSubcategoriesRestricted_200_response';
    ...
    protected static $openAPITypes = [
        'next' => 'int',
        'data' => '\Wildberries\Sdk\OrdersFbs\Model\GetV3SettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner[]'
    ];
     ...
     * Gets data
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\GetV3SettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner[]
     */
     ...
     * Sets data
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\GetV3SettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner[] $data Список ID предметов, товары которых не хранятся на складах WB
     *
     * @return self
     */
