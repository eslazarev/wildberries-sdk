...
/**
 * UpdateSupplyWaybill Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSupplyWaybill implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateSupplyWaybill';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['waybill_uuid'] === null) {
            $invalidProperties[] = "'waybill_uuid' can't be null";
        }
     ...
     * Sets waybill_uuid
     *
     * @param string $waybill_uuid ID ЭТрН
     *
     * @return self
     */
    public function setWaybillUuid($waybill_uuid)
    {
        if (is_null($waybill_uuid)) {
            throw new \InvalidArgumentException('non-nullable waybill_uuid cannot be null');
        }
