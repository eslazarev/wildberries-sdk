...
/**
 * V3ArchiveOrderCrossBorder Class Doc Comment
 *
 * @category Class
 * @description Информация о заказе по модели кроссбордер
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V3ArchiveOrderCrossBorder implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'v3_ArchiveOrder_crossBorder';
     ...
     * Sets parcel
     *
     * @param string|null $parcel ID посылки
     *
     * @return self
     */
