...
/**
 * PostV3SettingsAutoreturnsItemsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3SettingsAutoreturnsItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3SettingsAutoreturnsItems_request';
    ...
    public function setChrtIds($chrt_ids)
    {
        ...
        if ((count($chrt_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $chrt_ids when calling PostV3SettingsAutoreturnsItemsRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($chrt_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $chrt_ids when calling PostV3SettingsAutoreturnsItemsRequest., number of items must be greater than or equal to 1.');
        }
