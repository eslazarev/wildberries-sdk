...
/**
 * PostV3FbsSuppliesSpotListRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3FbsSuppliesSpotListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3FbsSuppliesSpotList_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supply_ids'] === null) {
            $invalidProperties[] = "'supply_ids' can't be null";
        }
     ...
     * Sets supply_ids
     *
     * @param string[] $supply_ids Список ID поставок
     *
     * @return self
     */
