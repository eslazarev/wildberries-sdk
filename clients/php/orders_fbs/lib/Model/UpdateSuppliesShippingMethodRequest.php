...
/**
 * UpdateSuppliesShippingMethodRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSuppliesShippingMethodRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateSuppliesShippingMethodRequest';
    ...
    protected static $openAPITypes = [
        'data' => '\Wildberries\Sdk\OrdersFbs\Model\UpdateSupplyShippingMethod[]'
    ];
     ...
     * Gets data
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\UpdateSupplyShippingMethod[]
     */
     ...
     * Sets data
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\UpdateSupplyShippingMethod[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling UpdateSuppliesShippingMethodRequest., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling UpdateSuppliesShippingMethodRequest., number of items must be greater than or equal to 1.');
        }
