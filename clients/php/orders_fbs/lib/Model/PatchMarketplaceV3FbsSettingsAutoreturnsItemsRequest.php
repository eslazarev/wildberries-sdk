...
/**
 * PatchMarketplaceV3FbsSettingsAutoreturnsItemsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PatchMarketplaceV3FbsSettingsAutoreturnsItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'patchMarketplaceV3FbsSettingsAutoreturnsItems_request';
    ...
    public function setChrtIds($chrt_ids)
    {
        ...
        if ((count($chrt_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $chrt_ids when calling PatchMarketplaceV3FbsSettingsAutoreturnsItemsRequest., number of items must be less than or equal to 1000.');
        }
