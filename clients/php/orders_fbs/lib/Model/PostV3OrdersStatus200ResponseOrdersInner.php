...
/**
 * PostV3OrdersStatus200ResponseOrdersInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3OrdersStatus200ResponseOrdersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3OrdersStatus_200_response_orders_inner';
     ...
     * Sets is_cancellable
     *
     * @param bool|null $is_cancellable Доступна ли [отмена](./orders-fbs#tag/fbsAssemblyOrders/operation/patchV3OrdersOrderIdCancel) сборочного задания: - `false` — недоступна - `true` — доступна
     *
     * @return self
     */
