...
class Supply implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $shipping_point_id ID пункта отгрузки. Можно получить в методе получения [пунктов отгрузки поставок](./orders-fbs#tag/fbsSupplies/operation/getV3FbsShippingPoints)
     *
     * @return self
     */
