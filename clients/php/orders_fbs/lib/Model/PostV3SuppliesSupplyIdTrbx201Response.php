...
/**
 * PostV3SuppliesSupplyIdTrbx201Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3SuppliesSupplyIdTrbx201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3SuppliesSupplyIdTrbx_201_response';
    ...
    public function setTrbxIds($trbx_ids)
    {
        ...
        if ((count($trbx_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $trbx_ids when calling PostV3SuppliesSupplyIdTrbx201Response., number of items must be greater than or equal to 1.');
        }
