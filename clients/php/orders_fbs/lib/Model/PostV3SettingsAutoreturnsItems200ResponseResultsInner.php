...
/**
 * PostV3SettingsAutoreturnsItems200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3SettingsAutoreturnsItems200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3SettingsAutoreturnsItems_200_response_results_inner';
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'string',
        'changeable' => 'bool',
        'error' => '\Wildberries\Sdk\OrdersFbs\Model\PostV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner[]'
    ];
     ...
     * Sets type
     *
     * @param string|null $type Куда будет возвращён товар:   - `auto` — место возврата определяется автоматически   - `byWarehouse` — на склад WB   - `byPickupPoint` — на пункт выдачи заказов   - `byCourier` — продавцу курьером. Всегда для товаров тех [предметов](/openapi/orders-fbs#tag/autoreturnSettings/operation/getV3SettingsAutoreturnsSubcategoriesRestricted), которые автоматически возвращаются в ПВЗ
     *
     * @return self
     */
     ...
     * Gets error
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\PostV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner[]|null
     */
     ...
     * Sets error
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\PostV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner[]|null $error Детали ошибки
     *
     * @return self
     */
