...
/**
 * PatchV3SettingsAutoreturnsItemsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PatchV3SettingsAutoreturnsItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'patchV3SettingsAutoreturnsItems_request';
    ...
    public function setChrtIds($chrt_ids)
    {
        ...
        if ((count($chrt_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $chrt_ids when calling PatchV3SettingsAutoreturnsItemsRequest., number of items must be less than or equal to 1000.');
        }
