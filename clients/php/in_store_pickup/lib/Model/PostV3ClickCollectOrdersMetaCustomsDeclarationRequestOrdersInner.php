...
/**
 * PostV3ClickCollectOrdersMetaCustomsDeclarationRequestOrdersInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\InStorePickup
 * @author   OpenAPI Generator team
 ...
 */
class PostV3ClickCollectOrdersMetaCustomsDeclarationRequestOrdersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postV3ClickCollectOrdersMetaCustomsDeclaration_request_orders_inner';
    ...
    public function setCustomsDeclaration($customs_declaration)
    {
        ...
        if ((mb_strlen($customs_declaration) > 29)) {
            throw new \InvalidArgumentException('invalid length for $customs_declaration when calling PostV3ClickCollectOrdersMetaCustomsDeclarationRequestOrdersInner., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($customs_declaration) < 17)) {
            throw new \InvalidArgumentException('invalid length for $customs_declaration when calling PostV3ClickCollectOrdersMetaCustomsDeclarationRequestOrdersInner., must be bigger than or equal to 17.');
        }
    ...
    public function setOriginCountryCode($origin_country_code)
    {
        ...
        if ((mb_strlen($origin_country_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $origin_country_code when calling PostV3ClickCollectOrdersMetaCustomsDeclarationRequestOrdersInner., must be smaller than or equal to 3.');
        }
