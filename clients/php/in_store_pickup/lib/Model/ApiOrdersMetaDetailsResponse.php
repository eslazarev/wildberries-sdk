...
class ApiOrdersMetaDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'request_id' => 'string',
        'orders' => '\Wildberries\Sdk\InStorePickup\Model\ApiOrdersMetaDetailsResponseOrdersInner[]'
    ];
     ...
     * Gets orders
     *
     * @return \Wildberries\Sdk\InStorePickup\Model\ApiOrdersMetaDetailsResponseOrdersInner[]
     */
     ...
     * Sets orders
     *
     * @param \Wildberries\Sdk\InStorePickup\Model\ApiOrdersMetaDetailsResponseOrdersInner[] $orders Идентификаторы маркировки сборочных заданий и статусы их валидации
     *
     * @return self
     */
