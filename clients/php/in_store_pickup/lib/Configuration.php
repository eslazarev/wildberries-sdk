...
namespace Wildberries\Sdk\InStorePickup;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://marketplace-api.wildberries.ru';
    ...
    {
        $report  = 'PHP SDK (Wildberries\Sdk\InStorePickup) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: instorepickup' . PHP_EOL;
