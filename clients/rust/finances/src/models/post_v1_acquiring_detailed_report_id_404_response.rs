...
pub struct PostV1AcquiringDetailedReportId404Response {
    /// HTTP статус-код
    #[serde(rename = "status")]
    pub status: i32,
    /// Заголовок ошибки
...
impl PostV1AcquiringDetailedReportId404Response {
    pub fn new(status: i32, title: String, detail: String, request_id: String, origin: String) -> PostV1AcquiringDetailedReportId404Response {
