...
pub struct ContentV2CardsUploadPostRequestInnerVariantsInnerDocuments {
    /// Список документов
...
impl ContentV2CardsUploadPostRequestInnerVariantsInnerDocuments {
    /// Документы
    pub fn new() -> ContentV2CardsUploadPostRequestInnerVariantsInnerDocuments {
