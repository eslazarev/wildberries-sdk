...
pub struct GetV2QuarantineGoods200Response {
    #[serde(rename = "data", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub data: Option<Option<Box<models::GetV2QuarantineGoods200ResponseData>>>,
    /// Флаг ошибки
...
impl GetV2QuarantineGoods200Response {
    pub fn new() -> GetV2QuarantineGoods200Response {
