...
pub struct GetV2QuarantineGoods200ResponseData {
    /// Информация о товарах в карантине
    #[serde(rename = "quarantineGoods", skip_serializing_if = "Option::is_none")]
    pub quarantine_goods: Option<Vec<models::QuarantineItems>>,
}

impl GetV2QuarantineGoods200ResponseData {
    /// Данные ответа
    pub fn new() -> GetV2QuarantineGoods200ResponseData {
