...
pub struct GetV3DbwWarehousesWarehouseIdContacts200Response {
    #[serde(rename = "contacts", skip_serializing_if = "Option::is_none")]
    pub contacts: Option<Vec<models::GetV3DbwWarehousesWarehouseIdContacts200ResponseContactsInner>>,
}

impl GetV3DbwWarehousesWarehouseIdContacts200Response {
    /// Список контактов склада продавца
    pub fn new() -> GetV3DbwWarehousesWarehouseIdContacts200Response {
