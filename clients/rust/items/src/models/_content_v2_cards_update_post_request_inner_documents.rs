...
pub struct ContentV2CardsUpdatePostRequestInnerDocuments {
    /// Список документов
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<models::ContentV2CardsUpdatePostRequestInnerDocumentsItemsInner>>,
...
impl ContentV2CardsUpdatePostRequestInnerDocuments {
    /// Документы
    pub fn new() -> ContentV2CardsUpdatePostRequestInnerDocuments {
