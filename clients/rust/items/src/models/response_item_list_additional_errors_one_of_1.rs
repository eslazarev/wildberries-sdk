...
pub struct ResponseItemListAdditionalErrorsOneOf1 {
    #[serde(rename = "error")]
    pub error: String,
}

impl ResponseItemListAdditionalErrorsOneOf1 {
    pub fn new(error: String) -> ResponseItemListAdditionalErrorsOneOf1 {
