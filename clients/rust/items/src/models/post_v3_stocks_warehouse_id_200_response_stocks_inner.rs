...
pub struct PostV3StocksWarehouseId200ResponseStocksInner {
    /// ID размера товара
...
impl PostV3StocksWarehouseId200ResponseStocksInner {
    pub fn new() -> PostV3StocksWarehouseId200ResponseStocksInner {
