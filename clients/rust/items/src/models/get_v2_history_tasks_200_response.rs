...
pub struct GetV2HistoryTasks200Response {
    #[serde(rename = "data", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub data: Option<Option<Box<models::SellerTaskMetadata>>>,
    /// Флаг ошибки
...
impl GetV2HistoryTasks200Response {
    pub fn new() -> GetV2HistoryTasks200Response {
