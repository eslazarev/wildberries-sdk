...
pub struct PostV2GetCardsList200Response {
    /// Список карточек товаров
    #[serde(rename = "cards", skip_serializing_if = "Option::is_none")]
    pub cards: Option<Vec<models::PostV2GetCardsList200ResponseCardsInner>>,
    #[serde(rename = "cursor", skip_serializing_if = "Option::is_none")]
    pub cursor: Option<Box<models::PostV2GetCardsList200ResponseCursor>>,
}

impl PostV2GetCardsList200Response {
    pub fn new() -> PostV2GetCardsList200Response {
