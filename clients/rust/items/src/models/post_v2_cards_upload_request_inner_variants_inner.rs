...
pub struct PostV2CardsUploadRequestInnerVariantsInner {
    /// Бренд
    ...
    pub dimensions: Option<Box<models::PostV2CardsUploadRequestInnerVariantsInnerDimensions>>,
    ...
    pub sizes: Option<Vec<models::PostV2CardsUploadRequestInnerVariantsInnerSizesInner>>,
...
impl PostV2CardsUploadRequestInnerVariantsInner {
    pub fn new(vendor_code: String) -> PostV2CardsUploadRequestInnerVariantsInner {
