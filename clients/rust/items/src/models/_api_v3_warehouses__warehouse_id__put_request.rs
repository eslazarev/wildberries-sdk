...
pub struct ApiV3WarehousesWarehouseIdPutRequest {
    /// Имя склада продавца
    #[serde(rename = "name")]
    pub name: String,
...
impl ApiV3WarehousesWarehouseIdPutRequest {
    pub fn new(name: String, office_id: i32) -> ApiV3WarehousesWarehouseIdPutRequest {
