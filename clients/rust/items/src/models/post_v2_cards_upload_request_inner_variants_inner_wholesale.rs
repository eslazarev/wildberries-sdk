...
pub struct PostV2CardsUploadRequestInnerVariantsInnerWholesale {
...
impl PostV2CardsUploadRequestInnerVariantsInnerWholesale {
    /// B2B-продажа
    pub fn new() -> PostV2CardsUploadRequestInnerVariantsInnerWholesale {
