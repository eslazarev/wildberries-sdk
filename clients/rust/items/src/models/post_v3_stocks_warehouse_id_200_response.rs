...
pub struct PostV3StocksWarehouseId200Response {
    #[serde(rename = "stocks", skip_serializing_if = "Option::is_none")]
    pub stocks: Option<Vec<models::PostV3StocksWarehouseId200ResponseStocksInner>>,
}

impl PostV3StocksWarehouseId200Response {
    pub fn new() -> PostV3StocksWarehouseId200Response {
