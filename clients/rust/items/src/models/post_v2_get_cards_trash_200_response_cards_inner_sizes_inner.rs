...
pub struct PostV2GetCardsTrash200ResponseCardsInnerSizesInner {
    /// ID размера
...
impl PostV2GetCardsTrash200ResponseCardsInnerSizesInner {
    pub fn new() -> PostV2GetCardsTrash200ResponseCardsInnerSizesInner {
