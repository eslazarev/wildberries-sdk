...
pub struct GetV2ListGoodsFilter200Response {
    #[serde(rename = "data")]
    pub data: Box<models::GetV2ListGoodsFilter200ResponseData>,
    /// Флаг ошибки
    #[serde(rename = "error")]
    pub error: bool,
    /// Текст ошибки
...
impl GetV2ListGoodsFilter200Response {
    pub fn new(data: models::GetV2ListGoodsFilter200ResponseData, error: bool, error_text: String) -> GetV2ListGoodsFilter200Response {
