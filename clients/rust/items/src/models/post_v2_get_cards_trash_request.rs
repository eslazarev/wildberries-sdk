...
pub struct PostV2GetCardsTrashRequest {
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Box<models::PostV2GetCardsTrashRequestSettings>>,
}

impl PostV2GetCardsTrashRequest {
    pub fn new() -> PostV2GetCardsTrashRequest {
