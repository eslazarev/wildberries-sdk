...
pub struct GetV2ListGoodsFilter200ResponseData {
    /// Информация о товарах
    #[serde(rename = "listGoods")]
    pub list_goods: Vec<models::ItemsList>,
}

impl GetV2ListGoodsFilter200ResponseData {
    /// Данные ответа
    pub fn new(list_goods: Vec<models::ItemsList>) -> GetV2ListGoodsFilter200ResponseData {
