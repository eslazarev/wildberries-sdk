...
pub struct PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInner {
    /// ID документа
    ...
    pub verdict: Option<Box<models::PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInnerVerdict>>,
    /// Дата добавления документа
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<chrono::DateTime<chrono::FixedOffset>>,
}

impl PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInner {
    pub fn new() -> PostV2GetCardsList200ResponseCardsInnerDocumentsItemsInner {
