...
pub struct PostV2GetCardsListRequest {
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Box<models::PostV2GetCardsListRequestSettings>>,
}

impl PostV2GetCardsListRequest {
    pub fn new() -> PostV2GetCardsListRequest {
