...
pub struct PostV1UploadTaskB2bWholesale208Response {
    /// HTTP статус-код
    #[serde(rename = "status")]
    pub status: i32,
    /// Заголовок ответа
...
impl PostV1UploadTaskB2bWholesale208Response {
    pub fn new(status: i32, title: String, detail: String, request_id: String, origin: String) -> PostV1UploadTaskB2bWholesale208Response {
