...
pub struct PostV2UploadTaskClubDiscountRequest {
    /// Товары и скидки WB Клуба для них. Максимум 1 000 товаров. 
    #[serde(rename = "data")]
    pub data: Vec<models::ClubDiscReq>,
}

impl PostV2UploadTaskClubDiscountRequest {
    pub fn new(data: Vec<models::ClubDiscReq>) -> PostV2UploadTaskClubDiscountRequest {
