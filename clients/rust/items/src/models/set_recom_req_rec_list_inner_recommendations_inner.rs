...
pub struct SetRecomReqRecListInnerRecommendationsInner {
...
impl SetRecomReqRecListInnerRecommendationsInner {
    pub fn new() -> SetRecomReqRecListInnerRecommendationsInner {
