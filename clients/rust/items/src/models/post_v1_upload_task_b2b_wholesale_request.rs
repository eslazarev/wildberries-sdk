...
pub struct PostV1UploadTaskB2bWholesaleRequest {
    /// Товары и оптовые скидки для B2B
    #[serde(rename = "data")]
    pub data: Vec<models::B2BWholesaleInner>,
}

impl PostV1UploadTaskB2bWholesaleRequest {
    pub fn new(data: Vec<models::B2BWholesaleInner>) -> PostV1UploadTaskB2bWholesaleRequest {
