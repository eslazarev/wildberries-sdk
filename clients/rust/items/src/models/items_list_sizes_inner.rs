...
pub struct ItemsListSizesInner {
...
impl ItemsListSizesInner {
    pub fn new(size_id: i64, price: i32, discounted_price: f64, club_discounted_price: f64, tech_size_name: String) -> ItemsListSizesInner {
        ItemsListSizesInner {
            size_id,
            price,
            discounted_price,
