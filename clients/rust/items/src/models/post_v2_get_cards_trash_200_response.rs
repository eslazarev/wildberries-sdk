...
pub struct PostV2GetCardsTrash200Response {
    /// Массив карточек товаров
    #[serde(rename = "cards", skip_serializing_if = "Option::is_none")]
    pub cards: Option<Vec<models::PostV2GetCardsTrash200ResponseCardsInner>>,
    #[serde(rename = "cursor", skip_serializing_if = "Option::is_none")]
    pub cursor: Option<Box<models::PostV2GetCardsTrash200ResponseCursor>>,
}

impl PostV2GetCardsTrash200Response {
    pub fn new() -> PostV2GetCardsTrash200Response {
