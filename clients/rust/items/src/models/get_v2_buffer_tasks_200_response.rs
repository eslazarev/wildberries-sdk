...
pub struct GetV2BufferTasks200Response {
    #[serde(rename = "data", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub data: Option<Option<Box<models::SellerTaskMetadataBuffer>>>,
    /// Флаг ошибки
...
impl GetV2BufferTasks200Response {
    pub fn new() -> GetV2BufferTasks200Response {
