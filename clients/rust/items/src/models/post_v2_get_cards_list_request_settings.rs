...
pub struct PostV2GetCardsListRequestSettings {
    #[serde(rename = "sort", skip_serializing_if = "Option::is_none")]
    pub sort: Option<Box<models::PostV2GetCardsListRequestSettingsSort>>,
    #[serde(rename = "filter", skip_serializing_if = "Option::is_none")]
    pub filter: Option<Box<models::PostV2GetCardsListRequestSettingsFilter>>,
    #[serde(rename = "cursor", skip_serializing_if = "Option::is_none")]
    pub cursor: Option<Box<models::PostV2GetCardsListRequestSettingsCursor>>,
}

impl PostV2GetCardsListRequestSettings {
    /// Настройки
    pub fn new() -> PostV2GetCardsListRequestSettings {
