...
#[serde(untagged)]
pub enum ResponseItemListAdditionalErrors {
    ResponseItemListAdditionalErrorsOneOf(Box<models::ResponseItemListAdditionalErrorsOneOf>),
    String(String),
    ResponseItemListAdditionalErrorsOneOf1(Box<models::ResponseItemListAdditionalErrorsOneOf1>),
}

impl Default for ResponseItemListAdditionalErrors {
    fn default() -> Self {
        Self::ResponseItemListAdditionalErrorsOneOf(Default::default())
    }
}
