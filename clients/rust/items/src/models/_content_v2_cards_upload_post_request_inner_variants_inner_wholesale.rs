...
pub struct ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale {
...
impl ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale {
    /// B2B-продажа
    pub fn new() -> ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale {
