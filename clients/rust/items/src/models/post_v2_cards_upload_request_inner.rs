...
pub struct PostV2CardsUploadRequestInner {
    /// ID предмета
    ...
    pub variants: Vec<models::PostV2CardsUploadRequestInnerVariantsInner>,
}

impl PostV2CardsUploadRequestInner {
    pub fn new(subject_id: i32, variants: Vec<models::PostV2CardsUploadRequestInnerVariantsInner>) -> PostV2CardsUploadRequestInner {
