...
pub struct GetV2DirectoryCountries200ResponseDataInner {
    /// ID страны
...
impl GetV2DirectoryCountries200ResponseDataInner {
    pub fn new() -> GetV2DirectoryCountries200ResponseDataInner {
