...
pub struct PostV2CardsUploadAddRequestCardsToAddInnerDimensions {
    /// Длина, см
...
impl PostV2CardsUploadAddRequestCardsToAddInnerDimensions {
    ...
    pub fn new() -> PostV2CardsUploadAddRequestCardsToAddInnerDimensions {
