...
pub struct PutV3WarehousesWarehouseIdRequest {
    /// Имя склада продавца
    #[serde(rename = "name")]
    pub name: String,
...
impl PutV3WarehousesWarehouseIdRequest {
    pub fn new(name: String, office_id: i32) -> PutV3WarehousesWarehouseIdRequest {
