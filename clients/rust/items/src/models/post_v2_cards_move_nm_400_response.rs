...
#[serde(untagged)]
pub enum PostV2CardsMoveNm400Response {
    ResponseItemList(Box<models::ResponseItemList>),
    ResponseIncorrectDate(Box<models::ResponseIncorrectDate>),
}

impl Default for PostV2CardsMoveNm400Response {
    fn default() -> Self {
        Self::ResponseItemList(Default::default())
    }
}
