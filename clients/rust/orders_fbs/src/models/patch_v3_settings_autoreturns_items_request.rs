...
pub struct PatchV3SettingsAutoreturnsItemsRequest {
...
impl PatchV3SettingsAutoreturnsItemsRequest {
    pub fn new(chrt_ids: Vec<i32>, r#type: Type) -> PatchV3SettingsAutoreturnsItemsRequest {
