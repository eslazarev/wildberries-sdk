...
pub struct PostV3OrdersStatusHistory200Response {
    /// Список сборочных заданий
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::PostV3OrdersStatusHistory200ResponseOrdersInner>>,
}

impl PostV3OrdersStatusHistory200Response {
    pub fn new() -> PostV3OrdersStatusHistory200Response {
