...
pub struct CountriesOksmList {
    /// Список стран ОКСМ
    #[serde(rename = "countries")]
    pub countries: Vec<models::CountriesOksmListCountriesInner>,
}

impl CountriesOksmList {
    pub fn new(countries: Vec<models::CountriesOksmListCountriesInner>) -> CountriesOksmList {
        CountriesOksmList {
            countries,
        }
    }
