...
pub struct PostV3PassesRequest {
    /// Имя водителя
...
impl PostV3PassesRequest {
    pub fn new(first_name: String, last_name: String, car_model: String, car_number: String, office_id: i64) -> PostV3PassesRequest {
        PostV3PassesRequest {
            first_name,
            last_name,
            car_model,
