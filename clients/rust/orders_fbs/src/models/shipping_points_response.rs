...
pub struct ShippingPointsResponse {
    /// Список пунктов отгрузки
    #[serde(rename = "shippingPoints")]
    pub shipping_points: Vec<models::ShippingPoint>,
}

impl ShippingPointsResponse {
    pub fn new(shipping_points: Vec<models::ShippingPoint>) -> ShippingPointsResponse {
