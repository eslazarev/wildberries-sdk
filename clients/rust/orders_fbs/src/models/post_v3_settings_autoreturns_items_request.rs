...
pub struct PostV3SettingsAutoreturnsItemsRequest {
    /// Список ID размеров товаров в системе WB
    #[serde(rename = "chrtIds")]
    pub chrt_ids: Vec<i64>,
}

impl PostV3SettingsAutoreturnsItemsRequest {
    pub fn new(chrt_ids: Vec<i64>) -> PostV3SettingsAutoreturnsItemsRequest {
