...
#[serde(untagged)]
pub enum ApiMarketplaceV3FbsOrdersArchiveGet403Response {
    ArhiveOrderError400(Box<models::ArhiveOrderError400>),
    Response4Xx(Box<models::Response4Xx>),
}

impl Default for ApiMarketplaceV3FbsOrdersArchiveGet403Response {
    fn default() -> Self {
        Self::ArhiveOrderError400(Default::default())
    }
}
