...
pub struct PostMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
    /// Код ошибки
    #[serde(rename = "code")]
    pub code: i32,
...
impl PostMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
    pub fn new(code: i32, detail: String) -> PostMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
