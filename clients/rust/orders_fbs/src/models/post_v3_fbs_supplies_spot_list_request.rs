...
pub struct PostV3FbsSuppliesSpotListRequest {
    /// Список ID поставок
    #[serde(rename = "supplyIds")]
    pub supply_ids: Vec<String>,
}

impl PostV3FbsSuppliesSpotListRequest {
    pub fn new(supply_ids: Vec<String>) -> PostV3FbsSuppliesSpotListRequest {
