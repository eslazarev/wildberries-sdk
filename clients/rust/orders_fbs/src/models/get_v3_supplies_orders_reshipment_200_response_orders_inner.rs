...
pub struct GetV3SuppliesOrdersReshipment200ResponseOrdersInner {
    /// ID поставки
...
impl GetV3SuppliesOrdersReshipment200ResponseOrdersInner {
    pub fn new() -> GetV3SuppliesOrdersReshipment200ResponseOrdersInner {
