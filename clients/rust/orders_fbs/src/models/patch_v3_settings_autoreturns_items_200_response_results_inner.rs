...
pub struct PatchV3SettingsAutoreturnsItems200ResponseResultsInner {
    /// ID размера товара в системе WB
    #[serde(rename = "chrtId")]
    pub chrt_id: i32,
    /// Детали ошибки
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<Vec<models::PatchV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner>>,
    /// - `true` — настройки автовозврата товара получены 
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl PatchV3SettingsAutoreturnsItems200ResponseResultsInner {
    pub fn new(chrt_id: i32) -> PatchV3SettingsAutoreturnsItems200ResponseResultsInner {
