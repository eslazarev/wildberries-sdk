...
pub struct UpdateSupplyWaybill {
    /// ID поставки
    #[serde(rename = "supplyId")]
    pub supply_id: String,
    /// ID ЭТрН
    #[serde(rename = "waybillUuid")]
    pub waybill_uuid: uuid::Uuid,
}

impl UpdateSupplyWaybill {
    pub fn new(supply_id: String, waybill_uuid: uuid::Uuid) -> UpdateSupplyWaybill {
        UpdateSupplyWaybill {
            supply_id,
            waybill_uuid,
        }
