...
pub struct PutV3PassesPassIdRequest {
    /// Имя водителя
...
impl PutV3PassesPassIdRequest {
    pub fn new(first_name: String, last_name: String, car_model: String, car_number: String, office_id: i64) -> PutV3PassesPassIdRequest {
