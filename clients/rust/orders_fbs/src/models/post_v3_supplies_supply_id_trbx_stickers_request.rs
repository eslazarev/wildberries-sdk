...
pub struct PostV3SuppliesSupplyIdTrbxStickersRequest {
    /// Список ID грузомест, по которым необходимо вернуть стикеры
    #[serde(rename = "trbxIds")]
    pub trbx_ids: Vec<String>,
}

impl PostV3SuppliesSupplyIdTrbxStickersRequest {
    pub fn new(trbx_ids: Vec<String>) -> PostV3SuppliesSupplyIdTrbxStickersRequest {
