...
pub struct SupplySpotDataResponse {
    #[serde(rename = "supplies")]
    pub supplies: Vec<models::SupplySpotDataResponseSuppliesInner>,
}

impl SupplySpotDataResponse {
    pub fn new(supplies: Vec<models::SupplySpotDataResponseSuppliesInner>) -> SupplySpotDataResponse {
