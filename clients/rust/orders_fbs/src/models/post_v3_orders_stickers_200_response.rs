...
pub struct PostV3OrdersStickers200Response {
    #[serde(rename = "stickers", skip_serializing_if = "Option::is_none")]
    pub stickers: Option<Vec<models::PostV3OrdersStickers200ResponseStickersInner>>,
}

impl PostV3OrdersStickers200Response {
    pub fn new() -> PostV3OrdersStickers200Response {
