...
pub struct PostMarketplaceV3FbsSettingsAutoreturnsItems200Response {
    #[serde(rename = "results")]
    pub results: Vec<models::PostMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner>,
}

impl PostMarketplaceV3FbsSettingsAutoreturnsItems200Response {
    pub fn new(results: Vec<models::PostMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner>) -> PostMarketplaceV3FbsSettingsAutoreturnsItems200Response {
