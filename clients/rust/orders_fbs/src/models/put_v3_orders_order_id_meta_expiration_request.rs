...
pub struct PutV3OrdersOrderIdMetaExpirationRequest {
    /// Дата, до которой годен товар. Не менее 30 дней с текущей даты
    #[serde(rename = "expiration")]
    pub expiration: String,
}

impl PutV3OrdersOrderIdMetaExpirationRequest {
    pub fn new(expiration: String) -> PutV3OrdersOrderIdMetaExpirationRequest {
