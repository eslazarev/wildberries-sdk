...
pub struct GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner {
    /// ID предмета
    #[serde(rename = "subjectId")]
    pub subject_id: i32,
}

impl GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner {
    pub fn new(subject_id: i32) -> GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner {
