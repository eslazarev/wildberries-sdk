...
pub struct GetV3SettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner {
    /// ID предмета
    #[serde(rename = "subjectId")]
    pub subject_id: i32,
}

impl GetV3SettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner {
    pub fn new(subject_id: i32) -> GetV3SettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner {
