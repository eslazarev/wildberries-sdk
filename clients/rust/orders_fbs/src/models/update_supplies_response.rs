...
pub struct UpdateSuppliesResponse {
    #[serde(rename = "results")]
    pub results: Vec<models::UpdatedSupplies>,
}

impl UpdateSuppliesResponse {
    pub fn new(results: Vec<models::UpdatedSupplies>) -> UpdateSuppliesResponse {
