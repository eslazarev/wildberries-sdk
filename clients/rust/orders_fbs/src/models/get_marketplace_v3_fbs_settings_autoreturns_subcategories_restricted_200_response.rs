...
pub struct GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200Response {
    ...
    #[serde(rename = "data")]
    pub data: Vec<models::GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner>,
}

impl GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200Response {
    pub fn new(next: Option<i64>, data: Vec<models::GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200ResponseDataInner>) -> GetMarketplaceV3FbsSettingsAutoreturnsSubcategoriesRestricted200Response {
