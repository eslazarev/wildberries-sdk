...
pub struct PatchMarketplaceV3FbsSettingsAutoreturnsItems200Response {
    #[serde(rename = "results")]
    pub results: Vec<models::PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner>,
}

impl PatchMarketplaceV3FbsSettingsAutoreturnsItems200Response {
    pub fn new(results: Vec<models::PatchMarketplaceV3FbsSettingsAutoreturnsItems200ResponseResultsInner>) -> PatchMarketplaceV3FbsSettingsAutoreturnsItems200Response {
