...
pub struct PatchV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
    /// Код ошибки
    #[serde(rename = "code")]
    pub code: i32,
...
impl PatchV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
    pub fn new(code: i32, detail: String) -> PatchV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
