...
pub struct PostV3OrdersStatus200Response {
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::PostV3OrdersStatus200ResponseOrdersInner>>,
}

impl PostV3OrdersStatus200Response {
    pub fn new() -> PostV3OrdersStatus200Response {
