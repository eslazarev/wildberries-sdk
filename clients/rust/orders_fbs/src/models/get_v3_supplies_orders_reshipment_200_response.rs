...
pub struct GetV3SuppliesOrdersReshipment200Response {
    /// Список сборочных заданий
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::GetV3SuppliesOrdersReshipment200ResponseOrdersInner>>,
}

impl GetV3SuppliesOrdersReshipment200Response {
    pub fn new() -> GetV3SuppliesOrdersReshipment200Response {
