...
pub struct PostV3OrdersStatusHistory200ResponseOrdersInner {
    ...
    pub statuses: Option<Vec<models::PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner>>,
    /// ID сборочного задания
    #[serde(rename = "orderID", skip_serializing_if = "Option::is_none")]
    pub order_id: Option<i32>,
}

impl PostV3OrdersStatusHistory200ResponseOrdersInner {
    pub fn new() -> PostV3OrdersStatusHistory200ResponseOrdersInner {
