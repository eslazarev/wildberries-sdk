...
pub struct PostV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
    /// Код ошибки
    #[serde(rename = "code")]
    pub code: i32,
...
impl PostV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
    pub fn new(code: i32, detail: String) -> PostV3SettingsAutoreturnsItems200ResponseResultsInnerErrorInner {
