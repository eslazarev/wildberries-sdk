...
pub struct DeleteV3SuppliesSupplyIdTrbxRequest {
    /// Список ID грузомест, которые необходимо удалить
    #[serde(rename = "trbxIds")]
    pub trbx_ids: Vec<String>,
}

impl DeleteV3SuppliesSupplyIdTrbxRequest {
    pub fn new(trbx_ids: Vec<String>) -> DeleteV3SuppliesSupplyIdTrbxRequest {
