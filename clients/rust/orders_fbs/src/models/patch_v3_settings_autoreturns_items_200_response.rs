...
pub struct PatchV3SettingsAutoreturnsItems200Response {
    #[serde(rename = "results")]
    pub results: Vec<models::PatchV3SettingsAutoreturnsItems200ResponseResultsInner>,
}

impl PatchV3SettingsAutoreturnsItems200Response {
    pub fn new(results: Vec<models::PatchV3SettingsAutoreturnsItems200ResponseResultsInner>) -> PatchV3SettingsAutoreturnsItems200Response {
