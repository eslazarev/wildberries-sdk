...
pub struct SupplySpotDataResponseSuppliesInner {
    /// ID поставки
    #[serde(rename = "id")]
    pub id: String,
    /// Данные СПОТ
    #[serde(rename = "spot", skip_serializing_if = "Option::is_none")]
    pub spot: Option<Box<models::SupplySpotData>>,
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<Box<models::ApiErrorV3>>,
}

impl SupplySpotDataResponseSuppliesInner {
    pub fn new(id: String) -> SupplySpotDataResponseSuppliesInner {
