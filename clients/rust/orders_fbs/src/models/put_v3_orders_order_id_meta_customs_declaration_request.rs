...
pub struct PutV3OrdersOrderIdMetaCustomsDeclarationRequest {
    /// Номер ДТ
    #[serde(rename = "customsDeclaration")]
    pub customs_declaration: String,
}

impl PutV3OrdersOrderIdMetaCustomsDeclarationRequest {
    pub fn new(customs_declaration: String) -> PutV3OrdersOrderIdMetaCustomsDeclarationRequest {
