...
pub struct PostMarketplaceV3FbsSettingsAutoreturnsItemsRequest {
    /// Список ID размеров товаров в системе WB
    #[serde(rename = "chrtIds")]
    pub chrt_ids: Vec<i64>,
}

impl PostMarketplaceV3FbsSettingsAutoreturnsItemsRequest {
    pub fn new(chrt_ids: Vec<i64>) -> PostMarketplaceV3FbsSettingsAutoreturnsItemsRequest {
