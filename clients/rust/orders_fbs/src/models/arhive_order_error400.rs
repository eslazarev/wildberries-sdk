...
pub struct ArhiveOrderError400 {
    /// Код ошибки
    ...
    pub errors: Option<Vec<models::ArhiveOrderError400ErrorsInner>>,
...
impl ArhiveOrderError400 {
    pub fn new(detail: String, title: String) -> ArhiveOrderError400 {
        ArhiveOrderError400 {
            code: None,
            detail,
            errors: None,
