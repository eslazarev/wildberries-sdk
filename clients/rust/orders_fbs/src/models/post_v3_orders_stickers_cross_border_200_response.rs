...
pub struct PostV3OrdersStickersCrossBorder200Response {
    #[serde(rename = "stickers", skip_serializing_if = "Option::is_none")]
    pub stickers: Option<Vec<models::PostV3OrdersStickersCrossBorder200ResponseStickersInner>>,
}

impl PostV3OrdersStickersCrossBorder200Response {
    pub fn new() -> PostV3OrdersStickersCrossBorder200Response {
