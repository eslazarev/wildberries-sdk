...
pub struct CommissionUaeReportInner {
    /// Комиссия для продавцов из ОАЭ, %
    #[serde(rename = "kgvpUAE", skip_serializing_if = "Option::is_none")]
    pub kgvp_uae: Option<f64>,
...
impl CommissionUaeReportInner {
    pub fn new() -> CommissionUaeReportInner {
