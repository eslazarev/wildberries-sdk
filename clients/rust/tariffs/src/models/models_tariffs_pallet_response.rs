...
pub struct ModelsTariffsPalletResponse {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ModelsWarehousesPalletRates>>,
}

impl ModelsTariffsPalletResponse {
    pub fn new() -> ModelsTariffsPalletResponse {
