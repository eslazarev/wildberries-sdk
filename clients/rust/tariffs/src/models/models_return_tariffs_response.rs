...
pub struct ModelsReturnTariffsResponse {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ModelsWarehousesReturnRates>>,
}

impl ModelsReturnTariffsResponse {
    pub fn new() -> ModelsReturnTariffsResponse {
