...
pub struct CommissionTurkeyReportInner {
    /// Комиссия для продавцов из Турции, %
    #[serde(rename = "kgvpTurkey", skip_serializing_if = "Option::is_none")]
    pub kgvp_turkey: Option<f64>,
...
impl CommissionTurkeyReportInner {
    pub fn new() -> CommissionTurkeyReportInner {
