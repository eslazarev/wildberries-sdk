...
pub struct GetV1Feedback200ResponseData {
    /// ID отзыва
    ...
    pub answer: Option<Option<Box<models::GetV1Feedback200ResponseDataAnswer>>>,
    ...
    pub product_details: Option<Box<models::GetV1Feedback200ResponseDataProductDetails>>,
    ...
    pub photo_links: Option<Option<Vec<models::GetV1Feedback200ResponseDataPhotoLinksInner>>>,
    /// Имя автора отзыва
    ...
    pub video: Option<Option<Box<models::GetV1Feedback200ResponseDataVideo>>>,
    /// Просмотрен ли отзыв
...
impl GetV1Feedback200ResponseData {
    pub fn new() -> GetV1Feedback200ResponseData {
