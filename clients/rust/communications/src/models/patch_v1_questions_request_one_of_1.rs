...
pub struct PatchV1QuestionsRequestOneOf1 {
    /// Id вопроса
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "answer")]
    pub answer: Box<models::PatchV1QuestionsRequestOneOf1Answer>,
...
impl PatchV1QuestionsRequestOneOf1 {
    pub fn new(id: String, answer: models::PatchV1QuestionsRequestOneOf1Answer, state: String) -> PatchV1QuestionsRequestOneOf1 {
