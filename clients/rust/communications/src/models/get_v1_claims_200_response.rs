...
pub struct GetV1Claims200Response {
    /// Заявки
    #[serde(rename = "claims", skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<models::GetV1Claims200ResponseClaimsInner>>,
    /// Количество заявок, соответствующих параметрам запроса. Без учёта `limit` и `offset`
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl GetV1Claims200Response {
    pub fn new() -> GetV1Claims200Response {
