...
pub struct PostFeedbacksV1Pins200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::OpenapiPinReviewItemResultDataInner>,
}

impl PostFeedbacksV1Pins200Response {
    pub fn new(data: Vec<models::OpenapiPinReviewItemResultDataInner>) -> PostFeedbacksV1Pins200Response {
