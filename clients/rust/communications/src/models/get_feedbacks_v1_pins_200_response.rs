...
pub struct GetFeedbacksV1Pins200Response {
    #[serde(rename = "data")]
...
impl GetFeedbacksV1Pins200Response {
    pub fn new(data: Vec<models::OpenapiPinnedReviewItemResult>) -> GetFeedbacksV1Pins200Response {
