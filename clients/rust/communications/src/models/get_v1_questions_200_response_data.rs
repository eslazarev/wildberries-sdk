...
pub struct GetV1Questions200ResponseData {
    ...
    pub questions: Option<Vec<models::GetV1Questions200ResponseDataQuestionsInner>>,
}

impl GetV1Questions200ResponseData {
    pub fn new() -> GetV1Questions200ResponseData {
