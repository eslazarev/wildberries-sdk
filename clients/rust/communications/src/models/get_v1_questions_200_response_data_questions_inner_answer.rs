...
pub struct GetV1Questions200ResponseDataQuestionsInnerAnswer {
    /// Текст ответа
...
impl GetV1Questions200ResponseDataQuestionsInnerAnswer {
    /// Структура ответа
    pub fn new() -> GetV1Questions200ResponseDataQuestionsInnerAnswer {
