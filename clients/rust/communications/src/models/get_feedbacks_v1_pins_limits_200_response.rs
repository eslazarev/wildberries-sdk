...
pub struct GetFeedbacksV1PinsLimits200Response {
    #[serde(rename = "data")]
    pub data: Box<models::OpenapiSellerLimitsResponseData>,
}

impl GetFeedbacksV1PinsLimits200Response {
    pub fn new(data: models::OpenapiSellerLimitsResponseData) -> GetFeedbacksV1PinsLimits200Response {
