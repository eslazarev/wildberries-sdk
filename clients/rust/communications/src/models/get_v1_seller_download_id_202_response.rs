...
pub struct GetV1SellerDownloadId202Response {
    /// Статус модерации
...
impl GetV1SellerDownloadId202Response {
    pub fn new(moderation_state: String, retry_seconds: i32) -> GetV1SellerDownloadId202Response {
