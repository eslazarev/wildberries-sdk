...
pub struct UpdateUserAccessRequest {
    ...
    #[serde(rename = "usersAccesses")]
    pub users_accesses: Vec<models::UserAccess>,
}

impl UpdateUserAccessRequest {
    pub fn new(users_accesses: Vec<models::UserAccess>) -> UpdateUserAccessRequest {
