...
pub struct PatchV0AuctionNmsRequestNmsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    #[serde(rename = "nms")]
    pub nms: Box<models::PatchV0AuctionNmsRequestNmsInnerNms>,
}

impl PatchV0AuctionNmsRequestNmsInner {
    pub fn new(advert_id: i64, nms: models::PatchV0AuctionNmsRequestNmsInnerNms) -> PatchV0AuctionNmsRequestNmsInner {
