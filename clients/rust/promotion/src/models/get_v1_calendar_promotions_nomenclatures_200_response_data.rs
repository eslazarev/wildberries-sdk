...
pub struct GetV1CalendarPromotionsNomenclatures200ResponseData {
    /// Список товаров
    #[serde(rename = "nomenclatures", skip_serializing_if = "Option::is_none")]
    pub nomenclatures: Option<Vec<models::PromoItemsList>>,
}

impl GetV1CalendarPromotionsNomenclatures200ResponseData {
    /// Данные ответа
    pub fn new() -> GetV1CalendarPromotionsNomenclatures200ResponseData {
