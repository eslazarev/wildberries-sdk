...
pub struct GetV1CalendarPromotionsDetails200ResponseData {
    /// Список акций
    #[serde(rename = "promotions", skip_serializing_if = "Option::is_none")]
    pub promotions: Option<Vec<models::GetV1CalendarPromotionsDetails200ResponseDataPromotionsInner>>,
}

impl GetV1CalendarPromotionsDetails200ResponseData {
    /// Данные ответа
    pub fn new() -> GetV1CalendarPromotionsDetails200ResponseData {
