...
pub struct V0GetNormQueryListResponse {
    #[serde(rename = "items", deserialize_with = "Option::deserialize")]
    pub items: Option<Vec<models::V0GetNormQueryListResponseItem>>,
}

impl V0GetNormQueryListResponse {
    pub fn new(items: Option<Vec<models::V0GetNormQueryListResponseItem>>) -> V0GetNormQueryListResponse {
