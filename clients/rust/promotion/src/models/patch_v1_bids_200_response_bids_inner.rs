...
pub struct PatchV1Bids200ResponseBidsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    /// Ставки
    #[serde(rename = "nm_bids")]
    pub nm_bids: Vec<models::PatchV1Bids200ResponseBidsInnerNmBidsInner>,
}

impl PatchV1Bids200ResponseBidsInner {
    pub fn new(advert_id: i64, nm_bids: Vec<models::PatchV1Bids200ResponseBidsInnerNmBidsInner>) -> PatchV1Bids200ResponseBidsInner {
