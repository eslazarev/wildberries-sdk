...
pub struct PutV0AuctionPlacementsRequest {
    /// Места размещения в кампаниях
    #[serde(rename = "placements")]
    pub placements: Vec<models::PutV0AuctionPlacementsRequestPlacementsInner>,
}

impl PutV0AuctionPlacementsRequest {
    pub fn new(placements: Vec<models::PutV0AuctionPlacementsRequestPlacementsInner>) -> PutV0AuctionPlacementsRequest {
