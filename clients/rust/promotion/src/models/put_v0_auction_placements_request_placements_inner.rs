...
pub struct PutV0AuctionPlacementsRequestPlacementsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    #[serde(rename = "placements")]
    pub placements: Box<models::PutV0AuctionPlacementsRequestPlacementsInnerPlacements>,
}

impl PutV0AuctionPlacementsRequestPlacementsInner {
    pub fn new(advert_id: i64, placements: models::PutV0AuctionPlacementsRequestPlacementsInnerPlacements) -> PutV0AuctionPlacementsRequestPlacementsInner {
