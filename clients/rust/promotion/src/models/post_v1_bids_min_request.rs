...
pub struct PostV1BidsMinRequest {
    /// ID кампании
...
impl PostV1BidsMinRequest {
    pub fn new(advert_id: i64, nm_ids: Vec<i64>, payment_type: PaymentType, placement_types: Vec<PlacementTypes>) -> PostV1BidsMinRequest {
