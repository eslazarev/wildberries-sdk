...
pub struct V1SetNormQueryBidsSuccessResponseItem {
    /// ID кампании
...
impl V1SetNormQueryBidsSuccessResponseItem {
    pub fn new(advert_id: i32, nm_id: i32, norm_query: String, currency: String) -> V1SetNormQueryBidsSuccessResponseItem {
