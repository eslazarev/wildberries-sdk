...
pub struct GetV1CalendarPromotions200ResponseData {
    /// Список акций
    #[serde(rename = "promotions", skip_serializing_if = "Option::is_none")]
    pub promotions: Option<Vec<models::GetV1CalendarPromotions200ResponseDataPromotionsInner>>,
}

impl GetV1CalendarPromotions200ResponseData {
    /// Данные ответа
    pub fn new() -> GetV1CalendarPromotions200ResponseData {
