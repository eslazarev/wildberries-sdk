...
pub struct PostV1CalendarPromotionsUploadRequestData {
    /// ID акции
...
impl PostV1CalendarPromotionsUploadRequestData {
    /// Данные запроса
    pub fn new() -> PostV1CalendarPromotionsUploadRequestData {
