...
pub struct GetV1Advert200ResponseItemsInner {
    /// ID баннера
    ...
    pub show_hours: Option<Vec<models::GetV1Advert200ResponseItemsInnerShowHoursInner>>,
    /// Уникальный ID медиакампании для работы с ОРД
    #[serde(rename = "Erid", skip_serializing_if = "Option::is_none")]
    pub erid: Option<String>,
}

impl GetV1Advert200ResponseItemsInner {
    pub fn new() -> GetV1Advert200ResponseItemsInner {
