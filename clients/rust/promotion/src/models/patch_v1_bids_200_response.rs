...
pub struct PatchV1Bids200Response {
    /// Результат отработки запроса
    #[serde(rename = "bids")]
    pub bids: Vec<models::PatchV1Bids200ResponseBidsInner>,
    /// Валюта [аккаунта продавца](https://cmp.wildberries.ru/campaigns/finances)
    #[serde(rename = "currency")]
    pub currency: String,
}

impl PatchV1Bids200Response {
    pub fn new(bids: Vec<models::PatchV1Bids200ResponseBidsInner>, currency: String) -> PatchV1Bids200Response {
