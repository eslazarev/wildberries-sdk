...
pub struct PatchV0AuctionNms200ResponseNmsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    #[serde(rename = "nms")]
    pub nms: Box<models::PatchV0AuctionNms200ResponseNmsInnerNms>,
}

impl PatchV0AuctionNms200ResponseNmsInner {
    pub fn new(advert_id: i64, nms: models::PatchV0AuctionNms200ResponseNmsInnerNms) -> PatchV0AuctionNms200ResponseNmsInner {
