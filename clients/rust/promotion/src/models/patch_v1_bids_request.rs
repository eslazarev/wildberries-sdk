...
pub struct PatchV1BidsRequest {
    /// Ставки в кампаниях
    #[serde(rename = "bids")]
    pub bids: Vec<models::PatchV1BidsRequestBidsInner>,
}

impl PatchV1BidsRequest {
    pub fn new(bids: Vec<models::PatchV1BidsRequestBidsInner>) -> PatchV1BidsRequest {
        PatchV1BidsRequest {
            bids,
        }
    }
