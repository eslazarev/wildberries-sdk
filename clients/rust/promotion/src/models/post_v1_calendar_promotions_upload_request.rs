...
pub struct PostV1CalendarPromotionsUploadRequest {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PostV1CalendarPromotionsUploadRequestData>>,
}

impl PostV1CalendarPromotionsUploadRequest {
    pub fn new() -> PostV1CalendarPromotionsUploadRequest {
