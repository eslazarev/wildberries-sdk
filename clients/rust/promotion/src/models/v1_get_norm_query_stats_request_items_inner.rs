...
pub struct V1GetNormQueryStatsRequestItemsInner {
    /// ID кампании
...
impl V1GetNormQueryStatsRequestItemsInner {
    pub fn new(advert_id: i64, nm_id: i64) -> V1GetNormQueryStatsRequestItemsInner {
