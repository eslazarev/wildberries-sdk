...
pub struct V1SetNormQueryBidsResponse {
    #[serde(rename = "success")]
    pub success: Vec<models::V1SetNormQueryBidsSuccessResponseItem>,
    #[serde(rename = "failed")]
    pub failed: Vec<models::NormQueryBidFailResponseItem>,
}

impl V1SetNormQueryBidsResponse {
    pub fn new(success: Vec<models::V1SetNormQueryBidsSuccessResponseItem>, failed: Vec<models::NormQueryBidFailResponseItem>) -> V1SetNormQueryBidsResponse {
