...
pub struct V1GetNormQueryStatsResponseItem {
    /// ID кампании
    ...
    #[serde(rename = "dailyStats", skip_serializing_if = "Option::is_none")]
    pub daily_stats: Option<Vec<models::V1GetNormQueryStatsResponseItemDailyStat>>,
}

impl V1GetNormQueryStatsResponseItem {
    pub fn new(advert_id: i64, nm_id: i64) -> V1GetNormQueryStatsResponseItem {
