...
pub struct V1GetNormQueryStatsResponse {
    #[serde(rename = "items")]
    pub items: Vec<models::V1GetNormQueryStatsResponseItem>,
}

impl V1GetNormQueryStatsResponse {
    pub fn new(items: Vec<models::V1GetNormQueryStatsResponseItem>) -> V1GetNormQueryStatsResponse {
