...
pub struct V0GetNormQueryListRequest {
    #[serde(rename = "items")]
    pub items: Vec<models::V0GetNormQueryListRequestItem>,
}

impl V0GetNormQueryListRequest {
    pub fn new(items: Vec<models::V0GetNormQueryListRequestItem>) -> V0GetNormQueryListRequest {
