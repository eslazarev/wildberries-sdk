...
pub struct PutV0AuctionPlacementsRequestPlacementsInnerPlacements {
...
impl PutV0AuctionPlacementsRequestPlacementsInnerPlacements {
    /// Места размещения
    pub fn new(search: bool, recommendations: bool) -> PutV0AuctionPlacementsRequestPlacementsInnerPlacements {
