...
pub struct PatchV1BidsRequestBidsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    /// Ставки
    #[serde(rename = "nm_bids")]
    pub nm_bids: Vec<models::PatchV1BidsRequestBidsInnerNmBidsInner>,
}

impl PatchV1BidsRequestBidsInner {
    pub fn new(advert_id: i64, nm_bids: Vec<models::PatchV1BidsRequestBidsInnerNmBidsInner>) -> PatchV1BidsRequestBidsInner {
