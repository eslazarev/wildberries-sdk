...
pub struct V0DeleteNormQueryBidsRequest {
    #[serde(rename = "bids")]
    pub bids: Vec<models::V0DeleteNormQueryBidsRequestItem>,
}

impl V0DeleteNormQueryBidsRequest {
    pub fn new(bids: Vec<models::V0DeleteNormQueryBidsRequestItem>) -> V0DeleteNormQueryBidsRequest {
