...
pub struct GetV1PromotionCount200Response {
    /// Данные по кампаниям
    #[serde(rename = "adverts", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub adverts: Option<Option<Vec<models::GetV1PromotionCount200ResponseAdvertsInner>>>,
    /// Общее количество кампаний всех статусов и типов
    #[serde(rename = "all", skip_serializing_if = "Option::is_none")]
    pub all: Option<i32>,
}

impl GetV1PromotionCount200Response {
    pub fn new() -> GetV1PromotionCount200Response {
