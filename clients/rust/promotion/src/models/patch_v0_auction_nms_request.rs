...
pub struct PatchV0AuctionNmsRequest {
    /// Карточки товаров в кампаниях
    #[serde(rename = "nms")]
    pub nms: Vec<models::PatchV0AuctionNmsRequestNmsInner>,
}

impl PatchV0AuctionNmsRequest {
    pub fn new(nms: Vec<models::PatchV0AuctionNmsRequestNmsInner>) -> PatchV0AuctionNmsRequest {
