...
pub struct GetV1Count200Response {
    ...
    pub adverts: Option<Option<Box<models::GetV1Count200ResponseAdverts>>>,
}

impl GetV1Count200Response {
    pub fn new() -> GetV1Count200Response {
