...
pub struct V1SetNormQueryBidsRequest {
    #[serde(rename = "bids")]
    pub bids: Vec<models::V1SetNormQueryBidsRequestItem>,
}

impl V1SetNormQueryBidsRequest {
    pub fn new(bids: Vec<models::V1SetNormQueryBidsRequestItem>) -> V1SetNormQueryBidsRequest {
