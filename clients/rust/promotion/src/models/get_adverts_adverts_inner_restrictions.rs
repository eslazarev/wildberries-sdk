...
pub struct GetAdvertsAdvertsInnerRestrictions {
    /// Можно ли изменять список товаров кампании:   - `true` — да   - `false` — нет 
    #[serde(rename = "can_change_nms", skip_serializing_if = "Option::is_none")]
    pub can_change_nms: Option<bool>,
}

impl GetAdvertsAdvertsInnerRestrictions {
    /// Ограничения кампании
    pub fn new() -> GetAdvertsAdvertsInnerRestrictions {
