...
pub struct V0DeleteNormQueryBidsRequestItem {
    /// ID кампании
...
impl V0DeleteNormQueryBidsRequestItem {
    pub fn new(advert_id: i32, nm_id: i32, norm_query: String) -> V0DeleteNormQueryBidsRequestItem {
