...
pub struct V2BudgetResponse {
    /// Данные по кампаниям
    #[serde(rename = "adverts", deserialize_with = "Option::deserialize")]
    pub adverts: Option<Vec<models::V1BudgetAdvert>>,
}

impl V2BudgetResponse {
    pub fn new(adverts: Option<Vec<models::V1BudgetAdvert>>) -> V2BudgetResponse {
        V2BudgetResponse {
            adverts,
        }
    }
