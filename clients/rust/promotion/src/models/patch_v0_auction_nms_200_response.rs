...
pub struct PatchV0AuctionNms200Response {
    /// Результат отработки запроса
    #[serde(rename = "nms")]
    pub nms: Vec<models::PatchV0AuctionNms200ResponseNmsInner>,
}

impl PatchV0AuctionNms200Response {
    pub fn new(nms: Vec<models::PatchV0AuctionNms200ResponseNmsInner>) -> PatchV0AuctionNms200Response {
