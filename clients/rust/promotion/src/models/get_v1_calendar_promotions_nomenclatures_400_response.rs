...
pub struct GetV1CalendarPromotionsNomenclatures400Response {
    /// Текст ошибки
    #[serde(rename = "errorText", skip_serializing_if = "Option::is_none")]
    pub error_text: Option<String>,
}

impl GetV1CalendarPromotionsNomenclatures400Response {
    pub fn new() -> GetV1CalendarPromotionsNomenclatures400Response {
