...
pub struct GetV1Advert200Response {
    /// ID медиакампании
    ...
    pub extended: Option<Box<models::GetV1Advert200ResponseExtended>>,
    /// Информация о баннере. <br> Наличие в ответе тех или иных полей зависит от конфигурации медиакампании. 
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<models::GetV1Advert200ResponseItemsInner>>,
}

impl GetV1Advert200Response {
    pub fn new() -> GetV1Advert200Response {
