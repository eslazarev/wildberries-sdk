...
pub struct V0BidRecommendationNormQuery {
    /// Поисковый кластер
    #[serde(rename = "normQuery", skip_serializing_if = "Option::is_none")]
    pub norm_query: Option<String>,
    #[serde(rename = "reachMax", skip_serializing_if = "Option::is_none")]
    pub reach_max: Option<Box<models::V0BidRecommendationReachMax>>,
    #[serde(rename = "reachMedium", skip_serializing_if = "Option::is_none")]
    pub reach_medium: Option<Box<models::V0BidRecommendationReachMedium>>,
    #[serde(rename = "reachMin", skip_serializing_if = "Option::is_none")]
    pub reach_min: Option<Box<models::V0BidRecommendationReachMin>>,
}

impl V0BidRecommendationNormQuery {
    pub fn new() -> V0BidRecommendationNormQuery {
