...
pub struct PostV1BidsMin200Response {
    /// Список карточек товаров со ставками
    #[serde(rename = "bids")]
    pub bids: Vec<models::PostV1BidsMin200ResponseBidsInner>,
}

impl PostV1BidsMin200Response {
    pub fn new(bids: Vec<models::PostV1BidsMin200ResponseBidsInner>) -> PostV1BidsMin200Response {
