...
pub struct GetV1CalendarPromotions200ResponseDataPromotionsInner {
    /// ID акции
...
impl GetV1CalendarPromotions200ResponseDataPromotionsInner {
    pub fn new() -> GetV1CalendarPromotions200ResponseDataPromotionsInner {
