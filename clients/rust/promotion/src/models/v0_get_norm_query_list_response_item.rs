...
pub struct V0GetNormQueryListResponseItem {
    /// ID кампании
    ...
    pub norm_queries: Option<Box<models::V0GetNormQueryListResponseItemNormQueries>>,
}

impl V0GetNormQueryListResponseItem {
    pub fn new() -> V0GetNormQueryListResponseItem {
