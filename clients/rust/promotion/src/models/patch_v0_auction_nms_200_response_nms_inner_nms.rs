...
pub struct PatchV0AuctionNms200ResponseNmsInnerNms {
...
impl PatchV0AuctionNms200ResponseNmsInnerNms {
    /// Карточки товаров
    pub fn new(added: Vec<i32>, deleted: Vec<i32>) -> PatchV0AuctionNms200ResponseNmsInnerNms {
