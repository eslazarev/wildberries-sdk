...
pub struct ApiStatusSetCustomsDeclarationResponse {
    ...
    pub errors: Option<Vec<models::ApiBatchCustomsDeclarationErrorResponse>>,
}

impl ApiStatusSetCustomsDeclarationResponse {
    pub fn new(order_id: i32, is_error: bool) -> ApiStatusSetCustomsDeclarationResponse {
