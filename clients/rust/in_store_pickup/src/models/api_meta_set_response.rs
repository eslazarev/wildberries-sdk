...
pub struct ApiMetaSetResponse {
    ...
    pub errors: Option<Vec<models::ApiMetaErrorResponse>>,
}

impl ApiMetaSetResponse {
    pub fn new(order_id: i32, is_error: bool) -> ApiMetaSetResponse {
        ApiMetaSetResponse {
            order_id,
            is_error,
            errors: None,
