...
pub struct SearchReportItemReq {
    ...
    #[serde(rename = "params")]
    pub params: Box<models::SearchReportItemReqParams>,
}

impl SearchReportItemReq {
    pub fn new(id: uuid::Uuid, report_type: String, params: models::SearchReportItemReqParams) -> SearchReportItemReq {
        SearchReportItemReq {
            id,
            report_type,
