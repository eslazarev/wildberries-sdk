...
pub struct PostV2ItemRating200Response {
    #[serde(rename = "data")]
    pub data: Box<models::ItemRatingResponse>,
}

impl PostV2ItemRating200Response {
    pub fn new(data: models::ItemRatingResponse) -> PostV2ItemRating200Response {
