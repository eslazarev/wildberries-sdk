...
pub struct PostV2SearchReportReport200Response {
    #[serde(rename = "data")]
    pub data: Box<models::MainResponse>,
}

impl PostV2SearchReportReport200Response {
    pub fn new(data: models::MainResponse) -> PostV2SearchReportReport200Response {
