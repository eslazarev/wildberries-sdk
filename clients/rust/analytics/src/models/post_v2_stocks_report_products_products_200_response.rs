...
pub struct PostV2StocksReportProductsProducts200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableItemResponse>,
}

impl PostV2StocksReportProductsProducts200Response {
    pub fn new(data: models::TableItemResponse) -> PostV2StocksReportProductsProducts200Response {
