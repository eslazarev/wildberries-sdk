...
pub struct DistributionTableItemV1 {
    /// Артикул WB
    ...
    pub feedback_rating: Option<Box<models::DistributionTableItemV1FeedbackRating>>,
    #[serde(rename = "feedbackCount", skip_serializing_if = "Option::is_none")]
    pub feedback_count: Option<Box<models::DistributionTableItemV1FeedbackCount>>,
    #[serde(rename = "fiveStar", skip_serializing_if = "Option::is_none")]
    pub five_star: Option<Box<models::DistributionTableItemV1FiveStar>>,
    #[serde(rename = "fourStar", skip_serializing_if = "Option::is_none")]
    pub four_star: Option<Box<models::DistributionTableItemV1FourStar>>,
    #[serde(rename = "threeStar", skip_serializing_if = "Option::is_none")]
    pub three_star: Option<Box<models::DistributionTableItemV1ThreeStar>>,
    #[serde(rename = "twoStar", skip_serializing_if = "Option::is_none")]
    pub two_star: Option<Box<models::DistributionTableItemV1TwoStar>>,
    #[serde(rename = "oneStar", skip_serializing_if = "Option::is_none")]
    pub one_star: Option<Box<models::DistributionTableItemV1OneStar>>,
    /// Отзывы, исключённые из рейтинга
    #[serde(rename = "disqualified", skip_serializing_if = "Option::is_none")]
    pub disqualified: Option<i32>,
}

impl DistributionTableItemV1 {
    pub fn new() -> DistributionTableItemV1 {
