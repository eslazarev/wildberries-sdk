...
pub struct PostAnalyticsV1StocksReportSellerWarehouses200Response {
    #[serde(rename = "data")]
    pub data: Box<models::InventorySellerResponse>,
}

impl PostAnalyticsV1StocksReportSellerWarehouses200Response {
    pub fn new(data: models::InventorySellerResponse) -> PostAnalyticsV1StocksReportSellerWarehouses200Response {
