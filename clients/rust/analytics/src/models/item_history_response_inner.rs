...
pub struct ItemHistoryResponseInner {
    #[serde(rename = "product")]
    pub product: Box<models::ItemHistoryResponseInnerProduct>,
...
impl ItemHistoryResponseInner {
    pub fn new(product: models::ItemHistoryResponseInnerProduct, history: Vec<models::History>, currency: String) -> ItemHistoryResponseInner {
