...
pub struct ItemOrdersResponse {
    /// Итог по товарам
    #[serde(rename = "total")]
    pub total: Vec<models::ItemOrdersMetrics>,
    /// Элементы таблицы
    #[serde(rename = "items")]
    pub items: Vec<models::ItemOrdersTextItem>,
}

impl ItemOrdersResponse {
    pub fn new(total: Vec<models::ItemOrdersMetrics>, items: Vec<models::ItemOrdersTextItem>) -> ItemOrdersResponse {
        ItemOrdersResponse {
            total,
            items,
        }
