...
pub struct PostV1OrderFeed200Response {
    #[serde(rename = "data")]
    pub data: Box<models::OrderFeedResponse>,
}

impl PostV1OrderFeed200Response {
    pub fn new(data: models::OrderFeedResponse) -> PostV1OrderFeed200Response {
