...
impl StatisticWbClub {
    pub fn new(order_count: u32, order_sum: u32, buyout_sum: u32, buyout_count: u32, cancel_sum: u32, cancel_count: u32, avg_price: u32, buyout_percent: u32, avg_order_count_per_day: f64) -> StatisticWbClub {
        StatisticWbClub {
            order_count,
            order_sum,
            buyout_sum,
