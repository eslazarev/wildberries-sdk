...
pub struct ItemsResponseProductsInnerStatistic {
...
impl ItemsResponseProductsInnerStatistic {
    pub fn new(selected: models::StatisticsSelected) -> ItemsResponseProductsInnerStatistic {
