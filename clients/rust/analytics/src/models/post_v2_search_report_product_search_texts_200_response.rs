...
pub struct PostV2SearchReportProductSearchTexts200Response {
    #[serde(rename = "data")]
    pub data: Box<models::ItemSearchTextsResponse>,
}

impl PostV2SearchReportProductSearchTexts200Response {
    pub fn new(data: models::ItemSearchTextsResponse) -> PostV2SearchReportProductSearchTexts200Response {
