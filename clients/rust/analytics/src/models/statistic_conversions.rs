...
pub struct StatisticConversions {
...
impl StatisticConversions {
    pub fn new(add_to_cart_percent: i32, cart_to_order_percent: i32, buyout_percent: i32) -> StatisticConversions {
