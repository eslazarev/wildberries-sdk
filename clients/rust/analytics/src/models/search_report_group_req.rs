...
pub struct SearchReportGroupReq {
    ...
    #[serde(rename = "params")]
    pub params: Box<models::SearchReportGroupReqParams>,
}

impl SearchReportGroupReq {
    pub fn new(id: uuid::Uuid, report_type: String, params: models::SearchReportGroupReqParams) -> SearchReportGroupReq {
