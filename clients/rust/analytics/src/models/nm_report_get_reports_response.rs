...
pub struct NmReportGetReportsResponse {
    #[serde(rename = "data")]
    pub data: Vec<models::NmReportGetReportsResponseDataInner>,
}

impl NmReportGetReportsResponse {
    pub fn new(data: Vec<models::NmReportGetReportsResponseDataInner>) -> NmReportGetReportsResponse {
