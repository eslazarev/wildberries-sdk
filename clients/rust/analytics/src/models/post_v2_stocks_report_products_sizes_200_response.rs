...
pub struct PostV2StocksReportProductsSizes200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableSizeResponse>,
}

impl PostV2StocksReportProductsSizes200Response {
    pub fn new(data: models::TableSizeResponse) -> PostV2StocksReportProductsSizes200Response {
