...
pub struct PostV3SalesFunnelGroupedHistory200Response {
    /// Статистика
    #[serde(rename = "data")]
    pub data: Vec<models::ItemHistoryResponseInner>,
}

impl PostV3SalesFunnelGroupedHistory200Response {
    pub fn new(data: Vec<models::ItemHistoryResponseInner>) -> PostV3SalesFunnelGroupedHistory200Response {
