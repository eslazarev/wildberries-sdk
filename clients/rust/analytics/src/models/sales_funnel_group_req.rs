...
pub struct SalesFunnelGroupReq {
    ...
    #[serde(rename = "params")]
    pub params: Box<models::SalesFunnelGroupReqParams>,
}

impl SalesFunnelGroupReq {
    pub fn new(id: uuid::Uuid, report_type: String, params: models::SalesFunnelGroupReqParams) -> SalesFunnelGroupReq {
        SalesFunnelGroupReq {
            id,
            report_type,
