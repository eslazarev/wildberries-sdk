...
pub struct TableSearchTextItemAllOfMedianPosition {
...
impl TableSearchTextItemAllOfMedianPosition {
    ...
    pub fn new(current: i32) -> TableSearchTextItemAllOfMedianPosition {
