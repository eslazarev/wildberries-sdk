...
pub struct PostV2StocksReportProductsGroups200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableGroupResponseSt>,
}

impl PostV2StocksReportProductsGroups200Response {
    pub fn new(data: models::TableGroupResponseSt) -> PostV2StocksReportProductsGroups200Response {
