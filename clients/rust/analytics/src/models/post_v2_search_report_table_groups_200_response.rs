...
pub struct PostV2SearchReportTableGroups200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableGroupResponse>,
}

impl PostV2SearchReportTableGroups200Response {
    pub fn new(data: models::TableGroupResponse) -> PostV2SearchReportTableGroups200Response {
