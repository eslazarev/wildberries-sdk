...
pub struct PostV2SearchReportTableDetails200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableDetailsResponse>,
}

impl PostV2SearchReportTableDetails200Response {
    pub fn new(data: models::TableDetailsResponse) -> PostV2SearchReportTableDetails200Response {
