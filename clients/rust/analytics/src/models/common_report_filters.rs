...
pub struct CommonReportFilters {
...
impl CommonReportFilters {
    /// Общие фильтры по отчёту
    pub fn new(current_period: models::PeriodInv, stock_type: models::StockType, skip_deleted_nm: bool, availability_filters: Vec<AvailabilityFilters>, order_by: models::TableOrderBy) -> CommonReportFilters {
        CommonReportFilters {
            nm_ids: None,
            subject_ids: None,
            brand_names: None,
