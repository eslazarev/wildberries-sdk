...
pub struct WbClubMetricsDynamic {
...
impl WbClubMetricsDynamic {
    pub fn new(order_count: i32, order_sum: i32, buyout_sum: i32, buyout_count: i32, cancel_sum: i32, cancel_count: i32, avg_price: i32, buyout_percent: i32, avg_order_count_per_day: f64) -> WbClubMetricsDynamic {
