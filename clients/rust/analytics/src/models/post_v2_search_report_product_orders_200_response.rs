...
pub struct PostV2SearchReportProductOrders200Response {
    #[serde(rename = "data")]
    pub data: Box<models::ItemOrdersResponse>,
}

impl PostV2SearchReportProductOrders200Response {
    pub fn new(data: models::ItemOrdersResponse) -> PostV2SearchReportProductOrders200Response {
