...
pub struct PostV3SalesFunnelProducts200Response {
    #[serde(rename = "data")]
    pub data: Box<models::PostV3SalesFunnelProducts200ResponseData>,
}

impl PostV3SalesFunnelProducts200Response {
    pub fn new(data: models::PostV3SalesFunnelProducts200ResponseData) -> PostV3SalesFunnelProducts200Response {
