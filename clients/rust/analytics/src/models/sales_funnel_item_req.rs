...
pub struct SalesFunnelItemReq {
    ...
    #[serde(rename = "params")]
    pub params: Box<models::SalesFunnelItemReqParams>,
}

impl SalesFunnelItemReq {
    pub fn new(id: uuid::Uuid, report_type: String, params: models::SalesFunnelItemReqParams) -> SalesFunnelItemReq {
        SalesFunnelItemReq {
            id,
            report_type,
