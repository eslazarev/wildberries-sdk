...
pub struct TableSearchTextItemAllOfOpenCard {
...
impl TableSearchTextItemAllOfOpenCard {
    /// Количество переходов в карточку товара из поиска
    pub fn new(current: i32, percentile: i32) -> TableSearchTextItemAllOfOpenCard {
