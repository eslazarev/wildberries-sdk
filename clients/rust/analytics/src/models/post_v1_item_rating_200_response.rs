...
pub struct PostV1ItemRating200Response {
    #[serde(rename = "data")]
    pub data: Box<models::ItemRatingResponseV1>,
}

impl PostV1ItemRating200Response {
    pub fn new(data: models::ItemRatingResponseV1) -> PostV1ItemRating200Response {
