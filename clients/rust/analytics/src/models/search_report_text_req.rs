...
pub struct SearchReportTextReq {
    ...
    #[serde(rename = "params")]
    pub params: Box<models::SearchReportTextReqParams>,
}

impl SearchReportTextReq {
    pub fn new(id: uuid::Uuid, report_type: String, params: models::SearchReportTextReqParams) -> SearchReportTextReq {
        SearchReportTextReq {
            id,
            report_type,
