...
pub struct SearchReportPositionClustersSecondHundred {
...
impl SearchReportPositionClustersSecondHundred {
    /// от 101 до 200
    pub fn new(current: i32) -> SearchReportPositionClustersSecondHundred {
