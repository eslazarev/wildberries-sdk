...
pub struct ApiMarketplaceV3DbsOrdersStickersPostRequest {
    /// Список ID сборочных заданий
    #[serde(rename = "orders")]
    pub orders: Vec<i64>,
}

impl ApiMarketplaceV3DbsOrdersStickersPostRequest {
    pub fn new(orders: Vec<i64>) -> ApiMarketplaceV3DbsOrdersStickersPostRequest {
