...
pub struct ApiMarketplaceV3DbsOrdersMetaCustomsDeclarationPostRequest {
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::ApiMarketplaceV3DbsOrdersMetaCustomsDeclarationPostRequestOrdersInner>>,
}

impl ApiMarketplaceV3DbsOrdersMetaCustomsDeclarationPostRequest {
    pub fn new() -> ApiMarketplaceV3DbsOrdersMetaCustomsDeclarationPostRequest {
