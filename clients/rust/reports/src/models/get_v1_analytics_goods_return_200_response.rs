...
pub struct GetV1AnalyticsGoodsReturn200Response {
    /// Отчёт
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::GetV1AnalyticsGoodsReturn200ResponseReportInner>>,
}

impl GetV1AnalyticsGoodsReturn200Response {
    pub fn new() -> GetV1AnalyticsGoodsReturn200Response {
