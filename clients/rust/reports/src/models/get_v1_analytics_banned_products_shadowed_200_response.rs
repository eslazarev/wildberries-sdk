...
pub struct GetV1AnalyticsBannedProductsShadowed200Response {
    /// Отчёт
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::GetV1AnalyticsBannedProductsShadowed200ResponseReportInner>>,
}

impl GetV1AnalyticsBannedProductsShadowed200Response {
    pub fn new() -> GetV1AnalyticsBannedProductsShadowed200Response {
