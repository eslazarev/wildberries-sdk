...
pub struct GetV1AnalyticsRegionSale200Response {
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::GetV1AnalyticsRegionSale200ResponseReportInner>>,
}

impl GetV1AnalyticsRegionSale200Response {
    pub fn new() -> GetV1AnalyticsRegionSale200Response {
