...
pub struct MeasurementPenalties {
    #[serde(rename = "data")]
    pub data: Box<models::MeasurementPenaltiesData>,
}

impl MeasurementPenalties {
    pub fn new(data: models::MeasurementPenaltiesData) -> MeasurementPenalties {
