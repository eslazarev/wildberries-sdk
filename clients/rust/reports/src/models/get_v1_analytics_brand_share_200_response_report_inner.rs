...
pub struct GetV1AnalyticsBrandShare200ResponseReportInner {
    /// Дата
...
impl GetV1AnalyticsBrandShare200ResponseReportInner {
    pub fn new() -> GetV1AnalyticsBrandShare200ResponseReportInner {
