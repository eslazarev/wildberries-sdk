...
pub struct ApiV1AnalyticsGoodsReturnGet200Response {
    /// Отчёт
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::ApiV1AnalyticsGoodsReturnGet200ResponseReportInner>>,
}

impl ApiV1AnalyticsGoodsReturnGet200Response {
    pub fn new() -> ApiV1AnalyticsGoodsReturnGet200Response {
