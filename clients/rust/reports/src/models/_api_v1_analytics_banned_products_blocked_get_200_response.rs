...
pub struct ApiV1AnalyticsBannedProductsBlockedGet200Response {
    /// Отчёт
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::ApiV1AnalyticsBannedProductsBlockedGet200ResponseReportInner>>,
}

impl ApiV1AnalyticsBannedProductsBlockedGet200Response {
    pub fn new() -> ApiV1AnalyticsBannedProductsBlockedGet200Response {
