...
pub struct ApiV1AnalyticsRegionSaleGet200Response {
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::ApiV1AnalyticsRegionSaleGet200ResponseReportInner>>,
}

impl ApiV1AnalyticsRegionSaleGet200Response {
    pub fn new() -> ApiV1AnalyticsRegionSaleGet200Response {
