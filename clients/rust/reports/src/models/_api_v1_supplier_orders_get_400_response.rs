...
#[serde(untagged)]
pub enum ApiV1SupplierOrdersGet400Response {
    ResponseErrorStatistics(Box<models::ResponseErrorStatistics>),
    ResponseErrorStatistics2(Box<models::ResponseErrorStatistics2>),
}

impl Default for ApiV1SupplierOrdersGet400Response {
    fn default() -> Self {
        Self::ResponseErrorStatistics(Default::default())
    }
}
