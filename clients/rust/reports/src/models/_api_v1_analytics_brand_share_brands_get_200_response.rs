...
pub struct ApiV1AnalyticsBrandShareBrandsGet200Response {
    /// Список брендов
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<String>>,
}

impl ApiV1AnalyticsBrandShareBrandsGet200Response {
    pub fn new() -> ApiV1AnalyticsBrandShareBrandsGet200Response {
