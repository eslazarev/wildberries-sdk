...
pub struct ApiV1AnalyticsBrandShareGet200Response {
    /// Отчёт
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::ApiV1AnalyticsBrandShareGet200ResponseReportInner>>,
}

impl ApiV1AnalyticsBrandShareGet200Response {
    pub fn new() -> ApiV1AnalyticsBrandShareGet200Response {
