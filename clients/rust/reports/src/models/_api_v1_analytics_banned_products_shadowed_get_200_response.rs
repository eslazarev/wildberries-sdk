...
pub struct ApiV1AnalyticsBannedProductsShadowedGet200Response {
    /// Отчёт
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::ApiV1AnalyticsBannedProductsShadowedGet200ResponseReportInner>>,
}

impl ApiV1AnalyticsBannedProductsShadowedGet200Response {
    pub fn new() -> ApiV1AnalyticsBannedProductsShadowedGet200Response {
