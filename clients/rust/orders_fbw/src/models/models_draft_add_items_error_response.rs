...
pub struct ModelsDraftAddItemsErrorResponse {
    /// Список невалидных баркодов с ошибками
    #[serde(rename = "results")]
    pub results: Vec<models::ModelsDraftAddItemsResultItem>,
}

impl ModelsDraftAddItemsErrorResponse {
    pub fn new(results: Vec<models::ModelsDraftAddItemsResultItem>) -> ModelsDraftAddItemsErrorResponse {
