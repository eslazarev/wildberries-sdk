...
pub struct ModelsDraftDeleteItemsErrorResponse {
    #[serde(rename = "results")]
    pub results: Vec<String>,
}

impl ModelsDraftDeleteItemsErrorResponse {
    pub fn new(results: Vec<String>) -> ModelsDraftDeleteItemsErrorResponse {
