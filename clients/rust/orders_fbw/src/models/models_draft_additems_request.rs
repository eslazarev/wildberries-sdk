...
pub struct ModelsDraftAdditemsRequest {
    /// Список товаров
    #[serde(rename = "items")]
    pub items: Vec<models::ModelsItem>,
}

impl ModelsDraftAdditemsRequest {
    pub fn new(items: Vec<models::ModelsItem>) -> ModelsDraftAdditemsRequest {
