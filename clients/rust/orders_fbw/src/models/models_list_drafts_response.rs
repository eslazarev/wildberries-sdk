...
pub struct ModelsListDraftsResponse {
    /// Общее количество черновиков
    #[serde(rename = "total")]
    pub total: i32,
    /// Список черновиков
    #[serde(rename = "drafts")]
    pub drafts: Vec<models::ModelsDraftItem>,
}

impl ModelsListDraftsResponse {
    pub fn new(total: i32, drafts: Vec<models::ModelsDraftItem>) -> ModelsListDraftsResponse {
