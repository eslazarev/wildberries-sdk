...
pub struct PostV3DbsOrdersStickers200Response {
    /// Стикеры
    #[serde(rename = "stickers", skip_serializing_if = "Option::is_none")]
    pub stickers: Option<Vec<models::PostV3DbsOrdersStickers200ResponseStickersInner>>,
}

impl PostV3DbsOrdersStickers200Response {
    pub fn new() -> PostV3DbsOrdersStickers200Response {
