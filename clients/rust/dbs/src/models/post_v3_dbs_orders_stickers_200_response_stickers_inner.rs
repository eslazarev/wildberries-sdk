...
pub struct PostV3DbsOrdersStickers200ResponseStickersInner {
...
impl PostV3DbsOrdersStickers200ResponseStickersInner {
    pub fn new(order_id: i64, part_a: String, part_b: String, barcode: String, file: String) -> PostV3DbsOrdersStickers200ResponseStickersInner {
