...
pub struct ApiOrdersCodeRequest {
    #[serde(rename = "orders")]
    pub orders: Vec<models::ApiOrderCodeRequest>,
}

impl ApiOrdersCodeRequest {
    pub fn new(orders: Vec<models::ApiOrderCodeRequest>) -> ApiOrdersCodeRequest {
