...
// checks if the PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner{}

// PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner struct for PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner
type PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner struct {
...
// NewPostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner instantiates a new PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner() *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner {
	this := PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner{}
	return &this
}

// NewPostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInnerWithDefaults instantiates a new PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInnerWithDefaults() *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner {
	this := PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner{}
	return &this
}

// GetDate returns the Date field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) GetDate() string {
...
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) GetDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) HasDate() bool {
...
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) SetDate(v string) {
	o.Date.Set(&v)
}
// SetDateNil sets the value for Date to be an explicit nil
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) SetDateNil() {
	o.Date.Set(nil)
}

// UnsetDate ensures that no value is present for Date, not even an explicit nil
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) UnsetDate() {
	o.Date.Unset()
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) SetCode(v string) {
	o.Code = &v
}

func (o PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) MarshalJSON() ([]byte, error) {
...
func (o PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) ToMap() (map[string]interface{}, error) {
...
type NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner struct {
	value *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner
	isSet bool
}

func (v NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) Get() *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner {
	return v.value
}

func (v *NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) Set(val *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner(val *PostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) *NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner {
	return &NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner{value: val, isSet: true}
}

func (v NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostV3OrdersStatusHistory200ResponseOrdersInnerStatusesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
