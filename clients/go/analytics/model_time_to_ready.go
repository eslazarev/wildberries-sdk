...
var _ MappedNullable = &TimeToReady{}
...
// NewTimeToReadyWithDefaults instantiates a new TimeToReady object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTimeToReadyWithDefaults() *TimeToReady {
	this := TimeToReady{}
	return &this
}
...
func (v NullableTimeToReady) Get() *TimeToReady {
	return v.value
}

func (v *NullableTimeToReady) Set(val *TimeToReady) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeToReady) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeToReady) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeToReady(val *TimeToReady) *NullableTimeToReady {
	return &NullableTimeToReady{value: val, isSet: true}
}

func (v NullableTimeToReady) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeToReady) UnmarshalJSON(src []byte) error {
	v.isSet = true
