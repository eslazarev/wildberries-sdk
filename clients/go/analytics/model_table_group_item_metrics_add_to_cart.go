...
var _ MappedNullable = &TableGroupItemMetricsAddToCart{}
...
// NewTableGroupItemMetricsAddToCartWithDefaults instantiates a new TableGroupItemMetricsAddToCart object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTableGroupItemMetricsAddToCartWithDefaults() *TableGroupItemMetricsAddToCart {
	this := TableGroupItemMetricsAddToCart{}
	return &this
}
...
func (o *TableGroupItemMetricsAddToCart) GetDynamics() int32 {
...
// and a boolean to check if the value has been set.
func (o *TableGroupItemMetricsAddToCart) GetDynamicsOk() (*int32, bool) {
	if o == nil || IsNil(o.Dynamics) {
		return nil, false
	}
...
func (o *TableGroupItemMetricsAddToCart) HasDynamics() bool {
	if o != nil && !IsNil(o.Dynamics) {
		return true
	}
...
func (o *TableGroupItemMetricsAddToCart) SetDynamics(v int32) {
	o.Dynamics = &v
}

func (o TableGroupItemMetricsAddToCart) MarshalJSON() ([]byte, error) {
...
type NullableTableGroupItemMetricsAddToCart struct {
	value *TableGroupItemMetricsAddToCart
	isSet bool
}

func (v NullableTableGroupItemMetricsAddToCart) Get() *TableGroupItemMetricsAddToCart {
	return v.value
}

func (v *NullableTableGroupItemMetricsAddToCart) Set(val *TableGroupItemMetricsAddToCart) {
	v.value = val
	v.isSet = true
}

func (v NullableTableGroupItemMetricsAddToCart) IsSet() bool {
	return v.isSet
}

func (v *NullableTableGroupItemMetricsAddToCart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTableGroupItemMetricsAddToCart(val *TableGroupItemMetricsAddToCart) *NullableTableGroupItemMetricsAddToCart {
	return &NullableTableGroupItemMetricsAddToCart{value: val, isSet: true}
}

func (v NullableTableGroupItemMetricsAddToCart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTableGroupItemMetricsAddToCart) UnmarshalJSON(src []byte) error {
	v.isSet = true
