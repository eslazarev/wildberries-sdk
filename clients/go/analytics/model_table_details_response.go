...
var _ MappedNullable = &TableDetailsResponse{}
...
// NewTableDetailsResponseWithDefaults instantiates a new TableDetailsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTableDetailsResponseWithDefaults() *TableDetailsResponse {
	this := TableDetailsResponse{}
	return &this
}
...
type NullableTableDetailsResponse struct {
	value *TableDetailsResponse
	isSet bool
}

func (v NullableTableDetailsResponse) Get() *TableDetailsResponse {
	return v.value
}

func (v *NullableTableDetailsResponse) Set(val *TableDetailsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTableDetailsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTableDetailsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTableDetailsResponse(val *TableDetailsResponse) *NullableTableDetailsResponse {
	return &NullableTableDetailsResponse{value: val, isSet: true}
}

func (v NullableTableDetailsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTableDetailsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
