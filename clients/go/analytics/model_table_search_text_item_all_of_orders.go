...
var _ MappedNullable = &TableSearchTextItemAllOfOrders{}
...
// NewTableSearchTextItemAllOfOrdersWithDefaults instantiates a new TableSearchTextItemAllOfOrders object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTableSearchTextItemAllOfOrdersWithDefaults() *TableSearchTextItemAllOfOrders {
	this := TableSearchTextItemAllOfOrders{}
	return &this
}
...
func (o *TableSearchTextItemAllOfOrders) GetDynamics() int32 {
...
// and a boolean to check if the value has been set.
func (o *TableSearchTextItemAllOfOrders) GetDynamicsOk() (*int32, bool) {
	if o == nil || IsNil(o.Dynamics) {
		return nil, false
	}
...
func (o *TableSearchTextItemAllOfOrders) HasDynamics() bool {
	if o != nil && !IsNil(o.Dynamics) {
		return true
	}
...
func (o *TableSearchTextItemAllOfOrders) SetDynamics(v int32) {
	o.Dynamics = &v
}
...
type NullableTableSearchTextItemAllOfOrders struct {
	value *TableSearchTextItemAllOfOrders
	isSet bool
}

func (v NullableTableSearchTextItemAllOfOrders) Get() *TableSearchTextItemAllOfOrders {
	return v.value
}

func (v *NullableTableSearchTextItemAllOfOrders) Set(val *TableSearchTextItemAllOfOrders) {
	v.value = val
	v.isSet = true
}

func (v NullableTableSearchTextItemAllOfOrders) IsSet() bool {
	return v.isSet
}

func (v *NullableTableSearchTextItemAllOfOrders) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTableSearchTextItemAllOfOrders(val *TableSearchTextItemAllOfOrders) *NullableTableSearchTextItemAllOfOrders {
	return &NullableTableSearchTextItemAllOfOrders{value: val, isSet: true}
}

func (v NullableTableSearchTextItemAllOfOrders) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTableSearchTextItemAllOfOrders) UnmarshalJSON(src []byte) error {
	v.isSet = true
