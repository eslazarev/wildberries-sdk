...
// checks if the PostV1BudgetDepositRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostV1BudgetDepositRequest{}

// PostV1BudgetDepositRequest struct for PostV1BudgetDepositRequest
type PostV1BudgetDepositRequest struct {
...
// NewPostV1BudgetDepositRequest instantiates a new PostV1BudgetDepositRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostV1BudgetDepositRequest() *PostV1BudgetDepositRequest {
	this := PostV1BudgetDepositRequest{}
	return &this
}

// NewPostV1BudgetDepositRequestWithDefaults instantiates a new PostV1BudgetDepositRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostV1BudgetDepositRequestWithDefaults() *PostV1BudgetDepositRequest {
	this := PostV1BudgetDepositRequest{}
	return &this
}

// GetSum returns the Sum field value if set, zero value otherwise.
func (o *PostV1BudgetDepositRequest) GetSum() int32 {
...
func (o *PostV1BudgetDepositRequest) GetSumOk() (*int32, bool) {
	if o == nil || IsNil(o.Sum) {
		return nil, false
	}
	return o.Sum, true
...
func (o *PostV1BudgetDepositRequest) HasSum() bool {
	if o != nil && !IsNil(o.Sum) {
		return true
	}
...
func (o *PostV1BudgetDepositRequest) SetSum(v int32) {
	o.Sum = &v
}

// GetCashbackSum returns the CashbackSum field value if set, zero value otherwise.
func (o *PostV1BudgetDepositRequest) GetCashbackSum() int32 {
...
// and a boolean to check if the value has been set.
func (o *PostV1BudgetDepositRequest) GetCashbackSumOk() (*int32, bool) {
	if o == nil || IsNil(o.CashbackSum) {
		return nil, false
	}
...
func (o *PostV1BudgetDepositRequest) HasCashbackSum() bool {
	if o != nil && !IsNil(o.CashbackSum) {
		return true
	}
...
func (o *PostV1BudgetDepositRequest) SetCashbackSum(v int32) {
	o.CashbackSum = &v
}

// GetCashbackPercent returns the CashbackPercent field value if set, zero value otherwise.
func (o *PostV1BudgetDepositRequest) GetCashbackPercent() int32 {
...
// and a boolean to check if the value has been set.
func (o *PostV1BudgetDepositRequest) GetCashbackPercentOk() (*int32, bool) {
	if o == nil || IsNil(o.CashbackPercent) {
		return nil, false
	}
...
func (o *PostV1BudgetDepositRequest) HasCashbackPercent() bool {
	if o != nil && !IsNil(o.CashbackPercent) {
		return true
	}
...
func (o *PostV1BudgetDepositRequest) SetCashbackPercent(v int32) {
	o.CashbackPercent = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *PostV1BudgetDepositRequest) GetType() int32 {
...
// and a boolean to check if the value has been set.
func (o *PostV1BudgetDepositRequest) GetTypeOk() (*int32, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *PostV1BudgetDepositRequest) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *PostV1BudgetDepositRequest) SetType(v int32) {
	o.Type = &v
}

// GetReturn returns the Return field value if set, zero value otherwise.
func (o *PostV1BudgetDepositRequest) GetReturn() bool {
...
// and a boolean to check if the value has been set.
func (o *PostV1BudgetDepositRequest) GetReturnOk() (*bool, bool) {
	if o == nil || IsNil(o.Return) {
		return nil, false
	}
...
func (o *PostV1BudgetDepositRequest) HasReturn() bool {
	if o != nil && !IsNil(o.Return) {
		return true
	}
...
func (o *PostV1BudgetDepositRequest) SetReturn(v bool) {
	o.Return = &v
}
...
func (o PostV1BudgetDepositRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostV1BudgetDepositRequest struct {
	value *PostV1BudgetDepositRequest
	isSet bool
}

func (v NullablePostV1BudgetDepositRequest) Get() *PostV1BudgetDepositRequest {
	return v.value
}

func (v *NullablePostV1BudgetDepositRequest) Set(val *PostV1BudgetDepositRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostV1BudgetDepositRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostV1BudgetDepositRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostV1BudgetDepositRequest(val *PostV1BudgetDepositRequest) *NullablePostV1BudgetDepositRequest {
	return &NullablePostV1BudgetDepositRequest{value: val, isSet: true}
}

func (v NullablePostV1BudgetDepositRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostV1BudgetDepositRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
