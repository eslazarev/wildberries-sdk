...
// checks if the PostV2GetCardsListRequestSettingsSort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostV2GetCardsListRequestSettingsSort{}
...
// NewPostV2GetCardsListRequestSettingsSort instantiates a new PostV2GetCardsListRequestSettingsSort object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostV2GetCardsListRequestSettingsSort() *PostV2GetCardsListRequestSettingsSort {
	this := PostV2GetCardsListRequestSettingsSort{}
	var ascending bool = false
	this.Ascending = &ascending
	return &this
}

// NewPostV2GetCardsListRequestSettingsSortWithDefaults instantiates a new PostV2GetCardsListRequestSettingsSort object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostV2GetCardsListRequestSettingsSortWithDefaults() *PostV2GetCardsListRequestSettingsSort {
	this := PostV2GetCardsListRequestSettingsSort{}
	var ascending bool = false
	this.Ascending = &ascending
	return &this
...
func (o *PostV2GetCardsListRequestSettingsSort) GetAscending() bool {
...
func (o *PostV2GetCardsListRequestSettingsSort) GetAscendingOk() (*bool, bool) {
	if o == nil || IsNil(o.Ascending) {
		return nil, false
	}
...
func (o *PostV2GetCardsListRequestSettingsSort) HasAscending() bool {
	if o != nil && !IsNil(o.Ascending) {
		return true
	}
...
func (o *PostV2GetCardsListRequestSettingsSort) SetAscending(v bool) {
	o.Ascending = &v
}
...
func (o PostV2GetCardsListRequestSettingsSort) ToMap() (map[string]interface{}, error) {
...
type NullablePostV2GetCardsListRequestSettingsSort struct {
	value *PostV2GetCardsListRequestSettingsSort
	isSet bool
}

func (v NullablePostV2GetCardsListRequestSettingsSort) Get() *PostV2GetCardsListRequestSettingsSort {
	return v.value
}

func (v *NullablePostV2GetCardsListRequestSettingsSort) Set(val *PostV2GetCardsListRequestSettingsSort) {
	v.value = val
	v.isSet = true
}

func (v NullablePostV2GetCardsListRequestSettingsSort) IsSet() bool {
	return v.isSet
}

func (v *NullablePostV2GetCardsListRequestSettingsSort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostV2GetCardsListRequestSettingsSort(val *PostV2GetCardsListRequestSettingsSort) *NullablePostV2GetCardsListRequestSettingsSort {
	return &NullablePostV2GetCardsListRequestSettingsSort{value: val, isSet: true}
}

func (v NullablePostV2GetCardsListRequestSettingsSort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostV2GetCardsListRequestSettingsSort) UnmarshalJSON(src []byte) error {
	v.isSet = true
