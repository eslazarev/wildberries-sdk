...
// checks if the PostV2GetCardsList200ResponseCardsInnerSizesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostV2GetCardsList200ResponseCardsInnerSizesInner{}
...
// NewPostV2GetCardsList200ResponseCardsInnerSizesInner instantiates a new PostV2GetCardsList200ResponseCardsInnerSizesInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostV2GetCardsList200ResponseCardsInnerSizesInner() *PostV2GetCardsList200ResponseCardsInnerSizesInner {
	this := PostV2GetCardsList200ResponseCardsInnerSizesInner{}
	return &this
}

// NewPostV2GetCardsList200ResponseCardsInnerSizesInnerWithDefaults instantiates a new PostV2GetCardsList200ResponseCardsInnerSizesInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostV2GetCardsList200ResponseCardsInnerSizesInnerWithDefaults() *PostV2GetCardsList200ResponseCardsInnerSizesInner {
	this := PostV2GetCardsList200ResponseCardsInnerSizesInner{}
	return &this
}
...
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) HasChrtID() bool {
	if o != nil && !IsNil(o.ChrtID) {
		return true
	}
...
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) GetTechSize() string {
...
// and a boolean to check if the value has been set.
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) GetTechSizeOk() (*string, bool) {
	if o == nil || IsNil(o.TechSize) {
		return nil, false
	}
...
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) HasTechSize() bool {
	if o != nil && !IsNil(o.TechSize) {
		return true
	}
...
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) SetTechSize(v string) {
	o.TechSize = &v
}

// GetWbSize returns the WbSize field value if set, zero value otherwise.
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) GetWbSize() string {
...
// and a boolean to check if the value has been set.
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) GetWbSizeOk() (*string, bool) {
	if o == nil || IsNil(o.WbSize) {
		return nil, false
	}
...
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) HasWbSize() bool {
	if o != nil && !IsNil(o.WbSize) {
		return true
	}
...
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) SetWbSize(v string) {
	o.WbSize = &v
}

// GetSkus returns the Skus field value if set, zero value otherwise.
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) GetSkus() []string {
...
// and a boolean to check if the value has been set.
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) GetSkusOk() ([]string, bool) {
	if o == nil || IsNil(o.Skus) {
		return nil, false
	}
	return o.Skus, true
...
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) HasSkus() bool {
	if o != nil && !IsNil(o.Skus) {
		return true
	}
...
func (o *PostV2GetCardsList200ResponseCardsInnerSizesInner) SetSkus(v []string) {
	o.Skus = v
}

func (o PostV2GetCardsList200ResponseCardsInnerSizesInner) MarshalJSON() ([]byte, error) {
...
func (o PostV2GetCardsList200ResponseCardsInnerSizesInner) ToMap() (map[string]interface{}, error) {
...
type NullablePostV2GetCardsList200ResponseCardsInnerSizesInner struct {
	value *PostV2GetCardsList200ResponseCardsInnerSizesInner
	isSet bool
}

func (v NullablePostV2GetCardsList200ResponseCardsInnerSizesInner) Get() *PostV2GetCardsList200ResponseCardsInnerSizesInner {
	return v.value
}

func (v *NullablePostV2GetCardsList200ResponseCardsInnerSizesInner) Set(val *PostV2GetCardsList200ResponseCardsInnerSizesInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePostV2GetCardsList200ResponseCardsInnerSizesInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePostV2GetCardsList200ResponseCardsInnerSizesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostV2GetCardsList200ResponseCardsInnerSizesInner(val *PostV2GetCardsList200ResponseCardsInnerSizesInner) *NullablePostV2GetCardsList200ResponseCardsInnerSizesInner {
	return &NullablePostV2GetCardsList200ResponseCardsInnerSizesInner{value: val, isSet: true}
}

func (v NullablePostV2GetCardsList200ResponseCardsInnerSizesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostV2GetCardsList200ResponseCardsInnerSizesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
