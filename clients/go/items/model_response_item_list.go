...
// checks if the ResponseItemList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseItemList{}

// ResponseItemList struct for ResponseItemList
...
// NewResponseItemList instantiates a new ResponseItemList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewResponseItemList() *ResponseItemList {
	this := ResponseItemList{}
	return &this
}

// NewResponseItemListWithDefaults instantiates a new ResponseItemList object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewResponseItemListWithDefaults() *ResponseItemList {
	this := ResponseItemList{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ResponseItemList) GetData() map[string]interface{} {
	if o == nil {
...
func (o *ResponseItemList) GetDataOk() (map[string]interface{}, bool) {
...
func (o *ResponseItemList) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *ResponseItemList) SetData(v map[string]interface{}) {
	o.Data = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *ResponseItemList) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *ResponseItemList) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *ResponseItemList) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *ResponseItemList) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *ResponseItemList) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *ResponseItemList) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *ResponseItemList) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *ResponseItemList) SetErrorText(v string) {
	o.ErrorText = &v
}

// GetAdditionalErrors returns the AdditionalErrors field value if set, zero value otherwise.
func (o *ResponseItemList) GetAdditionalErrors() ResponseItemListAdditionalErrors {
	if o == nil || IsNil(o.AdditionalErrors) {
		var ret ResponseItemListAdditionalErrors
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ResponseItemList) GetAdditionalErrorsOk() (*ResponseItemListAdditionalErrors, bool) {
	if o == nil || IsNil(o.AdditionalErrors) {
		return nil, false
	}
...
func (o *ResponseItemList) HasAdditionalErrors() bool {
	if o != nil && !IsNil(o.AdditionalErrors) {
		return true
	}
...
// SetAdditionalErrors gets a reference to the given ResponseItemListAdditionalErrors and assigns it to the AdditionalErrors field.
func (o *ResponseItemList) SetAdditionalErrors(v ResponseItemListAdditionalErrors) {
...
func (o ResponseItemList) ToMap() (map[string]interface{}, error) {
...
type NullableResponseItemList struct {
	value *ResponseItemList
	isSet bool
}

func (v NullableResponseItemList) Get() *ResponseItemList {
	return v.value
}

func (v *NullableResponseItemList) Set(val *ResponseItemList) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseItemList) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseItemList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseItemList(val *ResponseItemList) *NullableResponseItemList {
	return &NullableResponseItemList{value: val, isSet: true}
}

func (v NullableResponseItemList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseItemList) UnmarshalJSON(src []byte) error {
	v.isSet = true
