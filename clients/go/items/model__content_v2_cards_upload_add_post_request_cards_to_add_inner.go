...
func (o *ContentV2CardsUploadAddPostRequestCardsToAddInner) GetDocuments() ContentV2CardsUploadPostRequestInnerVariantsInnerDocuments {
...
// and a boolean to check if the value has been set.
func (o *ContentV2CardsUploadAddPostRequestCardsToAddInner) GetDocumentsOk() (*ContentV2CardsUploadPostRequestInnerVariantsInnerDocuments, bool) {
	if o == nil || IsNil(o.Documents) {
		return nil, false
	}
...
func (o *ContentV2CardsUploadAddPostRequestCardsToAddInner) HasDocuments() bool {
	if o != nil && !IsNil(o.Documents) {
		return true
	}
...
func (o *ContentV2CardsUploadAddPostRequestCardsToAddInner) SetDocuments(v ContentV2CardsUploadPostRequestInnerVariantsInnerDocuments) {
	o.Documents = &v
}
