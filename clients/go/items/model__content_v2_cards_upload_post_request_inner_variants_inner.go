...
func (o *ContentV2CardsUploadPostRequestInnerVariantsInner) GetWholesale() ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale {
...
// and a boolean to check if the value has been set.
func (o *ContentV2CardsUploadPostRequestInnerVariantsInner) GetWholesaleOk() (*ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale, bool) {
	if o == nil || IsNil(o.Wholesale) {
		return nil, false
	}
...
func (o *ContentV2CardsUploadPostRequestInnerVariantsInner) SetWholesale(v ContentV2CardsUploadPostRequestInnerVariantsInnerWholesale) {
	o.Wholesale = &v
}
